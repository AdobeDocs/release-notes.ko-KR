...
| 제품 | 리소스 | 설명 | 업데이트된 기능 |
| ------- | ------- | ------- | ------- |
| [!DNL Experience Cloud] | [Experience Platform Agent Orchestrator](https://experienceleague.adobe.com/ko/docs/core-services/interface/features/agentic-ai) | 도움말을 검색하고 Experience Cloud에서 AI 에이전트의 가용성을 확인합니다. | 2025년 11월 |
