...
| 기능 | 설명 |
| ------- | ----------- |
| [!UICONTROL 캠페인] | (2월 15일 릴리스) 이제 차트 형식으로 변경 로그를 볼 수 있으며 모든 항목에 메모를 추가할 수 있습니다. |
...
| 게시일 | 이름 | 유형 | 설명 | 애플리케이션 |
| -----------| ---------- | ---------- | ---------- |---------- |
| 2023년 3월 | [공증에 필요한 문서 보내기](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/notarize/send-document-notarize.html?lang=en) | 비디오 | 공증에 필요한 문서를 보내고, 서명자의 경험을 확인하고, 결과를 수신하는 방법에 대해 알아봅니다. | Acrobat Sign |
