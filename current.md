...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- |---------- |
| 2025년 9월 | [Federated Audience Composition 자습서](https://experienceleague.adobe.com/ko/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview) | 비디오 | FAC(Federated Audience Composition)를 사용하여 Data Warehouse에서 직접 대상과 협력합니다. |
