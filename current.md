...
* **분석** | 경험 작성자: Skill Exchange | _Adobe Analytics Adobe Summit의 스킬 교환_ | 2024년 3월 28일에 라스베가스에서 열리는 서밋에서 Adobe Analytics 스킬 익스체인지 대회를 개최합니다! 이제 사전 등록하여 Analytics 고객 및 챔피언의 팁, 요령 및 모범 사례를 알아보십시오. | **3월 28일 @ 오전 9시(PT)** | [등록](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=952%20953)

* **EXPERIENCE MANAGER** | 경험 작성자: Skill Exchange | _AEM용 Adobe Summit의 스킬 교환_ | 2024년 3월 28일에 라스베가스에서 열리는 서밋에서 AEM Skill Exchange를 개최합니다! AEM 고객 및 챔피언의 팁, 요령 및 모범 사례를 배우려면 지금 미리 등록하십시오. | **3월 28일 @ 오전 9시(PT)** | [등록](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=950%20951)

* **EXPERIENCE MANAGER** | 경험 작성자: Skill Exchange | _Marketo Engage Adobe Summit의 스킬 교환_ | 2024년 3월 28일에 라스베가스에서 열리는 서밋에서 Marketo Engage 스킬 익스체인지 대회를 개최합니다! Marketo Engage 고객 및 챔피언의 팁, 요령 및 모범 사례를 배우려면 지금 미리 등록하십시오. | **3월 28일 @ 오전 9시(PT)** | [등록](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=954%20955)

* **WORKFRONT** | 경험 작성자: Skill Exchange | _Workfront Adobe Summit의 스킬 교환_ | 2024년 3월 28일에 라스베가스에서 열리는 서밋에서 Adobe Workfront 스킬 익스체인지 대회를 개최합니다! 지금 사전 등록하여 Workfront 고객의 팁, 요령 및 모범 사례를 알아보십시오. | **3월 28일 @ 오전 9시(PT)** | [등록](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=956%20957)
...
다음에 대해 알아보기 [콘텐츠 공급망](https://business.adobe.com/solutions/adobe-genstudio.html), Adobe은 생성 AI 및 지능형 자동화를 통해 콘텐츠를 가속화하고 단순화하는 종단 간 솔루션입니다.

+++세부 사항

| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2024년 2월 | [컨텐츠 공급망 Tutorials](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | 비디오 | Experience League에서 컨텐츠 공급망 튜토리얼을 봅니다. 컨텐츠 공급망은 Adobe의 종합적인 솔루션으로, 생성 AI 및 지능형 자동화를 통해 컨텐츠 공급망을 가속화하고 단순화합니다. |
...
* [2024년 1월 30일 수요일](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2024/02142024.html#status)
...
* 이제 자격 증명을 보거나 수정할 때 이름별로 API 자격 증명을 검색할 수 있습니다.
* 이제 역할 탭에서 사용자의 역할 목록을 볼 때 각 역할에 대해 사용자 그룹 멤버십 정보를 사용할 수 있습니다. 다음 **[!UICONTROL 역할 제거]** 옵션은 사용자 그룹을 통해서만 역할이 할당된 사용자에 대해서만 비활성화됩니다.
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2024년 2월 | 태그 | [태그 확장 추가 및 구성](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/add-and-configure-extensions.html) | 비디오 | 태그 속성에서 확장을 추가하고 구성하는 방법에 대해 알아봅니다. 확장은 사이트에 설치하는 사전 패키징된 &quot;앱&quot;으로, 필요한 추적, 개인화 또는 기타 기능을 제공합니다. |
| 2024년 2월 | 태그 | [데이터 요소 만들기](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/create-data-elements.html) | 비디오 | 데이터 레이어에서 가져온 값을 저장하는 데이터 요소를 만들고 태그 속성의 규칙 및 확장에 사용할 수 있도록 하는 방법에 대해 알아봅니다. |
| 2024년 2월 | 태그 | [태그 규칙 작성](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/build-rules.html) | 비디오 | 태그에서 명령을 실행할 수 있도록 규칙을 만드는 방법을 알아봅니다. 이벤트와 조건은 작업을 언제 수행할지 결정하며 작업은 작업을 결정합니다. |
| 2024년 2월 | 태그 | [태그 라이브러리 빌드 및 게시](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/build-and-publish-a-library.html) | 비디오 | 태그 속성에서 라이브러리를 만들고 개발, 스테이징 및 프로덕션 환경을 통해 변경 사항을 푸시하는 방법을 알아봅니다. 여러 팀이 병렬 작업 스트림으로 속성을 업데이트하는 데 도움이 되는 여러 개발 환경을 사용하는 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2024년 2월 | [[!UICONTROL 기본값 수집] 위치: [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23641.html) | 신규 문서 | 에서 수집하는 동안 기본값을 설정해야 하는 경우 방법에 대해 알아봅니다. [!DNL Adobe Experience Platform (AEP)], 특히 [!DNL upsert] 작업을 수행하려면 데이터 수집 프로세스에서 명시적 매핑을 사용해야 합니다. |
...
[!DNL Analytics] 릴리스 날짜: **2024년 3월 13일**
...
Adobe Analytics용으로 게시된 신규 또는 업데이트된 비디오, 튜토리얼 또는 교육 과정

| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2024년 2월 | [Analytics 구현을 위해 Experience Platform 태그에 데이터 요소 만들기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html) | 비디오 | 다음에 대한 데이터 요소 만들기 [!DNL Analytics] SDR(Solution Design Reference) 문서에 설명된 변수 및 이벤트를 기반으로 하는 태그의 구현. |
| 2024년 2월 | [Experience Platform 태그에서 전역 페이지 규칙 만들기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-a-global-page-rule-in-tags.html) | 비디오 | Experience Platform 태그를 사용하여 모든 페이지의 Adobe Analytics에 전송할 데이터 포인트에 대한 글로벌 페이지 규칙을 설정하는 방법에 대해 알아봅니다. |
| 2024년 2월 | [Experience Platform 태그의 전역 페이지 로드 규칙 유효성 검사](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/validating-your-global-page-load-rule-in-tags.html) | 비디오 | Experience Platform 디버거를 사용하여 전역 페이지 로드 규칙을 확인하는 방법에 대해 알아봅니다. |
| 2024년 2월 | [성공 이벤트에 대한 Experience Platform 태그 규칙 만들기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-success-events.html?lang=en) | 비디오 | 태그의 규칙을 사용하여 사이트에서 전환 이벤트(성공 이벤트)를 추적하는 방법에 대해 알아봅니다. |
...
| 2024년 2월 | [내부 URL 필터 설정](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/set-internal-url-filters.html?lang=en) | 비디오 | 내부 레퍼러(경로 지정 보고서를 향상시키기 위한) 또는 외부 레퍼러(레퍼러/참조 도메인 보고서를 향상시키기 위한)로 설정하는 레퍼러에 대한 설정에 대해 알아봅니다. |
| 2024년 2월 | [태그 - 개인 비서](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/analytics/analysis-workspace/tips-and-tricks/tags-your-personal-assistant.html) | 문서 | Experience Platform 태그가 어떻게 디지털 분석을 간소화하고 필요한 항목을 효율적으로 찾을 수 있는 개인 비서 역할을 하는지 알아보십시오. Adobe Analytics 챔피언 Jeff Bloomer는 도구의 이점을 극대화하는 데 대한 전문가의 통찰력을 공유합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2024년 2월 | [Adobe Analytics 작업 영역을 공유할 때 프로젝트 링크(URL)에서 생성된 변경 사항](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html) | 신규 문서 | 이 문서에서는 공유 Adobe Analytics 작업 영역에서 작업 영역 프로젝트 링크를 검색할 때마다 프로젝트 링크가 변경되는 Adobe Analytics 문제에 대한 해결 방법을 제공합니다. 새로 생성된 링크나 이전에 생성된 링크를 사용하여 대상 프로젝트에 액세스할 수 있습니다. |
...
[!DNL Customer Journey Analytics] 릴리스 날짜: **2024년 3월 13일**
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2024년 2월 | Experience Manager Assets | [자동 시작 워크플로](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/auto-start-workflows.html) | 비디오 | 자동 시작 워크플로우가에서 에셋 처리를 확장하는 방법 알아보기 [!DNL AEM as a Cloud Service] 에셋 처리가 완료되면 업로드 또는 재처리 시 사용자 지정 워크플로를 자동으로 호출하여. |
| 2024년 2월 | Experience Manager Sites | [문서 작성 설정](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html) | 비디오 | 작성자를 위한 문서 작성 설정 방법에 대한 안내서입니다. |
| 2024년 2월 | Experience Manager Sites | [문서 워크플로](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | 비디오 | AEM 문서 작성과 함께 문서 워크플로를 사용하는 방법을 살펴봅니다. |
| 2024년 2월 | Experience Manager Sites | [문서 버전](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | 비디오 | AEM 문서 작성을 사용하여 작성된 문서의 버전을 지정하는 방법을 알아봅니다. |
| 2024년 2월 | AEM CS | [Cloud 5 - 서드파티 검색](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html) | 비디오 | 타사 검색을 Edge Delivery Services에 가장 잘 통합할 수 있는 방법을 살펴봅니다. |
| 2024년 2월 | Experience Manager Assets | [PIM 통합을 위한 AEM Assets 이벤트](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/assets-pim-integration.html) | 비디오 | AEM Assets을 PIM(제품 정보 관리) 또는 PLM(제품 라인 관리) 시스템과 같은 서드파티 시스템과 통합하여 기본 AEM IO 이벤트를 사용하여 에셋 메타데이터를 업데이트하는 방법에 대해 알아봅니다. |
| 2024년 2월 | AEM Headless | [사용자 정의 필드](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | 비디오 | AEM 콘텐츠 조각 편집기에서 사용자 지정 필드를 만드는 방법을 알아봅니다. |
| 2024년 2월 | Experience Manager, AEM Cloud Manager, Marketo Engage | [AEM 챔피언 팁 및 요령 - Cloud Manager에서 로그 사용](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/cloud-manager-using-logs.html) | 비디오 | 동료 AEM 챔피언 Rami EL Gamal이 알려 주는 팁을 확인해 보십시오. 이 비디오에서 Rami는 Cloud Manager에서 로그를 다운로드하는 방법을 안내하면서 모범 사례 팁을 공유합니다. |
| 2024년 2월 | AEM CS | [Cloud 5 - RUM(Real User Monitoring)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=en) | 비디오 | Adobe이 Edge Delivery Services과 함께 제공되는 AEM 사이트에 제공하는 RUM(Real User Monitoring) 분석과 RUM을 사용하여 웹 사이트를 개선하는 방법을 알아봅니다. |
| 2024년 2월 | Experience Manager Forms | [핵심 구성 요소 기반 양식 제출의 데이터로 PDF 생성](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html) | 비디오 | 워크플로우에서 핵심 구성 요소 기반 양식 제출의 데이터를 XDP 템플릿과 병합합니다. |
| 2024년 2월 | AEM Cloud Manager | [AEM AEM Champion 우수 사례 및 팁 - as a Cloud Service으로의 마이그레이션 준비 및 계획](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | 비디오 | 동료 AEM 챔피언 Wilson Faure의 전문가 조언과 모범 사례를 살펴보십시오. 이 비디오에서, 그는 AEM으로 마이그레이션하기 위한 계획과 준비의 복잡한 과정을 as a Cloud Service으로 안내합니다. |
| 2024년 2월 | Experience Manager Sites | [Cloud 5 - Edge 작업자](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | 비디오 | AEM Sites 및 Edge Delivery Services에서 에지 작업자의 중요성과 이를 백엔드 시스템과 통합하는 방법을 살펴봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2024년 2월 | [[!DNL CDN] 템플릿 위치 [!UICONTROL 응용 프로그램 설정] 저장 안 함](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | 신규 문서 | 다음과 같은 경우의 해결 방법에 대해 알아봅니다. [!DNL CDN] 템플릿 위치 [!UICONTROL 응용 프로그램 설정] 저장할 수 없습니다. |
| 2024년 2월 | [JDK 11의 원인 `NoClassDefFoundError` [!DNL AEM] 6.5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | 신규 문서 | 설치 방법에 대해 알아보기 [!DNL CXF] 의 문제를 해결하기 위해 외부에서 패키지 사용 `NoClassDefFoundError` 로 업그레이드한 후 [!DNL Java™] 11 포함 [!DNL AEM] 6.5x |
| 2024년 2월 | [자격을 부여하는 방법 [!DNL AEM as Cloud Service] 지원 티켓](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | 신규 문서 | 지원팀이 문제를 신속하게 처리하고 이해할 수 있도록 티켓의 자격을 완전히 부여하는 방법과 필요한 정보에 대해 알아봅니다. |
| 2024년 2월 | [서버 및 서버 변경에 대해 알아보기 [!DNL JVM] 유럽/파리 시간대 [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | 신규 문서 | 서버 및 서버 변경에 대해 알아보기 [!DNL JVM] 유럽/파리 시간대 [!DNL AEM as a Cloud Service]. |
| 2024년 2월 | [코드 배포 후 워크플로가 &quot;편집할 수 없음&quot;으로 설정됩니다.](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | 신규 문서 | 해결 방법에 대해 알아보기 [!DNL AEM] 에서 워크플로우를 만든 후 의 문제 [!DNL AEM] 뒤에 코드 배포가 오면 [!UICONTROL 워크플로] 은 &quot;편집할 수 없음&quot;으로 표시됩니다. 가장 좋은 방법은 [!UICONTROL 워크플로] 코드베이스의 모델은 여러 환경에서 일관되므로 다시 만들 필요가 없습니다 [!UICONTROL 워크플로] 각 환경마다. |
| 2024년 2월 | [[!DNL DDoS] 공격 또는 보트 오버로드 [!DNL AEM] 트래픽 있음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | 신규 문서 | Dispatcher 수준에서 활성화된 로깅을 활성화하여 이 문제를 디버깅하는 방법에 대해 알아보고 트래픽 스파이크로 인한 중단을 방지하는 Dispatcher 캐싱을 개선하는 단계를 수행합니다. |
| 2024년 2월 | [일반적인 자산 수집 문제 및 솔루션](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | 신규 문서 | 가장 일반적인 항목 알아보기 [!DNL AEM] 자산 수집 문제 시나리오 및 이를 분석하는 방법(높은 처리, 높은 볼륨, 큰 규모 포함) [!DNL DAM] 저장소 및 여러 동시 작성자 |
| 2024년 2월 | [변형, 성능 및 보존 정책의 최대 한도 [!UICONTROL 컨텐츠 조각]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | 신규 문서 | 단일 내에서 허용되는 변형의 최대 수에 대한 제한에 대해 알아봅니다 [!UICONTROL 컨텐츠 조각], 여러 변형이 사이트 느림에 기여하는지 여부 및 삭제에 대한 보존 정책이 있는지 여부 [!UICONTROL 컨텐츠 조각]. |
| 2024년 2월 | [[!UICONTROL 삭제 요청] 콘텐츠 삭제 시 트리거된 워크플로우](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | 신규 문서 | 사용자가 로그인하고 페이지 또는 에셋을 삭제하는 시기에 대해 알아봅니다 [!DNL AEM], &quot;[!UICONTROL 삭제 요청]&quot;워크플로우가 트리거됩니다. |
| 2024년 2월 | [[!DNL HTML] 파일 저장 위치 [!DNL CRX] 가 브라우저에서 열리지 않고 대신 다운로드됩니다.](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | 신규 문서 | A [!DNL HTML] 에 직접 저장된 파일 [!DNL Oak] 브라우저에서 저장소가 열리지 않습니다. 대신,에서 다운로드됩니다. [!DNL AEM 6.1 SP2] 및 이후 버전. |
| 2024년 2월 | [[!DNL Adobe Experience Manager]: `WARN` 메시지: `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | 신규 문서 | 다음 기간 동안 문제에 대해 알아보기 [!DNL AEM 6.5] 시작, `WARN` 메시지가에 여러 번 표시됨 `error.log`. |
| 2024년 2월 | [[!DNL Adobe Experience Manager]: 가 있는 노드 `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | 신규 문서 | 경우에 따라 가 있는 노드일 때의 문제에 대해 알아봅니다. `sling:resourceType` 값 `wcm/msm/components/ghost` 존재합니다. 이 문서에서는 노드가 생성되는 방식을 설명합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2024년 2월 | [Adobe Commerce 데이터베이스에 대한 쿼리 연결 및 실행](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/remote-db-connection-execute-queries.html?lang=en) | 비디오 | Adobe Commerce 온-클라우드 프로젝트에 연결하고, 오프사이트에서 사용할 데이터베이스를 덤프하고, PII를 마스킹하고 제거하는 방법을 알아봅니다. |
| 2024년 2월 | [Commerce Cloud 기술 온보딩 및 하드웨어 핸드오프 - 시작 프로세스 타임라인](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-commerce-cloud/technical-onboarding-hardware-handoff/launch-process-timeline.html) | 비디오 | 론치 프로세스 타임라인에 대한 Adobe Commerce Cloud 기술 온보딩에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2024년 2월 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html?lang=ko-KR) | 신규 문서 | 에서 사용할 수 있는 패치를 적용하는 방법에 대한 새로운 문서 [!DNL QPT] 1.1.44, [!DNL QPT] 1.1.45 및 [!DNL QPT] 1.1.46이 게시되었으며 각 섹션에서 찾을 수 있습니다. |
| 2024년 2월 | [동일한 엔터티에 대한 데이터베이스의 여러 행](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/database/multiple-rows-in-database-for-same-entity.html) | 신규 문서 | 이 문서에서는 데이터베이스에 동일한 엔티티 ID에 대한 행이 여러 개 있는 문제에 대한 해결 방법을 제공합니다. |
| 2024년 2월 | [Recommendations [!DNL JS] Adobe Commerce 버전 2.4.5로 업그레이드 후 오류 발생](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | 신규 문서 | 이 문서에서는 Adobe Commerce으로 업그레이드한 후 (모든 배포 방법)에 [!DNL JS] 제품 Recommendations 모듈/유닛과 관련된 콘솔 오류. |
...
Adobe Campaign용으로 게시된 새로운 비디오 튜토리얼 또는 업데이트된 비디오 튜토리얼.
...
| 2024년 2월 | Campaign Web 사용자 인터페이스 | [Campaign 웹 사용자 인터페이스 살펴보기](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/getting-started/explore-the-web-ui.html) | 비디오 | Campaign Web 사용자 인터페이스에 액세스하고 탐색하는 방법과 인벤토리 목록을 사용자 정의하는 방법을 알아봅니다. AI 기반의 Knowledge Assistant를 살펴보십시오. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2024년 2월 | [에 연결되어 있을 때 게재 템플릿 창을 올바르게 볼 수 없음 [!DNL Campaign Console] 경유 [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | 신규 문서 | 에 연결할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. [!DNL Adobe Campaign Console] 경유 [!DNL VPN], 창 내에서는 게재 템플릿 데이터를 볼 수 없습니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2024년 2월 | [&quot;+&quot; 연산자를 사용하여 표현식을 작성할 때 함수 캡슐화](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23749.html) | 신규 문서 | &quot;+&quot; 연산자를 사용할 때 함수 호출을 괄호로 캡슐화하는 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2024년 2월 | [마케팅 속성 및 데이터 사일로](https://experienceleague.adobe.com/docs/marketo-measure-learn/tutorials/evangelist/marketing-attribution-and-data-silos.html) | 비디오 | 이 세션 동안 Measure Evangelist 강연에서는 Attributa의 CEO Drew Smith를 초대하여 성장 기업과 데이터 사일로가 직면한 과제를 논의합니다. Adobe 솔루션 컨설턴트(Marketo Measure)인 Andy Schneider와 Adobe Marketo 전도사인 Ian Michels는 이러한 문제가 잘못된 데이터와 잘못된 의사 결정으로 이어질 수 있는 방법에 대한 대화를 안내합니다. |
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |---------- |
| 2024년 2월 | [!DNL Adobe Firefly] | [Adobe Firefly 검색](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html?lang=en) | 비디오 | 상업적 안전 사용 및 혁신을 위해 설계된 생성 AI로 창의성의 미래를 Adobe Firefly 할 수 있습니다. |
| 2024년 2월 | [!DNL Adobe Firefly] | [랜딩 페이지](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | 비디오 | Adobe Firefly 사용을 시작하는 방법에 대해 알아봅니다. |
| 2024년 2월 | [!DNL Adobe Firefly] | [생성 채우기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html?lang=en) | 비디오 | 생성 채우기를 사용하여 간단한 텍스트 프롬프트를 사용하여 이미지의 내용을 비파괴적으로 추가, 확장 또는 제거하는 방법을 알아봅니다. 생성형 채우기를 통해 창의력을 높이고 특별한 프로젝트를 만들 수 있습니다. |
| 2024년 2월 | [!DNL Adobe Firefly] | [생성 재채색](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html?lang=en) | 비디오 | 벡터 파일에서 제품 포장, 포스터 또는 아트웍에 대한 다양한 색상 변화를 즉시 미리 보는 방법에 대해 알아봅니다. 생성 다시 칠을 사용하면 입력할 수 있는 한 빨리 다시 칠할 수 있습니다. 평범한 아이디어로 실험하고, 다양한 테마나 팔레트를 중심으로 상상하고, 다양한 변형을 빠르게 만들 수 있습니다. |
| 2024년 2월 | [!DNL Adobe Firefly] | [Firefly 사용 방법의 예](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html?lang=en) | 비디오 | Firefly을 사용하여 영감을 주는 PowerPoint 프레젠테이션, 무드 보드, 관념화, 화면 보호기 등을 만드는 방법에 대해 알아봅니다. |
| 2024년 2월 | [!DNL Adobe Firefly] | [텍스트 효과](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/text-effects.html?lang=en) | 비디오 | 간단한 텍스트 프롬프트를 사용하여 프로젝트에 고유하고 영감을 주는 텍스트를 만드는 방법을 알아봅니다. 텍스트 효과를 사용하면 창의력을 높이고 프로젝트에 사용할 수 있는 특별한 텍스트를 만들 수 있습니다. |
