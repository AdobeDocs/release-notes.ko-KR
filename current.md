...
Experience League에서 [과정](https://experienceleague.adobe.com/en/courses)을 사용할 수 있습니다. 전문가가 생성한 구조화된 학습을 제공하여 기술을 보다 빠르게 구축하고, 전문성을 검증하며, Adobe 솔루션 전반에서 보다 자신 있게 진급할 수 있습니다.
...
| [!DNL Experience Cloud] | Experience Cloud 애플리케이션의 [Agentic AI](https://experienceleague.adobe.com/ko/docs/core-services/interface/features/agentic-ai) | [AEM 에이전트](https://experienceleague.adobe.com/en/docs/core-services/interface/features/agentic-ai#ai-first-experience-cloud-applications)에 대한 새 도움말이 게시되었습니다. 도움말을 검색하고 Experience Cloud에서 AI 에이전트의 사용 가능 여부를 확인합니다. | 2025년 11월 21일 |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2025년 12월 | [Adobe Experience Platform에서 개인 정보 액세스 및 삭제 요청을 처리하는 방법](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29736) | 신규 문서 | Adobe Experience Platform에서 개인 정보 액세스 및 삭제 요청을 처리하는 방법에 대해 알아봅니다. |
| 2025년 12월 | [사용자 지정 CSV 업로드에 대해 30일 후에 대상 모집단 감소](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29670) | 신규 문서 | Adobe Experience Platform(AEP)에서 CSV 파일을 업로드하여 만든 대상자가 30일 후 정규화된 프로필이 급격히 감소할 수 있는 경우의 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [Power BI을 Customer Journey Analytics AEP에 연결하는 동안 자격 증명 인증 오류가 발생했습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29668) | 신규 문서 | SQL 클라이언트를 사용하여 AEP을 Adobe Customer Journey Analytics의 BI Connector에 연결할 때 인증 오류가 발생할 때 Power BI의 문제를 해결하는 방법에 대해 알아봅니다. |
| 2025년 12월 | [Adobe Experience Platform의 XDM ExperienceEvent 데이터 세트에 대해 업데이트가 지원되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29689) | 신규 문서 | 데이터 흐름에서 Adobe Experience Platform의 XDM ExperienceEvent 데이터 세트에 대한 업데이트 또는 업데이트 작업을 수행하려고 할 때 오류 *업데이트가 이벤트에 대해 지원되지 않음*&#x200B;이(가) 발생할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [*대상을 활성화할 때*&#x200B;대상에 대한 내보내기 순서에 올바른 대상 ID가 포함되지 않음 [!DNL Azure Blob]  오류](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29708) | 신규 문서 | AEP에서 [!DNL Azure Blob] 연결을 설정한 후 필요한 액세스 권한이 부여되지 않은 경우 세그먼트를 활성화하는 동안 오류가 발생하는 문제의 해결 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2026년 1월 | [CJA 연결 활성화 및 유효성 검사](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/visitor-id/stitching-enablement-and-validation) | 비디오 | 모든 이벤트 데이터 세트에서 결합을 활성화하는 방법에 대해 알아봅니다. |
| 2026년 1월 | [AI 트래픽 추적 및 분석](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/use-cases/ai/track-and-analyze-ai-traffic) | 비디오 | 파생 필드, 세그먼트 및 Workspace 프로젝트를 사용하여 Adobe Customer Journey Analytics에서 AI 생성 트래픽을 식별하고 필터링하여 정확하고 사람 중심의 고객 인사이트를 확보하는 방법을 알아봅니다. |
...
| 게시일 | 애플리케이션 | 이름 | 형식 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026년 1월 | [!DNL AEM Assets] | [Dynamic Media URL 구문 및 이미지 사전 설정 모범 사례](https://experienceleague.adobe.com/en/docs/experience-manager-learn/assets/dynamic-media/images/dynamic-media-urls-and-image-presets) | 비디오 | AEM Assets Dynamic Media URL 구문을 살펴보고 이미지 사전 설정을 사용하여 값을 최대화하는 방법에 대해 알아봅니다. 자산 관리 기능을 향상시키고 워크플로우 효율성을 개선합니다. |
| 2026년 1월 | [!DNL AEM Assets] | [AEM Assets Content Hub에서 에셋 다운로드](https://experienceleague.adobe.com/en/docs/experience-manager-learn/assets/content-hub/download-assets) | 비디오 | Adobe Experience Manager Assets Content Hub에서 에셋을 탐색, 검색 및 다운로드하는 방법을 알아봅니다. |
| 2026년 1월 | [!DNL AEM CS] | AEM의 [에이전트](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/ai/agents-in-aem) | 비디오 | Adobe Experience Manager Agent에서 AEM의 작업을 자동화하여 워크플로를 간소화하는 방법을 살펴볼 수 있습니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2025년 12월 | [Dynamic Media Scene7 캐시 TTL(Time To Live) 질문](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29687) | 신규 문서 | Dynamic Media Scene7 캐시 TTL(Time To Live) 설정에 대해 알아봅니다. |
| 2025년 12월 | [특정 지역의 사용자 하위 집합에 대해 Dynamic Media 이미지를 로드하지 못했습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29709) | 신규 문서 | 다른 사용자가 특정 URL을 정상적으로 로드할 수 있을 때 특정 사용자 하위 집합이 Dynamic Media에 특정 URL을 로드할 수 없는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [Brand Portal 공유 링크에 AEM에서 컬렉션 업데이트 후 자산이 표시되지 않습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28072) | 신규 문서 | 에셋을 추가하거나 업데이트한 후 공유 컬렉션 링크가 *표시할 콘텐츠 없음*&#x200B;을 표시할 때 AEM Brand Portal에서 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | 끝점 URL 필드 없이 AEM 6.5.23에서 [구성 [!DNL Microsoft Translator] 하는 중](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28099) | 신규 문서 | [!DNL Microsoft Translator]을(를) Adobe Experience Manager(AEM) 6.5.23과 통합할 때 문제 해결 방법에 대해 알아봅니다. 구성 대화 상자는 Microsoft 끝점 URL을 입력하는 필드를 제공하지 않습니다. |
| 2025년 12월 | [AEM Dynamic Media의 손상된 인코딩으로 인해 비디오 재생이 실패합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29548) | 신규 문서 | 특정 비디오 에셋의 인코딩이 손상되어 Adobe Experience Manager(AEM) Dynamic Media에서 비디오 재생이 중간에 중단되는 경우의 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [AEM Dynamic Media에서 HLS/DASH에 대한 대량 비디오 자산을 효율적으로 재처리합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29601) | 신규 문서 | AEM Dynamic Media에서 HLS/DASH 스트리밍용 비디오 에셋을 재처리할 때 시스템이 오버로드되고 일괄 처리 시 오류가 발생하는 문제의 해결 방법에 대해 알아봅니다. |
...
| 2025년 12월 | [AEM 6.5의 권한으로 인한 태그 이동 오류 해결](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29651) | 신규 문서 | 한 네임스페이스에서 다른 네임스페이스로 태그를 이동한 다음 원래 위치로 다시 이동할 때 *액세스가 거부됨*&#x200B;으로 인해 작업이 실패하는 문제에 대한 해결 방법에 대해 알아봅니다. |
...
| 2025년 12월 | [Dynamic Media 또는 AEM Assets의 Assets이 Content Hub에 표시되지 않습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28074) | 신규 문서 | AEM as a Cloud Service의 Content Hub이 게시 및 승인 후에도 Dynamic Media 또는 AEM Assets의 에셋이 표시되지 않는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [AEM 콘텐츠 조각의 사용자 지정 로케일 폴더에서 고유 필드 유효성 검사가 실패합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28085) | 신규 문서 | AEM의 사용자 지정 로케일 폴더 이름이 언어 루트로 인식되지 않아 고유한 필드 유효성 검사 오류를 발생하는 문제의 솔루션에 대해 알아봅니다. |
| 2025년 12월 | [AEM as a Cloud Service에서 손상된 사용자 노드로 인해 로그인 오류가 발생했습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28127) | 신규 문서 | 사용자 노드에 잘못된 이메일 주소와 같이 손상되거나 잘못된 데이터가 포함되어 있는 경우 Adobe Experience Manager(AEM) as a Cloud Service에서 특정 사용자에 대해 로그인 오류가 발생할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [워크플로 벨 아이콘에 AEM의 Admin Console 사용자에 대한 로컬 작업이 표시되지 않습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28140) | 신규 문서 | 참가자 단계 승인과 같은 로컬 워크플로우 작업이 받은 편지함에 표시되더라도 Admin Console 동기화 사용자의 종 모양 아이콘에 표시되지 않는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [AEMaaCS에서 새로 고친 후 편집 모드에서 Dynamic Media 레이아웃 컨테이너가 사라짐](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28171) | 신규 문서 | Adobe Experience Manager as a Cloud Service(AEMaaCS)에서 비디오 작성을 위해 Dynamic Media 핵심 구성 요소로 작업할 때 새로 고친 후 편집 모드에서 레이아웃 컨테이너가 페이지에서 사라지는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [401 AEM as a Cloud Service에서 기능 테스트 중 승인되지 않은 오류가 발생했습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28177) | 신규 문서 | Dispatcher에서 지원되지 않는 기본 인증을 사용하기 때문에 AEM as a Cloud Service에서 기능 테스트 중에 401 인증되지 않은 오류가 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [보낸 사람&#x200B;**[!UICONTROL 주소가 Adobe Experience Manager as a Cloud Service과 다른 경우]**&#x200B;워크플로 전자 메일이 배달되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29609) | 신규 문서 | 일별 CQ 메일 서비스의 **[!UICONTROL 보낸 사람]** 주소가 일별 CQ 워크플로우 이메일 알림 서비스의 주소와 일치하지 않을 때 워크플로우 이메일 알림이 전송되지 않는 AEMaaCS의 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [AEMaaCS에서 권한이 부족하여 콘텐츠 조각이 있는 DAM 폴더를 게시하지 못했습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29652) | 신규 문서 | Adobe Experience Manager as a Cloud Service(AEMaaCS)에서 콘텐츠 조각이 포함된 DAM 폴더를 게시하지 못하고 게시물을 관리할 권한이 없다는 오류 메시지가 표시될 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [AEMaaCS에서 승인된 자산에 대한 배달 URL이 누락됨](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28098) | 신규 문서 | OpenAPI가 있는 Dynamic Media가 활성화되어 있지만 사용자 권한이 누락된 경우 Adobe Experience Manager as a Cloud Service(AEMaaCS)에서 승인 및 게시된 에셋에 대한 게재 URL이 표시되지 않는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [403 인코딩된 슬래시가 있는 URL에 사용할 수 없음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28182) | 신규 문서 | URL에 인코딩된 슬래시(`%2F`)가 포함되어 있는 경우 Adobe Experience Manager as a Cloud Service에서 403 Forbidden 오류를 반환하는 문제에 대한 해결 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2026년 1월 | [모임 예약](https://experienceleague.adobe.com/en/docs/brand-concierge/content/getting-started/meeting-booking) | 비디오 | 모임 예약 방법을 알아봅니다. 고객으로서의 경험을 확인하고, 달력을 사용하도록 담당자를 구성하고, 보고서를 확인합니다. |

자세한 내용은 [Adobe Brand Concierge](https://experienceleague.adobe.com/en/docs/brand-concierge/content/home) 자습서 홈 페이지를 참조하십시오.
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2026년 1월 | [가시성 개요](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/observability/overview) | 비디오 | 최신 Adobe Commerce 아키텍처에 대해 중앙 집중식 관찰력이 필수적인 이유를 알아봅니다. |
| 2026년 1월 | [원격 분석 열기](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/observability/open-telemetry) | 비디오 | Open Telemetry가 단일 모니터링 도구로 잠그지 않고 로그, 추적 및 지표 전반에서 가시성을 표준화하는 방법에 대해 알아봅니다. |
| 2026년 1월 | [설정 및 구성](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/observability/demo-setup-configuration) | 비디오 | 표준화된 상관 관계 원격 분석을 사용하여 Adobe Commerce 및 사용자 지정 애플리케이션에서 전체적인 가시성을 구현하는 방법에 대해 알아봅니다. |
| 2026년 1월 | [가시성 데모](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/observability/demo) | 비디오 | Adobe Commerce에서 원활한 주문 추적 및 디버깅을 위해 가시성, 웹후크 및 이벤트 상관 관계를 사용하는 방법에 대해 알아봅니다. |
...
| 2025년 12월 | [여러 조직에 할당된 사용자의 Adobe IMS(Identity Management Service) 로그인 문제](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29604) | 신규 문서 | 여러 Adobe IMS 조직에 속한 Adobe Commerce 사용자가 로그인 중에 잘못된 조직을 선택할 때 로그인하지 못하는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [[!DNL Fastly] 클라우드 인프라의 Adobe Commerce에서 캐싱이 작동하지 않습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29629) | 신규 문서 | 사이트에서 [!DNL Fastly] 캐싱이 작동하지 않을 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [무효화된 캐시가 응답 시간 저하를 일으킴](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29631) | 신규 문서 | Adobe Commerce 저장 성능을 저하시킬 수 있는 캐시 무효화를 방지하는 방법에 대해 알아봅니다. |
| 2025년 12월 | [Adobe Commerce의 데이터베이스 저장소 문제 해결사](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29633) | 신규 문서 | Adobe Commerce의 데이터베이스 스토리지 문제에 대한 솔루션에 대해 알아봅니다. |
| 2025년 12월 | [Adobe Commerce 배포 문제 해결사](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29640) | 신규 문서 | Adobe Commerce에서 배포가 중단되고 배포가 실패했을 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [엔터티 Adobe Commerce 백엔드를 저장할 수 없습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29642) | 신규 문서 | Adobe Commerce 백엔드에 엔티티를 저장할 수 없는 경우의 문제 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [CSV 가져오기 후 고객 그리드에 새 고객이 표시되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29643) | 신규 문서 | **[!UICONTROL 파일에서 가져온 후]**&#x200B;고객&#x200B;**[!UICONTROL >]**&#x200B;모든 고객`.csv`에서 새 고객을 볼 수 없을 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [Adobe Commerce에 대한 `/tmp` 탑재 가득 참 문제 해결](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29644) | 신규 문서 | `/tmp` 마운트가 꽉 찼고 사이트가 다운되었을 수 있으며 노드에 SSH를 사용할 수 없는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [소스를 제거하거나 소스 코드를 변경할 수 없습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29648) | 신규 문서 | 시스템에서 소스를 삭제하거나 해당 코드를 수정할 수 없는 경우 이러한 작업이 제한되므로 이 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [수정 *클래스를 생성된/코드 디렉터리에 저장할 수 없습니다* 오류](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29649) | 신규 문서 | 종속성이 지정된 방식으로 인해 클래스가 즉시 자동 생성되지 않고 *클래스를 생성된/코드 디렉터리에 저장할 수 없습니다* 오류 메시지가 발생하는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [Adobe Commerce [!DNL Fastly] 문제 해결사](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29661) | 신규 문서 | Adobe Commerce 사용자를 위한 이 [!DNL Fastly] 문제 해결사는 발생하는 증상에 대한 응답을 기반으로 솔루션을 안내합니다. |
| 2025년 12월 | [클라우드에서 캐시를 제거하는 동안 오류가 발생했습니다 [!DNL Fastly] 삭제 요청이 처리되지 않았습니다.*제거 요청이 처리되지 않았습니다.*)](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29667) | 신규 문서 | [!DNL Fastly] 제거 옵션이 사용되고 오류가 발생할 때 문제에 대한 해결 방법에 대해 알아봅니다. *제거 요청이 성공적으로 처리되지 않았습니다.* |
| 2025년 12월 | 1k+ 제품이 포함된 범주를 저장할 때 [504 게이트웨이 시간 초과 오류 발생](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29703) | 신규 문서 | 대규모 범주(1,000개 이상의 제품)에서 작업을 수행할 때 발생하는 시간 초과 문제에 대한 솔루션에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2025년 12월 | [`queryDef`이(가) Adobe Campaign 워크플로우에서 10,000개의 레코드만 반환합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28003) | 신규 문서 | Adobe Campaign Classic에서 워크플로우를 실행할 때 문제에 대한 해결 방법에 대해 알아봅니다. `lineCount` 특성을 지정하지 않으면 JavaScript 활동 내의 `queryDef`에서 10,000개의 레코드만 반환합니다. |
| 2025년 12월 | [Adobe Campaign Standard의 게재 수 임계값으로 인해 보고서에서 캠페인 가시성이 제한됨](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28077) | 신규 문서 | Adobe Campaign Standard에서 캠페인 이름별로 필터링할 때 일부 비즈니스 사용자가 일반 **[!UICONTROL 보고서]** 섹션에서 특정 월별 캠페인을 볼 수 없는 경우의 문제 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [외부 계정 정리가 Adobe Campaign Classic의 목록 테이블을 제거합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28069) | 신규 문서 | ACC(Adobe Campaign Classic) 환경에서 수신자 및 비수신자 목록에 대한 데이터베이스 테이블이 매일 삭제될 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2025년 12월 | [Campaign Standard: 캠페인 레이블에 대한 전역 보고서를 필터링하면 사용자마다 다른 결과가 나옵니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29728) | 신규 문서 | 캠페인 이름을 필터로 사용하여 **[!UICONTROL 전역 보고서]**&#x200B;를 필터링할 때 다른 역할을 가진 사용자가 다른 숫자를 보는 이유에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2025년 12월 | [Journey Optimizer의 사용자 지정 작업 응답에서 배열이 지원되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28054) | 신규 문서 | Adobe Journey Optimizer(AJO)의 사용자 지정 작업에서 API를 호출할 때 응답이 배열을 반환하는 문제에 대한 솔루션에 대해 알아봅니다. |
...
| 2026년 1월 | Acrobat | [복합 테이블](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/accessibility-tutorials/complex-tables) | 비디오 | Acrobat에서 접근성을 위해 표에 태그를 지정하는 방법을 알아봅니다. |
| 2026년 1월 | Acrobat | [태그 지정의 기본 사항](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/accessibility-tutorials/basics-tagging) | 비디오 | PDF 파일에 태그를 지정하여 액세스할 수 있게 하는 방법의 기본 사항에 대해 알아봅니다. |
| 2026년 1월 | Acrobat | [Acrobat에서 액세스 가능한 PDF 만들기](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/accessibility-tutorials/accessible-acrobat) | 비디오 | Acrobat에서 시작하여 액세스 가능한 PDF을 만드는 방법을 알아봅니다. |
| 2026년 1월 | Acrobat | [[!UICONTROL 액세스 가능] 안내 작업](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/accessibility-tutorials/make-accessible-action) | 비디오 | _[!UICONTROL 액세스 가능]_ 안내 작업을 사용하여 PDF 파일에 액세스할 수 있게 하는 방법에 대해 알아봅니다. |
| 2026년 1월 | Acrobat Sign | [모바일 친화적 보기 만들기](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/mobile/mobile-tutorials/create-mobile-friendly) | 비디오 | 개발자 지원 없이 모바일 친화적인 문서를 원활하게 생성하는 방법에 대해 알아봅니다. |
| 2026년 1월 | Acrobat Sign | [모바일 전용 보기](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/mobile/mobile-tutorials/mobile-friendly) | 비디오 | 모바일 친화적 보기를 사용하여 모바일 디바이스에서 양식을 작성하는 방법을 알아봅니다. |
| 2026년 1월 | Acrobat Sign | [사용자 지정 워크플로우 구축](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/building-a-custom-workflow) | 비디오 | 사용자 지정 워크플로우를 만들고 사용하여 계약을 만들고 보내는 프로세스를 가속화하는 방법을 알아봅니다. |
