...
### Experience Cloud 애플리케이션을 위한 통합 구성 튜토리얼 {#integrations}

새로운 기능 발표 [Experience Cloud 애플리케이션을 위한 통합 튜토리얼 홈](https://experienceleague.adobe.com/docs/integrations-learn/experience-cloud/overview.html?) Experience League!

가장 일반적인 Experience Cloud 애플리케이션 통합에 대해 알아보십시오. 통합 튜토리얼 찾아보기 [솔루션](https://experienceleague.adobe.com/docs/integrations-learn/experience-cloud/solution-categories/overview.html?lang=en) 또는 [애플리케이션](https://experienceleague.adobe.com/docs/integrations-learn/experience-cloud/integrations-between-applications/overview.html?lang=en).

### Experience League 시 이벤트
...
* **[!DNL EXPERIENCE MANAGER]** | Experience Maker | _Adobe Experience Manager의 Skill Exchange_ | **8월 17일 @ 오전 9시(PT)** | [등록](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,jvUOpWGTjE-Ph64NemBUhA,ZNAqPMQNZkK7VD-MS7tTJQ,Hk32dXdY40OM3NXnqXTPhA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL WORKFRONT]** | Experience Maker | _Adobe Workfront의 Skill Exchange_ | **8월 16일 @ 오전 9시(PT)** | [등록](https://cvent.me/OnVZk3?rt=GK3dI3eyIEu5Ln9oKu3x0Q&amp;RefId=Experience+League)
* **[!DNL ANALYTICS]** | Experience Maker | _Adobe Analytics의 Skill Exchange_ | **8월 17일 @ 오전 9시(PT)** | [등록](https://cvent.me/OnVZk3?rt=GK3dI3eyIEu5Ln9oKu3x0Q&amp;RefId=Experience+League)

* **[!DNL TARGET]** | 웨비나 | _성수기 준비와 함께 ROI에 미치는 영향 극대화_ | **8월 17일 @ 오전 8시(PT)** | [등록](https://adobepeakseasonreadiness2023.experienceleague.adobeevents.com/)

* **[!DNL WORKFRONT]** | 고객 워크숍 | _Workfront 학습 - 요청된 큐_ | **8월 22일 @ 오전 9시(MT)** | [등록](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,Tu1ThXWIykiOZEfcg-DHeA,HXziSkoXUkm1SUYQGdEkZA,G-p3ztGJpkCWE8JFONuXNg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
인증 사이트는 모든 [!DNL Experience Cloud] 인증 관련 콘텐츠에 대한 종합적인 정보를 제공하며 다음을 포함하여 정기적으로 업데이트됩니다.
...
| 기능 | 설명 |
| ------- | -------|
| 공지 | 공지 사항 **글로벌**, **클라우드**, 또는 **제품**&#x200B;광범위한 영향을 미치는 메시지 레벨링 과거의 사례로는 코로나19 관련 메시지가 있을 수 있다. 다른 예로는 Log4j 또는 지원 센터 다운과 같은 글로벌 보안 취약점이 있습니다. 공지가 문제 또는 유지 관리에 연결되어 있지 않습니다. 이 기능은 클라우드 또는 제품 수준의 업데이트에 대해 고객과 통신하는 데 사용됩니다.<p>이제 구독자는 새로운 구독을 만들거나 편집하여 문제 및 유지 관리 외에 공지를 포함할 수 있습니다. 구독하는 제품이 알림의 영향을 받는지 여부에 따라 구독자에게 공지 알림이 전송됩니다. 구독자는 일반적인 알림 채널(이메일/Slack)을 통해 이러한 커뮤니케이션을 수신하고 다음에서 이벤트를 볼 수 있습니다. [status.adobe.com](https://status.adobe.com/) 웹 페이지. |
| 개선 사항 | <ul><li>의 성능 개선 [status.adobe.com](https://status.adobe.com/) 개요 페이지.</li><li>향상된 Acrobat Online 구독 서비스.</li><li>[!DNL Adobe Advertising] - 구식 TV 제공 서비스는 중단되었으며, 구독자들은 가리켰다 [!UICONTROL Demand Side Platform] 제공.</li><li>이제 제품 오퍼 페이지의 배너는 모든 제품에 걸쳐 이벤트를 표시하는 대신 제품 오퍼 상태를 반영합니다.</li><li>제품 영향이 종료되고 동시에 사소한 것으로 다운그레이드되면 다운그레이드에 대한 종료 알림이 고객에게 전송됩니다.</li></ul> |
| 알림 버그 수정 | <ul><li>취소된 유지 보수는 배너에 예약된 날짜/시작 날짜 및 취소된 날짜를 올바르게 표시합니다.</li><li>여러 제품에 영향을 주는 유지 보수가 있는 경우 구독자는 해당 제품이 영향을 받은 경우에만 알림을 받습니다. 받은 이메일은 제품에 대한 영향만 보여줍니다.</li></ul> |
...
[!DNL Analytics] 릴리스 날짜: **2023년 8월 9일**
...
[!DNL Customer Journey Analytics] 릴리스 날짜: **2023년 8월 9일**
...
기존 고객은 [!DNL DIL] 구현을 계속 사용할 수 있습니다. 그러나 Adobe는 이 시점 이후로 [!DNL DIL]의 개발을 진행하지 않습니다. 고객은 다음을 평가하는 것이 좋습니다. [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=ko) 을 참조하십시오. 2023년 7월 이후에 새로운 데이터 수집 통합을 구현하고자 하는 고객은 대신 [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=ko)를 사용해야 합니다.
...
* [Adobe Experience Manager(AEM) as a Cloud Service 최신 릴리스 정보](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=ko) - 의 최신 릴리스 정보 읽기 [!DNL Experience Manager as a Cloud Service].
...
* **컨텐츠 조각용 MSM:** 이제 콘텐츠 조각에 Adobe Experience Manager(AEM) Multisite Manager를 사용할 수 있으며 벌크 콘텐츠 배포를 위해 콘텐츠 조각 라이브 카피를 만들 수 있습니다. 콘텐츠 조각 요소 및 변형 수준까지 세분화된 상속 제어를 사용할 수 있습니다.

_프리릴리스 채널의 새로운 기능_

* 다음 [콘텐츠 조각 콘솔](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/content-fragments-console.html?lang=ko) 이제 사용자는 태그를 보고 콘텐츠 조각에 메타데이터로 적용된 태그로 검색할 수 있습니다. 사용자는 이 기능을 위해 더 이상 Assets 사용자 인터페이스로 전환할 필요가 없어 컨텍스트 전환이 줄어들고 효율성이 향상됩니다.

### [!DNL Experience Manager Assets] as a [!DNL Cloud Service]

_새로운 기능_

* **이미지 스마트 태그를 위한 인공 지능 프레임워크 개선** - Experience Manager Assets은 이제 이미지 스마트 태그에 대해 향상된 인공 지능 프레임워크를 사용합니다. 이 콘텐츠 인텔리전스는 수집 시 모든 이미지 자산에 사용할 수 있는 스마트 태그의 관련성과 정확성을 향상시킵니다.
* **자산 목록 보기에 대한 열 표시 구성** - 이제 Assets Essentials을 사용하여 이름, 상태, 형식, Dimension, 크기 및 수정된 항목과 같이 에셋 목록 보기에 표시되는 열을 선택할 수 있습니다.
* **관련성을 기준으로 검색 결과 정렬** - 이제 Assets Essentials은 기본적으로 관련성을 기준으로 검색 결과를 정렬합니다. 검색된 자산을 `Name`, `Relevance`, `Size`, `Modified` 및 `Created`의 오름차순 또는 내림차순으로 정렬할 수 있습니다.

### [!DNL Experience Manager Forms] as a [!DNL Cloud Service]

_새로운 기능_

* **[기본 테마 및 템플릿](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/using-themes-in-core-components.html?lang=ko)** - 숙련된 전문가와 새로운 양식 작성자 모두에게 역량을 부여할 수 있도록 맞춤형으로 구성된 Adobe의 바로 사용 가능한 테마 및 템플릿을 사용하여 양식 작성 프로세스를 시작하십시오. 적응형 양식 핵심 구성 요소를 사용하여 원활하게 구축되었으며 세심하게 선별된 이 테마 및 템플릿을 사용하면 일반적인 사용 사례에 대한 양식을 신속하게 작성할 수 있습니다.
* **Headless Forms용 React 구성 요소** - 이제 즉시 제공된 React 구성 요소로 Headless 적응형 양식 렌디션을 미리 보고 사용자 정의할 수 있습니다. 이러한 구성 요소는 스타일을 지정할 때 적응형 Forms 핵심 구성 요소의 BEM 클래스를 사용하므로 특정 요구 사항에 따라 모양을 손쉽게 사용자 지정할 수 있습니다.
* **[반복 가능한 섹션이 포함된 적응형 Forms 만들기](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/create-forms-repeatable-sections.html?lang=en)** - 이제 다음을 수행할 수 있습니다. [어코디언](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/accordion.html?lang=en), [마법사](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/wizard.html?lang=en), [패널](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/panel-container.html?lang=en), 및 [가로 탭](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/horizontal-tabs.html?lang=en) 여러 데이터 레코드 캡처를 위한 적응형 양식 기반 구성 요소. 이러한 반복 가능한 섹션을 사용하면 여러 데이터 항목을 쉽게 제공할 수 있습니다. 필요한 데이터 인스턴스를 미리 알 수 없는 경우에 유용합니다. 양식 작성기에서 섹션을 쉽게 추가하거나 제거할 수 있으므로, 양식을 다양한 데이터 입력 시나리오에 맞게 조정하고 동일한 데이터 레코드의 여러 항목 수집을 단순화할 수 있습니다.

_프리릴리스 채널의 새로운 기능_

* **[Google reCAPTCHA 엔터프라이즈 지원](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-components-to-an-adaptive-form/captcha-adaptive-forms.html?lang=en)** - 적응형 양식에서 Google reCAPTCHA Enterprise를 사용하여 사기 활동 및 스팸에 대한 향상된 보호를 제공하여 보다 안전한 사용자 경험을 제공합니다. 고급 위험 분석 및 원활한 통합을 통해 실제 사용자가 양식을 쉽게 제출할 수 있는 동시에 봇이 효과적으로 차단됩니다.

### Headless 적응형 양식 얼리 어답터 프로그램

사용 [헤드리스 적응형 Forms](https://experienceleague.adobe.com/docs/experience-manager-headless-adaptive-forms/using/overview.html?lang=en) 을 사용하면 개발자가 기존의 그래픽 사용자 인터페이스가 아닌 API를 통해 액세스하고 상호 작용할 수 있는 대화형 양식을 만들고 게시하고 관리할 수 있습니다. Headless 적응형 양식은 다음에 도움이 됩니다.
...
* **작업 센터** - 즉각적인 조치가 필요한 중요한 사고가 발생할 때 경고하는 이메일 알림을 구독하고 사이트를 최적화할 수 있는 개인화된 권장 사항을 제공합니다. 액션 센터는 차단된 복제 대기열 또는 자격 증명 만료와 같은 경고를 검토하고 해결 상태로 표시할 수 있는 허브 역할을 합니다.
* **CDN 및 WAF 규칙 얼리 어답터 프로그램** - 다음을 기반으로 CDN에서 트래픽 필터링:

   * 요청 헤더 및 속성(예: IP 주소)
   * 악의적인 트래픽과 관련된 것으로 알려진 트래픽 패턴

  기능을 사용해 보고 피드백을 공유하고 싶으십니까? 얼리 어답터 프로그램에 대한 자세한 내용을 보려면 (으)로 이메일을 보내십시오. [aemcs-waf-adopter@adobe.com](mailto:aemcs-waf-adopter@adobe.com) (공식 이메일 ID에서) 인원이 한정되어 있습니다.
...
* **기타 기초 변경 사항** - 2023년 8월 7일이 있는 주 동안 AEM AEM 인스턴스에 대한 요청이 정상 수준을 초과하면 오류 코드 503 대신 오류 코드 429를 반환합니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/development-guidelines.html?lang=en).

### [!DNL Cloud Manager]

_새로운 기능_

* 이제 Cloud Manager 랜딩 페이지의 카드에 해당 프로그램에 대한 [향상된 보안](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/programs/creating-production-programs.html?lang=en) 기능이 활성화되어 있는지 여부가 표시됩니다.
* 개발인 경우 [파이프라인](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html?lang=en) 에는 테스트 단계가 포함되어 있지 않습니다. 사용자가 테스트 단계를 포함할 때 선택적으로 포함할 수 있습니다. [파이프라인 시작](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/managing-pipelines.html?lang=en#running-pipelines). 이 기능은 단계적으로 출시될 예정입니다.
* 날짜 [실행 취소](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/managing-pipelines.html?lang=en#view-details)이제 파이프라인 실행 승인 단계에서 사용자에게 취소 이유를 입력하도록 요청합니다. 이 기능은 단계적으로 출시될 예정입니다.
* 이제 사용자가 액세스할 수 있음 [콘텐츠 복사 프로세스의 로그](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/content-copy.html?lang=en#accessing-logs). 이 옵션은 소스 및 대상 환경이 모두 AEM 2023.7.12549 이상에 있는 경우에만 사용할 수 있습니다.

**버그 수정**

* 에서 작성 사용자 인터페이스로 이동 [!DNL Cloud Manager] 더 이상 로 리디렉션하지 못함 [!DNL Experience Cloud] 로그인 후.
* 이제 Go-Live 위젯을 통해 Go-Live 날짜를 편집하면 향상된 보안 탭 대신 Go-Live 탭으로 이동합니다.
* 복사 작업을 시작할 때 사용자는 복사 작업이 이미 호출된 환경을 더 이상 선택할 수 없습니다.

### [!DNL Workfront for Experience Manager] 강화 커넥터

의 최신 버전 1.9.11에 대한 릴리스 날짜 [!DNL Workfront] 대상 [!DNL Experience Manager] 향상된 커넥터는 2023년 6월 19일입니다.

_릴리스 하이라이트_

* 고급 네트워킹을 구성했으면 Adobe Workfront에서 로 콘텐츠를 전송하는 동안 문제가 발생합니다. [!DNL AEM as a Cloud Service].

>[!NOTE]
>
>AEM 6.4는 이제 확장 지원이 종료되었습니다. 자세한 내용은 Adobe [기술 지원 기간](https://helpx.adobe.com/kr/support/programs/eol-matrix.html). 다음 찾기 [여기에서 지원되는 버전](https://experienceleague.adobe.com/docs/?lang=en).
...
* Classic 사용 시 [!DNL Workfront] 경험, **전송 대상** 옵션이에서 사용할 수 있음 **자세히** 드롭다운 목록에서는 Experience Manager 내의 대상 을 선택할 수 없습니다. **수신인** 옵션은 **문서 작업** 드롭다운 목록을 사용하여 올바르게 작동합니다. The **수신인** 옵션은 새로운 Workfront 경험에서 사용할 수 있는 **추가** 드롭다운 목록 및 **문서 작업** 목록에서 올바르게 작동합니다.

### 커뮤니티

* [!DNL Experience Manager as a Cloud Service] 2023.7.0 - 릴리스 업데이트: [https://adobe.ly/3Y6CC6J](https://adobe.ly/3Y6CC6J)
* AEM GEM, 2023년 6월 28일 - 레코딩은 &quot;기본 the Art of Experience Manager 인증: Get Ready, Get Set, Get Certified!&quot;에 제공됩니다.: [https://adobe.ly/3p2CmbA](https://adobe.ly/3p2CmbA)
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2023년 8월 | [!DNL AEM] | [Cloud Service의 보안 전략](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html) | 비디오 | 디지털 환경을 안전하게 보호하고 보호하는 방법에 대해 알아봅니다. |
| 2023년 8월 | [!DNL AEM Assets] | [기본 AEM Assets 탐색](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html) | 업데이트된 비디오 | 탐색의 기본 사항 살펴보기 [!DNL AEM Assets]. |
| 2023년 8월 | [!DNL AEM Cloud Manager] | [[!DNL AEM Cloud Manager] 챔피언 운영 시간](https://experienceleague.adobe.com/docs/events/aem-champion-office-hours/2023/may.html) | 비디오 | 다음에 대해 알아보기 [!DNL AEM Cloud Manager] AEM Champions의 우수 사례입니다. |
| 2023년 8월 | [!DNL AEM Forms] | [Azure Storage에서 양식 데이터 유지](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/prefill-azure-storage/introduction.html) | 문서 | Azure Storage를 사용하여 적응형 양식의 채우기를 저장하고 다시 시작하여 양식 데이터를 유지하는 방법에 대해 알아봅니다. |
| 2023년 8월 | [!DNL AEM Forms] | [AEM Forms에서 SendGrid를 사용하여 이메일 보내기](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/send-grid.html) | 문서 | 사용 방법 알아보기 [!DNL SendGrid] AEM Forms에서 이메일을 전송합니다. |
| 2023년 8월 | [!DNL AEM Sites] | [개발자를 위한 CSRF 보호](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/advanced/csrf-protection.html) | 문서 | 인증된 사용자를 위해 AEM에 POST, PUT 및 DELETE 요청에 AEM CSRF 토큰을 추가하는 방법을 알아봅니다. |
| 2023년 8월 | [!DNL AEM Sites] | [[!DNL AEM Sites] 챔피언 운영 시간](https://experienceleague.adobe.com/docs/events/aem-champion-office-hours/2023/march.html) | 비디오 | 다음에 대해 알아보기 [!DNL AEM Sites] AEM Champions의 우수 사례입니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2023년 7월 | [일괄 컨텐츠가 있는 오류 메시지와 함께 자산 업로드가 실패합니다](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22476.html) | 신규 문서 | 폴더에 여러 자산을 업로드하면 오류가 발생하는 문제에 대한 해결 방법을 알아봅니다. |
| 2023년 7월 | [AEM 설치 오류 *검색 경로 임계값에 도달할 때까지 스타일을 찾을 수 없음*](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22472.html) | 신규 문서 | 오류가 발생한 문제에 대한 해결 방법 알아보기 _검색 경로 임계값에 도달할 때까지 스타일을 찾을 수 없음_ AEM 6.5.17을 설치한 후 나타납니다. |
| 2023년 7월 | [사이트 콘솔에 게시된 페이지의 표시 형식을 사용자 지정하는 방법](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22473.html) | 신규 문서 | 게시된 날짜의 날짜/시간 포맷을 사용자 정의하여 시간을 포함하는 방법에 대해 알아봅니다. |
...
* 다음을 참조하십시오 [의 릴리스 정보 [!DNL Adobe Commerce] 및 [!DNL Magento Open Source]](https://experienceleague.adobe.com/docs/commerce-operations/release/notes/overview.html) 최신 상태로 유지하려면
...
에 대한 새로운 튜토리얼 [!DNL Adobe Commerce] Experience League.

| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 8월 | [느린 MySQL 복제 설명](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/galera-db-slow-replication.html) | 비디오 | Galera DB 복제 및 관련 MySQL 느린 쿼리에 대해 알아봅니다. |
| 2023년 8월 | [MySQL 쿼리 캐시](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/mysql-query-cache.html) | 비디오 | Mysql 쿼리 캐시에 대해 알아봅니다. |
...
| 2023년 7월 | [_파일을 삭제할 수 없습니다. 경고!unlink: 관리자의 파일 또는 디렉터리 오류가 없습니다._](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/file-cannot-be-deleated-no-file-or-directory.html) | 신규 문서 | 사용자에게 오류가 표시되는 문제에 대한 해결 방법 알아보기 _파일을 삭제할 수 없습니다. 경고!unlink: 해당 파일 또는 디렉터리 오류가 없습니다._ JavaScript/CSS 플러시를 수행할 때 Commerce Admin에서. |
...
* 신규! Campaign 컨트롤 패널: [릴리스 정보](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=ko)
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2023년 7월 | [ACC 플랫폼에서 받은 이메일에 자동 회신](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22514.html) | 신규 문서 | 플랫폼에서 전송된 이메일에 대한 자동 응답을 구현하는 해결 방법에 대해 알아봅니다. |
| 2023년 7월 | [OOTB의 웨어하우스 시간 초과로 인한 데이터 동기화 문제](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22499.html) | 신규 문서 | OOTB가 발생하는 문제에 대한 솔루션 알아보기 `ffdaReplicateStagingData` 워크플로우가 데이터를 동기화하지 않습니다. |
| 2023년 7월 | [Adobe Analytics을 통한 ACS에서의 데이터 검색 불일치](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22483.html) | 신규 문서 | ACS에서 데이터 검색이 일치하지 않는 문제에 대한 해결 방법을 알아봅니다. |
| 2023년 7월 | [Adobe Campaign Classic과 HIGH-2023 간의 호환성](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22496.html) | 신규 문서 | 간의 호환성에 대해 자세히 알아보기 [!DNL Campaign Classic] v7.3 및 HIGH-2023 |
| 2023년 7월 | [이메일 디자이너에 이미지가 표시되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22179.html) | 신규 문서 | 이메일/게재에 업로드된 이미지가 이메일 디자이너 인터페이스에 표시되지 않는(끊어진 이미지 아이콘 표시) 문제에 대한 해결 방법을 알아봅니다. |
| 2023년 7월 | [게재 활동 DCE 모드에서 이메일을 볼 수 없음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22417.html) | 신규 문서 | DCE 모드 스크롤바에서 사용자가 게재 활동에서 전체 이메일을 보지 못하도록 하는 문제에 대한 해결 방법을 알아봅니다. |
| 2023년 7월 | [파일 업로드 위치 [!DNL Azure Blob] 저장소 - CRL-290029 금지됨](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22375.html) | 신규 문서 | 사용자가에 파일 전송 활동(액션-파일 업로드)을 추가하려고 할 때 나타나는 오류를 해결하는 방법에 대해 알아봅니다 [!DNL Azure Blob]. |
| 2023년 7월 | [감독자 그룹의 사용자에게 워크플로우 경고가 전송되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22371.html) | 신규 문서 | 감독자 그룹의 사용자에게 워크플로우 경고가 전송되지 않는 문제에 대한 해결 방법을 알아봅니다. |
| 2023년 7월 | [이미지가 공개 리소스에 업로드되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22395.html) | 신규 문서 | 모든 공개 리소스 폴더에서 프로덕션에 이미지를 업로드하는 동안 발생하는 오류를 해결하는 방법에 대해 알아봅니다. |
| 2023년 7월 | [워크플로우가 클라이언트 콘솔을 충돌시킵니다.](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22393.html) | 신규 문서 | 워크플로우가 클라이언트 콘솔과 충돌하는 문제를 해결하는 방법을 알아봅니다. |
...
[Journey Optimizer 릴리스 정보](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=ko-KR)에서 최신 기능, 개선 사항 및 수정 사항에 대해 알아보십시오.
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- |---------- |
| 2023년 7월 | [푸시 알림 캠페인 구성 및 전송](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/push-channel/create-a-push-campaign.html) | 비디오 | 캠페인을 사용하여 푸시 알림을 구성하고 보내는 방법을 알아봅니다. |
...
* 다음을 참조하십시오 [2023년 9월 - 최신 릴리스 정보](https://experienceleague.adobe.com/docs/marketo/using/release-notes/current.html) 최신 정보를 위하여
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- |---------- |
| 2023년 8월 | [참여 맵 개요](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/engagement-maps/engagement-map-overview.html) | 비디오 | 다음을 사용하여 재사용 가능한 캠페인을 구축하고 속도를 높이는 방법에 대해 알아봅니다. [!UICONTROL 참여 맵]. |
| 2023년 8월 | [참여 맵 중첩 캠페인](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/engagement-maps/engagement-map-nested-campaign.html) | 비디오 | 상호 연결되고 깊이 중첩된 캠페인을 해독하여 를 사용하여 전체 고객 여정에 대한 가시성을 향상시킵니다. [!UICONTROL 참여 맵]. |
| 2023년 8월 | [참여 맵 오류 감지 및 해결](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/engagement-maps/engagement-map-error-detection-and-resolution.html) | 비디오 | 방법 알아보기 [!UICONTROL 참여 맵] 는 캠페인 문제의 신속한 해결 및 해결을 지원합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- |---------- |
| 2023년 8월 | [관리자를 위한 프로젝트 재무](https://experienceleague.adobe.com/docs/courses/using/workfront-a-1-2023-1-finances.html) | 교육 과정 | 에서 청구 및 보고의 일관성을 보장하기 위해 재무 설정을 설정하는 방법에 대해 알아봅니다. [!DNL Workfront] 인스턴스 또는 그룹. |
| 2023년 8월 | [사용자를 위한 프로젝트 재무](https://experienceleague.adobe.com/docs/courses/using/workfront-u-1-2023-1-finances.html) | 교육 과정 | 프로젝트에 대한 재무 정보를 추적하고, 비용 및 수익 유형을 설정하고, 청구 요금을 재정의하는 방법을 알아봅니다. |
| 2023년 8월 | [흐름 요청에 대한 설정 이해](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/request-queues/understand-settings-for-a-flow-request.html) | 비디오 | 에서 요청 흐름이 어떻게 처리되는지 알아봅니다. [!DNL Workfront] 효과가 있습니다. 그런 다음 라우팅 규칙, 주제 그룹 및 대기열 주제를 만듭니다. |
| 2023년 8월 | [프로젝트 간 전임 작업 이해](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/intermediate-projects/understand-cross-project-predecessors.html?lang=en) | 비디오 | 둘 이상의 프로젝트에서 전임 작업 을 사용하고 추적하는 방법에 대해 알아봅니다. |
| 2023년 8월 | [프로젝트 타임라인 이해](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/project-timelines/understand-project-timelines.html?lang=en) | 비디오 | 시작 또는 완료 날짜부터 프로젝트를 예약하는 방법을 알아보고 기간, 전임 작업 및 작업 제한이 프로젝트 계획에 어떤 영향을 미치는지 알아봅니다. |
| 2023년 8월 | [프로젝트 공유](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/projects/share-a-project.html?lang=ko) | 비디오 | 이해 당사자와 프로젝트에 관심이 있는 다른 사람이 을 사용하여 진행 중인 작업을 볼 수 있도록 프로젝트를 공유하는 방법을 알아봅니다  [!DNL Workfront]. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 7월 | [증명을 업로드하는 중 증명 문제, 블루바가 무기한 스크롤됨](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22364.html) | 신규 문서 | 새 증명을 업로드할 때 발생하는 오류를 해결하는 방법을 알아봅니다. |
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2023년 8월 | Acrobat Sign | [사용 사례: 교육 IEP 프로세스를 위한 맞춤형 워크플로](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/edu/usecase-edu-iep.html) | 비디오 | 맞춤형 워크플로 디자이너를 사용하여 K-12 학교의 IEP(Indialized Education Program) 프로세스를 디지털화하는 방법에 대해 알아봅니다. |
| 2023년 8월 | Acrobat Sign | [사용 사례: Education 웹 양식 인턴십 애플리케이션](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/edu/usecase-edu-intern.html) | 비디오 | 웹 양식을 사용하여 모든 장치 및 모든 위치에서 제출할 수 있는 필수 양식에 대한 학생들의 액세스를 향상시켜 교육 승인 프로세스를 가속화하는 방법에 대해 알아봅니다. |
| 2023년 8월 | Acrobat Sign | [사용 사례: 교육 웹 양식 인턴십 애플리케이션 만들기](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/edu/usecase-edu-intern-create.html) | 비디오 | 인턴십 웹 양식을 만들어 모든 장치 및 모든 위치에서 제출할 수 있는 필수 양식에 대한 학생 액세스 권한을 향상시키는 방법에 대해 알아봅니다. |
| 2023년 8월 | Acrobat Sign | [SharePoint Online과 웹 양식 통합](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/integrate-web-form-sharepoint-online.html) | 비디오 | 웹 양식에서 수집된 데이터를 SharePoint 목록에 매핑하여 팀 간에 수집된 데이터를 공유하는 방법을 알아봅니다. |
| 2023년 8월 | Acrobat Sign | [사용 사례: 여러 알 수 없는 서명자가 있는 정부 대출 신청](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/gov/webform-multiple-signers.html) | 비디오 | 알 수 없는 여러 참가자가 포함된 복잡한 정부 대출 애플리케이션 워크플로에 웹 양식을 사용하는 방법을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- |---------- |
| 2023년 8월 | [Firefly을 사용하여 블로그의 그래픽 콘텐츠 만들기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-blog-graphics.html) | 비디오 | Adobe Express에서 Adobe Firefly 기반의 Text to Image를 사용하여 블로그의 고유한 그래픽 콘텐츠를 만드는 방법에 대해 알아봅니다. |
| 2023년 8월 | [Firefly을 사용하여 채용 및 온보딩 컨텐츠 만들기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-on-boarding.html) | 비디오 | Adobe Express에서 Adobe Firefly 기반의 텍스트를 이미지로 사용하여 직원 채용 및 온보딩 콘텐츠를 위한 고유한 그래픽을 만드는 방법에 대해 알아봅니다. |
| 2023년 8월 | [Firefly을 사용하여 마케팅 캠페인용 플라이어 콘텐츠 만들기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-local-marketing.html) | 비디오 | 글로벌 호텔 마케팅 캠페인에서 Adobe Express에서 Adobe Firefly 기반의 텍스트를 이미지로 사용하여 현지화된 콘텐츠를 만드는 방법에 대해 알아봅니다. |
