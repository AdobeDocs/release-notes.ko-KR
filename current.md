...
최종 업데이트: **2022년 3월 14일**, 3월 12일 릴리스
...
| [!UICONTROL 포트폴리오] <br> [!UICONTROL 캠페인] | (Beta 기능, [!DNL Microsoft® Advertising] 캠페인) - 이제 [!UICONTROL 전환 최대화] 입찰 전략을 사용하도록 검색 캠페인을 구성하고 선택적으로 클릭당 최대 비용을 설정할 수 있습니다.<br>다른 자동 입찰 전략에 대한 하이브리드 최적화 Beta에 이미 참여하고 있는 경우 [!UICONTROL 전환 최대화] 전략에 자동으로 액세스할 수 있으며 [!UICONTROL 전환 최대화] 전략이 포함된 캠페인을 하이브리드 포트폴리오에 포함할 수 있습니다. 하이브리드 포트폴리오에서 이 전략을 사용하려면 [!DNL Microsoft® Ads]에 Advertising Cloud Search 목표를 업로드할 수 있어야 합니다. 아직 Beta에 참여하지 않았으며 가입하고자 하는 경우 [!DNL Adobe] 계정 관리자에게 문의하십시오. |
| Campaign [!UICONTROL Audiences]<br><br>Campaign [!UICONTROL Bulksheets] | ([!DNL Microsoft® Advertising] 캠페인) - 이제 마켓 내 대상을 제외한 모든 [!DNL Microsoft® Advertising] 대상을 캠페인 수준 타겟 또는 [!UICONTROL 광고 그룹] 수준 타겟으로 사용할 수 있습니다. 이전에는 [!UICONTROL 광고 그룹] 수준 타겟으로만 사용할 수 있었습니다. |
| 캠페인 [!UICONTROL 대상] | (Beta 기능, [!UICONTROL 고객 일치] 타겟팅에 적합한 [!DNL Microsoft® Advertising] 계정) 이제 이메일 주소가 포함된 CSV 파일을 업로드하여 고객 일치 대상을 만들고 관리할 수 있습니다. 해당 데이터는 SHA-256 알고리즘을 사용하여 해시해야 합니다. |
