...
# Experience Cloud central 릴리스 노트 - 2025년 11월
...
* Experience League의 새 [과정](https://experienceleague.adobe.com/ko/courses):

  새로운 교육 과정은 마케터, 실무자, 관리자, 개발자 및 기타 사용자가 기술을 더 빠르게 구축하고, 전문성을 검증하고, Adobe 솔루션 전반에서 보다 자신 있게 진행할 수 있도록 설계된 구조화된 전문가 생성 학습을 제공합니다. 각 과정은 공유 가능한 완료 인증서로 마무리되며, 내부적으로 또는 LinkedIn에서 성과를 강조할 수 있는 확실한 방법을 제공합니다.

* AEM의 [Agentic AI](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/ai-in-aem/overview?#agentic-ai-in-aem)
* 11월 이벤트 업데이트, 새로운 비디오 튜토리얼 및 이 페이지의 지원 문서 업데이트.
