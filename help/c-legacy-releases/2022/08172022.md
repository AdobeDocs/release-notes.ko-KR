...
* 이제 Experience Manager as a Cloud Service에서 `mod_macro`을(를) 사용할 수 있습니다. [지원되는 Apache 모듈의 목록은 이 표](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html)을(를) 참조하십시오.
...
| 2022년 8월 | [AEM Headless 튜토리얼](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html) | 업데이트된 문서 | AEM Headless SDK 자습서가 지속 쿼리 및 WKND 2.0을 사용하도록 업데이트되었습니다. 실습형 튜토리얼을 사용하여 다양한 옵션을 사용하는 방법을 살펴보고 자신에게 적합한 옵션을 선택하십시오. | AEM as a Cloud Service |
