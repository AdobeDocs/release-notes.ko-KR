...
[2022년 7월 릴리스 개요 비디오](https://video.tv.adobe.com/v/3454203/?captions=kor&quality=12)를 시청하여 2022.7.0(2022년 7월) 릴리스에 추가된 기능에 대한 간단한 요약을 살펴보십시오. <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* 이제 Experience Manager as a Cloud Service에서 `mod_macro`을(를) 사용할 수 있습니다. [지원되는 Apache 모듈의 목록은 이 표](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html?lang=ko)을(를) 참조하십시오.
