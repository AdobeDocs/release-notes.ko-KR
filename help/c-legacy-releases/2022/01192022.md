...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [Customer AI 구성](https://experienceleague.adobe.com/docs/platform-learn/tutorials/intelligent-services/configure-customer-ai.html?lang=ko) | 비디오 | 고객 AI 인스턴스를 만들어 고객 행동을 예측하는 방법을 알아봅니다. |
| 2022년 1월 | [Attribution AI 구성](https://experienceleague.adobe.com/docs/platform-learn/tutorials/intelligent-services/configure-attribution-ai.html?lang=ko) | 비디오 | 마케팅 채널 및 캠페인의 영향력을 파악하기 위해 Attribution AI 인스턴스를 만드는 방법을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [비즈니스 사용자를 위한 Analytics 기본 사항이 삭제되었습니다.](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/retire-fundamentals-for-business-users-course.html?lang=ko) | 비디오 | 원래 교육 과정이 삭제된 이유 및 Adobe에서 권장하는 새로운 대체 교육 과정에 대해 알아봅니다. |
...
| 2022년 1월 | [Analysis Workspace에서 치수로 세그먼트 사용](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.html?lang=ko) | 업데이트된 비디오 | Analysis Workspace에서 세그먼트를 치수로 사용하여 비교하고 시각화하는 방법에 대해 알아봅니다. |
