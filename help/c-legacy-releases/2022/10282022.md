...
* 대부분의 대화 상자 필드에서의 [Campaign 변수 삽입](https://github.com/adobe/aem-core-email-components/wiki/RTE-Personalization) 및 유연한 [세분화 구성 요소](https://github.com/adobe/aem-core-email-components/wiki/)를 통해 고급 개인화 및 세분화 기능을 제공합니다.
