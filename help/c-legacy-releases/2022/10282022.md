...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 12월 | [향상된 보안](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/enhancing-security.html) | 업데이트된 비디오 | Adobe Analytics 액세스를 제어하기 위한 회사 설정의 보안 관리자 설정에 대해 알아봅니다. 여기에는 강력한 암호, 암호 만료일 및 복구 기능, 이메일 도메인 제한 사항이 포함됩니다. |
...
| 2022년 11월 | [Analytics란?](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-is-analytics.html) | 문서 | Adobe Analytics를 배우기 전에 분석의 기본 사항에 대해 알아봅니다. |
| 2022년 11월 | [대시보드에 대한 사용자 정의 세부 정보 보기 만들기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/additional-tools/analytics-dashboards/create-custom-detail-views.html) | 비디오 | Adobe Analytics 대시보드의 텍스트를 포함하여 세부 정보 보기를 사용자 정의하고 모바일 스코어카드 프로젝트를 통해 관련자들에게 전하고 싶은 스토리를 구체화하는 방법에 대해 알아봅니다. |
| 2022년 11월 | [주요 지표 요약 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/key-metric-summary.html) | 비디오 | 단일 기간 내에서 중요한 지표의 추세를 확인할 수 있는 Analysis Workspace의 주요 지표 요약 시각화에 대해 알아봅니다. 또한 두 기간에 걸쳐 지표의 성능을 비교할 수 있습니다. |
...
Workfront for Experience Manager 강화 커넥터의 [최신 1.9.3 버전으로 업그레이드](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html)하는 것이 좋습니다.
...
| 2022년 12월 | [기본 React 앱](https://experienceleague.adobe.com/landing/experience-manager/headless/developer/code/basic-react-app.html) | 비디오 | 지속 쿼리를 사용하여 AEM의 GraphQL API를 사용하여 콘텐츠를 쿼리하는 방법에 대해 알아봅니다. 이 애플리케이션은 필터링 가능한 WKND 모험을 렌더링하며, 모험을 선택하면 모험의 전체 세부 정보를 표시합니다. | AEM Headless 개발자 포털 |
| 2022년 12월 | [jQuery 및 Handlebars 코드 샘플 필터링](https://experienceleague.adobe.com/landing/experience-manager/headless/developer/code/filtering-jquery-handlebars.html) | 비디오 | jQuery 및 Handlebars를 사용하는 JavaScript 앱을 사용하여 데이터를 필터링하는 AEM Headless GraphQL API 기능을 살펴봅니다. 이 앱은 활동 유형별로 필터링 가능한 WKND 모험 목록을 생성합니다. | AEM Headless 개발자 포털 |
...
| 2022년 10월 | [Adobe Commerce 지원 기술 자료](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/overview.html) | 지원 설명서 | 문제 해결 및 모범 사례를 다루고, 발표를 호스팅하고, FAQ에 답변하고, 공식 문서에서 (어떤 이유로든) 언급되지 않은 특정 시나리오를 강조합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | --------- | ---------- |
| 2022년 11월 | [조건 규칙 빌더로 동적 콘텐츠 만들기](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/personalize-content/create-dynamic-content.html) | 비디오 | 조건 규칙을 만들고 저장하는 방법과 이러한 조건 규칙을 모든 채널의 콘텐츠에 적용하는 방법을 알아봅니다. |
...
| 2022년 11월 | [D-Trust를 사용하여 등록 및 서명](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/digital-id/dtrust/d-trust.html) | 비디오 | D-Trust에 ID를 등록한 후 문서에 D-Trust 디지털 서명을 사용하는 방법을 알아봅니다. | Acrobat Sign |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 11월 | [놀라운 디지털 에셋](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/stunning-digital-assets.html) | PDF | 이 실습형 튜토리얼에서는 Adobe Stock을 CC Libraries와 통합하여 인쇄 및 화면에 대한 일관되고 전문적인 디자인 결과를 만드는 방법을 알아봅니다. |
| 2022년 11월 | [CC Libraries로 CC 워크플로 개선](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/cceoverview/ccetutorials/cc-workflows-cc-libraries.html) | PDF | 이 실습형 튜토리얼에서는 Creative Cloud Libraries가 디자인 요소를 함께 유지하여 디자이너와 팀의 프로젝트 일관성을 보장하는 방법을 알아봅니다. |
| 2022년 11월 | [Frame.io로 비디오 검토](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/videooverview/videotutorials/video-review-frame-io.html) | PDF | 이 실습형 튜토리얼에서는 Adobe Premiere Pro용 Frame.io 확장을 사용하여 에셋을 중앙 집중화 및 공유하고, 실시간 댓글을 받고, 수정 사항을 추적하고, 타임라인을 벗어나지 않고도 더 빠르게 승인을 받는 방법을 알아봅니다. |
