...
* **AEM 커뮤니티 사용자의 최신 블로그**
   * [AEM JMX를 통해 Oak 색인을 트리거하여 변경된 색인 정의를 적용하는 프로세스를 시작하는 방법](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/how-to-trigger-oak-index-via-aem-jmx-to-start-the-process-of/ba-p/650118?profile.language=ko)
   * [분류를 AEM Assets으로 마이그레이션하지 않는 방법](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/how-not-to-migrate-taxonomies-to-aem-assets/ba-p/648931?profile.language=ko)
   * [AEM의 숨겨진 힘 살펴보기: OSGi Marvels 잠금 해제](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/exploring-aem-s-hidden-power-unlocking-osgi-marvels/ba-p/648162?profile.language=ko)
   * [AEM 6.5.5 인덱싱 문제 *해결됨*](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-6-5-5-not-indexing-problem-fixed/ba-p/639836?profile.language=ko)
...
* [Adobe Primetime 릴리스 노트](https://experienceleague.adobe.com/docs/pass.html?lang=ko-KR)
...
* **새로 만들기!** [!DNL Campaign Web Interface]: [새로운 기능](https://experienceleague.adobe.com/docs/campaign-web/v8/whats-new.html?lang=ko-KR) | [제품 설명서](https://experienceleague.adobe.com/docs/campaign-web/v8/campaign-web-home.html?lang=ko-KR)

* **새로 만들기!** [!DNL Campaign] v8.6: [릴리스 노트](https://experienceleague.adobe.com/docs/campaign/campaign-v8/releases/release-notes.html?lang=ko-KR) | [제품 설명서](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=ko-KR)
