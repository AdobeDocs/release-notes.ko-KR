...
| 공지 | 추가 또는 업데이트 날짜 | 설명 |
| ----------- | ---------- | ---------- |
| Adobe Data Connectors의 EOL | 2021년 8월 3일 | Adobe [!UICONTROL Data Connectors]는 더 이상 실행 불가능하거나 지원되지 않는 레거시 기술을 기반으로 합니다. 이 표준을 사용하여 모든 통합이 지속적으로 제공되고 지원될 수 있습니다. 공식적인 서비스 종료 날짜는 **2021년 8월 19일**&#x200B;입니다. [자세히 알아보기...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=ko) |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 7월 | [프로젝트에서 도넛 시각화 사용](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/using-the-donut-visualization.html?lang=ko) | 비디오 | Analysis Workspace 프로젝트에서 도넛 시각화를 추가하고 구성하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [막대 및 스택 막대 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/bar-and-bar-stacked-visualizations.html?lang=ko) | 비디오 | 이 비디오에서는 Analysis Workspace에서 프로젝트에 막대, 스택 막대, 가로 막대 및 스택 가로 막대 시각화를 추가 및 구성하는 방법에 대해 설명합니다. 기본적인 수준이더라도 이러한 시각화는 분석가에게 데이터에 대한 스토리를 전달하고 통찰력을 제공하는 데 도움이 될 수 있습니다. |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
     ...
     자세한 내용은 [Experience Manager Guides](https://business.adobe.com/kr/products/experience-manager/guides/aem-guides.html)를 참조하십시오.
...
| 2021년 7월 | [Adobe PDF Embed API를 사용하여 디지털 문서 게시](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/ddppdfembedapi.html?lang=ko) | 문서 | PDF 뷰어를 웹 페이지에 임베드하면 사용자가 HTML 및 CSS 디자인을 변경하거나 웹 사이트에 대한 액세스를 방해하지 않고 문서를 볼 수 있습니다. |
| 2021년 7월 | [Adobe Document Services API를 통한 학생과 교사의 공동 작업](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/educationcollab.html?lang=ko) | 문서 | PDF Services API에 액세스하기 위해 `Node.js` 애플리케이션에 대한 공식 SDK에 대해 알아봅니다. 이를 통해 Microsoft® Word 또는 Microsoft® Excel과 같은 문서를 PDF로 변환할 수 있습니다. |
| 2021년 7월 | [Adobe Document Services API를 통한 채용 공고](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/jobposting.html?lang=ko) | 문서 | 여러 사용자와 함께 웹 사이트를 운영하는 경우, 모든 사용자가 원활한 경험을 할 수 있는 환경을 설계하는 것이 중요합니다. 자동으로 모든 업로드된 문서를 PDF로 변환하고 게시물에 인라인으로 임베드하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 보고서 생성 및 편집](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reportcreation.html?lang=ko) | 문서 | PDF를 통해 테이블, 그래픽 및 인터랙티브 콘텐츠와 함께 풍부한 문서를 모든 사용자가 볼 수 있는 형식으로 손쉽게 공유할 수 있습니다. 이러한 통계를 경영진, 주주, 기부자 또는 다른 관련자와 공유하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 검토 및 승인](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reviews.html?lang=ko) | 문서 | 몇 가지 Adobe Document Services API를 사용하여 실습형 검토 및 승인 사용 사례를 해결하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 검색 및 색인화](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html?lang=ko) | 문서 | 이 튜토리얼에서는 Adobe Document Services API의 환상적인 기능과 이 기능을 사용하여 문서를 손쉽게 보관하고 디지털화하는 방법에 대해 알아봅니다. Express NodeJS 애플리케이션을 만든 다음 보관, 디지털화 및 문서 변형을 위한 문서 서비스 API를 통합하여 이러한 기능을 살펴봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 직원 제안서 관리](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/offer.html?lang=ko) | 문서 | 이 튜토리얼은 사용자가 직업 세부 정보로 채울 웹 양식을 표시하는 Node Express 프로젝트를 설정하는 과정을 안내합니다. 이러한 세부 정보는 웹을 통해 문서 서비스를 사용하여 제안서를 PDF로 생성하며 해당 PDF는 나중에 Adobe Sign API를 사용하여 고객에게 서명용으로 전달될 수 있습니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 법적 계약 관리](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/legal.html?lang=ko) | 문서 | 이 튜토리얼에서는 문서의 사용자 정의 입력 필드 생성에 대한 Adobe Document Services API의 기능을 살펴봅니다. 또한 이렇게 생성된 문서를 보호된 portable document format(PDF)으로 손쉽게 변환하여 데이터 조작을 방지하는 방법에 대해 살펴봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 NDA 작성](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/nda.html?lang=ko) | 문서 | 회사 NDA를 위한 Microsoft® Word 템플릿을 제작하는 방법에 대해 알아봅니다. Adobe의 Microsoft® Word용 무료 추가 기능인 Adobe Document Generation Tagger는 &quot;태그&quot;를 삽입하여 동적 값을 입력하는 데 도움이 됩니다. 템플릿에 JSON 데이터를 전달하고 동적 PDF를 제작하는 방법에 대해 배울 수도 있습니다. 그런 다음 비즈니스 요구 사항 및 목표에 따라 해당 PDF를 이메일로 보내거나 브라우저에 표시하여 공동 작업자에게 보여 줄 수 있습니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 판매 제안서 및 계약서 관리](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/sales.html?lang=ko) | 문서 | 동적 데이터 및 워크플로를 사용하여 판매 제안서를 작성하기 위한 효율적인 프로세스를 구축하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [Adobe Document Generation API를 통해 인보이스 처리](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/invoices.html?lang=ko) | 문서 | Adobe Document Generation API를 사용하여 자동으로 인보이스를 생성하고, PDF를 암호로 보호하고, 각각의 고객에게 인보이스를 전달하는 방법에 대해 알아봅니다. Node.js, JavaScript, Express.js, HTML 및 CSS에 대한 약간의 지식만 있으면 됩니다. |
