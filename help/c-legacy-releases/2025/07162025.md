...
* [Experience Cloud 애플리케이션의 생성 AI](https://experienceleague.adobe.com/ko/docs/core-services/interface/features/generative-ai)
...
| 2025년 6월 | [Adobe Experience Platform 액세스할 수 없음](https://experienceleague.adobe.com/ko/docs/experience-cloud-kcs/kbarticles/ka-26778) | 신규 문서 | 다음 오류가 발생하는 문제에 대한 솔루션을 알아봅니다. *이 사용자에게는 샌드박스가 활성화되어 있지 않습니다. 조직의 관리자에게 연락하여 최소 하나 이상의 샌드박스에 대한 액세스 권한을 요청하십시오.* Adobe Experience Platform에서 관리 권한이 있는 올바른 제품 프로필에 추가되었더라도 말이다. |
...
| 2025년 6월 | [AEM Cloud 미리 보기에는 *작동합니다!* 사이트 홈 페이지 &#x200B;](https://experienceleague.adobe.com/ko/docs/experience-cloud-kcs/kbarticles/ka-26745) 대신 | 신규 문서 | Adobe Experience Manager(AEM) _게시_ 또는 _미리보기_ 환경에 *작동 중!*&#x200B;이 표시되는 경우 문제의 해결 방법에 대해 알아봅니다. 사이트의 홈 페이지 대신 메시지를 표시합니다. |
...
| 2025년 6월 | [여러 주소가 있는 경우 결제 방법이 체크아웃에 표시되지 않음](https://experienceleague.adobe.com/ko/docs/experience-cloud-kcs/kbarticles/ka-26824) | 신규 문서 | 여러 배송 주소를 사용하는 경우 체크아웃 시 대부분의 결제 방법이 표시되지 않는 문제에 대한 솔루션을 알아봅니다. |
...
* [!DNL Campaign] v8: 2025년 7월 9일 목요일 - [릴리스 정보](https://experienceleague.adobe.com/ko/docs/campaign/campaign-v8/releases/release-notes#release-8-7-4) | [제품 설명서](https://experienceleague.adobe.com/ko/docs/campaign/campaign-v8/campaign-home)
...
| 2025년 7월 | [!DNL Journey Optimizer] | [이메일 채널 구성](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/email-channel/configure-email-channel) | 새 비디오 | Adobe Journey Optimizer.에서 이메일 채널을 구성하는 방법에 대해 알아봅니다. |
