...
9월 릴리스 - [Journey Orchestration에 대한 릴리스 정보](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html#september-release)를 참조하십시오.
...
| 2020년 9월 23일 | [Adobe Analytics로 페이지 데이터 수집](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/analytics/collect-data-analytics.html) | 문서 | AEM 핵심 구성 요소와 함께 Adobe Client Data Layer의 기본 제공 기능을 사용하여 Adobe Experience Manager Sites의 페이지에 대한 데이터를 수집하는 방법을 알아봅니다. |
