...
* Adobe ID를 사용하면 제품, 지역 및 이벤트 환경 설정에 따라 이벤트 알림을 구독할 수 있습니다. 구독 환경 설정을 구성하는 사용자는 관련 제품 인시던트 및 유지 관리 이벤트가 열리거나 업데이트되거나 종료되면 이런 이벤트에 대한 알림을 받게 됩니다. [status.adobe.com/subscriptions](https://status.adobe.com/ko-kr/proactive-notifications/subscriptions/edit)에서 시작해 보십시오.
...
* **새로운 기능: AEM as a Cloud Service**
  ...
  [Adobe Experience Manager](https://business.adobe.com/kr/products/experience-manager/adobe-experience-manager.html)&#x200B;(AEM)는 이제 클라우드 서비스로 사용할 수 있습니다.
