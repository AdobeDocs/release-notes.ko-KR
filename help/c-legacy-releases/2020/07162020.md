...
# Adobe Experience Cloud 릴리스 정보 - 2020년 7월
...
Experience Cloud에서 **2020년 7월 16일** 릴리스는 애플리케이션 전환기 드롭다운 메뉴를 업데이트합니다. 솔루션 로고가 제거되고 액세스 권한이 있는 애플리케이션 및 서비스만 메뉴에 표시되도록 간소화되었습니다.

예를 보려면 Experience Cloud 인터페이스 [제품 설명서](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=ko)를 참조하십시오.
...
* 향상된 제품 도움말: [!UICONTROL Experience League]는 제품에 통합되어 있으므로 도움말 검색에 커뮤니티 포럼 및 비디오 콘텐츠의 결과도 포함됩니다. 이러한 변경 사항을 통해 더 많은 콘텐츠를 간편하게 이용하고 Experience Cloud를 최대한 활용할 수 있습니다. 또한 **[!UICONTROL 도움말]** > **[!UICONTROL 피드백]**&#x200B;을 클릭하여 문제를 보고하거나 Adobe와 아이디어를 공유할 수 있습니다.
...
* [Analytics 관리자에 대한 중요 공지](#aa-notices)(2020년 7월 13일 업데이트됨)
...
* 그래프의 막대를 클릭할 때의 날짜와 테이블의 날짜가 다르게 표시되는 [온보딩 상태 보고서](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/onboarding-status-report.html?lang=ko)의 문제를 수정했습니다. (AAM-55235)
...
* **Dynamic Media Classic**
  ...
  [Adobe Dynamic Media Classic 데스크탑 앱 - 지금 사용 가능](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/new-ui-2020.html?lang=ko)을 참조하십시오.

* **Dynamic Media에 추가된 3D 에셋 지원**

  이제 AEM 6.5의 Dynamic Media 및 AEM as a Cloud Service를 사용하여 3D 에셋을 업로드, 관리 및 확인하고 몰입형 환경으로 제공할 수 있습니다.

   * AEM as a Cloud Service에서 [Dynamic Media에서 3D 에셋 작업](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/assets-3d.html?lang=ko)을 참조하십시오.
   * AEM 6.5에서 [Dynamic Media에서 3D 에셋 작업](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/assets-3d.html?lang=ko)을 참조하십시오.
...
* **AEM 6.5.5 양식 설명서 업데이트**
   ...
   * 6.5.5 릴리스의 새로운 기능 및 개선 사항:
      ...
      * [Adobe Experience Manager 받은 편지함 열 사용자 정의](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/essentials/inbox.html?lang=ko#inbox-admin-control).
      * [대화형 커뮤니케이션을 초안으로 저장.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html?lang=ko#save-as-draft)
      * [단일 서버](https://helpx.adobe.com/content/dam/help/ko-KR/experience-manager/6-5/forms/pdf/prepare-install-single-server.pdf) 및 [클러스터](https://helpx.adobe.com/content/dam/help/ko-KR/experience-manager/6-5/forms/pdf/prepare-install-cluster.pdf) 설치에 대한 Oracle WebLogic 애플리케이션 서버 지원
      * [액세스 가능성 향상.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=ko#accessibility-improvements)
      * [양식 데이터 모델에서 SOAP 기반 웹 서비스를 위한 X-509 인증서 기반 인증.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html?lang=ko#configure-soap-web-services)
      * [Oracle RAC 지원.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=ko#other-improvements)
      * [트랜잭션 보고에서 오류 로깅이 개선되었습니다.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=ko#view-transaction-reporting-logs)
   * 6.4.8.1 릴리스의 새로운 기능 및 개선 사항:
      * [양식 데이터 모델에서 SOAP 기반 웹 서비스를 위한 X-509 인증서 기반 인증.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html?lang=ko#configure-soap-web-services)
      * [트랜잭션 보고에서 오류 로깅이 개선되었습니다.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=ko#view-transaction-reporting-logs)
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2020년 6월 25일 | [반응형 양식 시작하기](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-adaptive-form/adaptive-forms-getting-started-tutorial-use.html?lang=ko) | 비디오 | 이 튜토리얼에서는 다중 탭 반응형 양식 만들기에 관련된 단계를 안내합니다. 테이블, 아코디언 레이아웃 및 규칙 편집기를 사용하여 비즈니스 규칙을 작성하는 방법을 알아봅니다. |
| 2020년 6월 25일 | [AEM Forms에서 검토 워크플로 만들기](https://video.tv.adobe.com/v/3410037?captions=kor) | 비디오 | 활성 양식 제출에서 제출된 데이터를 검토하는 워크플로를 생성하는 방법을 알아봅니다. |
| 2020년 6월 23일 | [처리 프로필](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/processing-profiles.html?lang=ko) | 비디오 | 처리 프로필은 AEM as a Cloud Service에서 에셋에 대해 만들 변환을 정의합니다. |
| 2020년 6월 23일 | [Dynamic Media Classic 모범 사례](https://experienceleague.adobe.com/docs/experience-manager-learn/dynamic-media-classic-tutorial/overview.html?lang=ko) | 문서 | 현재 사용자와 신규 사용자는 Dynamic Media Classic과 핵심 기능에 대해 알아보고 워크플로를 _제작_, _작성_ 및 _전달_&#x200B;합니다. |
| 2020년 6월 23일 | [AEM as a Cloud Service 빌드 및 배포 디버깅](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/build-and-deployment.html?lang=ko) | 문서 | AEM as a Cloud Service에 대한 빌드 및 배포를 디버깅하는 방법을 알아봅니다. |
| 2020년 6월 16일 | [로그를 사용하여 AEM as a Cloud Service 디버깅](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/logs.html?lang=ko) | 문서 | 로그를 사용하여 AEM as a Cloud Service를 디버깅하는 방법을 알아봅니다. 로그는 AEM 애플리케이션을 디버깅하기 위해 최전방 역할을 하지만 배포된 AEM 애플리케이션에서 적절한 로깅에 의존합니다. |
| 2020년 6월 5일 | [SPA 편집기 프로젝트](https://experienceleague.adobe.com/docs/experience-manager-learn/spa-react-tutorial/create-project.html) | 문서 | AEM(Adobe Experience Manager) 프로젝트 원형을 사용하여 AEM SPA 편집기와 통합된 반응형 애플리케이션의 시작점으로 다중 모듈 Maven 프로젝트를 생성하는 방법을 알아봅니다. |
...
* 새로운 골드 표준 안정 빌드. [자세히 보기](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html?lang=ko#release-19-1-4-build-9032)

#### Campaign 컨트롤 패널

* 하위 도메인 전달 기능 감사 - [자세한 내용](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html?lang=ko)
...
| 게시일 | 이름 | 솔루션 | 설명 |
| ----------- | ----------- | ---------- | ---------- |
| 2020년 6월 26일 | [Adobe Campaign Classic UI 살펴보기](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/exploring-the-adobe-campaign-classic-user-interface.html?lang=ko) | Campaign Classic | 이 비디오에서는 Adobe Campaign Classic의 기본 사용자 인터페이스에 대해 설명하고 기본 기능을 탐색하는 방법을 보여 줍니다. |
| 2020년 7월 8일 | [Adobe Campaign 클라이언트 설치 및 설정](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/install-and-setup-the-adobe-campaign-client.html?lang=ko) | Campaign Classic | Adobe Campaign 클라이언트 콘솔을 다운로드 및 설치하고, 여러 환경에 대한 연결을 만들고 관리하며, Adobe Campaign 클라이언트 콘솔에 대한 액세스를 확인하는 방법을 알아봅니다. |
| 2020년 6월 19일 | [Adobe Campaign Classic 소개](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/introduction-to-adobe-campaign-classic.html?lang=ko) | Campaign Classic | Adobe Digital Experience Classic이 Adobe Digital Experience 포트폴리오에 어떻게 적합한지 그리고 주요 기능 및 기능을 알아봅니다. |
| 2020년 6월 12일 | [임시 이메일 전달 템플릿 배포](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/deploying-ad-hoc-email-delivery-template.html?lang=ko) | Campaign Classic | 임시 이메일 템플릿을 배포하는 방법 알아보기 |
| 2020년 6월 12일 | [전달 템플릿 구성](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/configuring-a-delivery-template.html?lang=ko) | Campaign Classic | 이메일 템플릿 구성 방법 알아보기 |
| 2020년 6월 12일 | [전달 템플릿 속성 설정](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/setting-delivery-template-properties.html?lang=ko) | Campaign Classic | 이메일 템플릿 속성을 설정하는 방법 알아보기 |
| 2020년 6월 26일 | [Adobe Campaign Standard의 UI 시작하기](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/getting-started/getting-started-with-the-ui.html?lang=ko) | Campaign Standard | 이 비디오에서는 Adobe Campaign Standard 사용자 인터페이스에 대한 개요를 보고 주요 기능과 핵심 기능을 탐색하는 방법을 설명합니다. |
| 2020년 6월 26일 | [GPG 키 관리](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/administrating/control-panel/gpg-key-management/gpg-key-management-overview.html?lang=ko) | Campaign Standard/컨트롤 패널 | 데이터 암호화에 대한 공개/비공개 GPG 키 쌍을 생성 및 설치하는 방법 및 데이터 암호 해독용 공개 키를 가져오고 설치하는 방법을 알아봅니다. |
...
**2020년 7월 24일**&#x200B;에 업데이트되었습니다.

| 기능 | 설명 |
| -----------| ---------- |
| GDPR 투명성 및 동의 프레임워크 | Advertising Cloud는 2020년 8월 15일까지 IAB의 투명성 및 동의 프레임워크에 대한 지원을 버전 2.0으로 업그레이드합니다. 현재 고객 측 변경은 필요하지 않습니다.  각 고객의 데이터 처리자인 Adobe Advertising Cloud는 고객이 당사 제품 및 서비스 사용에 적용되는 GDPR에 따른 의무를 이행하는 데 사용할 수 있는 기능을 갖추고 있습니다. |
| Audience Manager 통합 | (Adobe Experience Platform을 사용하는 Adobe Audience Manager 고객용 Beta만 해당) DSP는 Adobe Experience Platform을 통해 광고주의 광고 참여 데이터가 포함된 실행 가능한 로그 파일을 Audience Manager로 전송할 수 있습니다. Audience Manager에서 광고주는 Audience Optimization 보고서와 같은 통찰력 도구에서의 고급 세분화 및 사용을 위해 데이터를 사용할 수 있습니다. |
| 사용자 기반 크로스 디바이스 그래프 타겟팅 | 셀프 서비스 DSP 고객은 모든 새로운 캠페인에서 사용자 기반 타겟팅 및 빈도 관리를 위해 디바이스 그래프(Adobe Experience Cloud Device Co-op 또는 LiveRamp)를 사용할 수 있습니다. 이렇게 하면 광고주는 자신이 소유한 디바이스 전체에 대상자를 연결하고 광고 노출을 제한할 수 있습니다. 또한 배치 전체에서 크로스 디바이스 타겟팅 설정을 일괄적으로 편집할 수 있는 기능을 이제 Beta 모드에서 사용할 수 있습니다. 계정에 Beta를 활성화하려면 Adobe 계정 관리자에게 문의하십시오. |
| 사이트 타겟팅 | “블랙리스트” 및 “화이트리스트”는 보다 공정한 용어인 “차단된 (사이트)” 및 “타겟팅된 (사이트)”로 이름이 변경되었습니다. |
| Flashtalking 광고 | 이제 DSP는 단일 광고 생성 및 일괄 서드파티 광고 생성 워크플로를 통해 모든 Flashtalking 광고 태그에 대한 클릭 매크로를 자동으로 삽입합니다. |
| 보고서 | (Adobe Experience Platform 고객용 Beta만 해당) Advertising Cloud Search의 새로운 크로스 채널 보고서는 DSP 배치 및 검색 캠페인에 대한 일일 주요 지표와 함께 DSP 및 검색 전반에 걸친 미디어 지출에 대한 통합 보기를 제공합니다. |
...
| 기능 | 설명 |
| -----------| ---------- |
| [!UICONTROL 경고 Beta] | 이제 경고에 대한 데이터가 포함된 필터링된 읽기 전용 보기를 연 다음 관련 캠페인 관리 보기에서 엔티티의 필터링된 보기를 열어 엔티티 레코드를 편집할 수 있습니다. |
