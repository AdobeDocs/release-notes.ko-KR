...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 3월 | [Adobe Experience Platform: meta:enum을(를) 비울 수 없습니다](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21767.html) | 신규 문서 | `meta:enum`을 비워 둘 수 없는 문제를 해결하는 방법에 대해 알아봅니다. |
