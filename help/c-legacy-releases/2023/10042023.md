...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2023년 9월 | 대상 | [[!UICONTROL 대상] 개요](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/understanding-destinations.html?lang=ko) | 비디오 | 다양한 사용 사례 지원을 위해 Real-Time CDP, Experience Platform 및 태그에서 데이터를 가져오는 데 사용 가능한 대상 유형에 대해 알아봅니다. |
| 2023년 9월 | 대상 | [Experience Platform에서 데이터 세트 내보내기 대상 구성](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-dataset-export-destination.html?lang=ko) | 비디오 | 대상 연결을 사용하여 Adobe Experience Platform의 데이터 세트를 클라우드 스토리지 위치로 내보내는 구성, 워크플로 및 사용 사례에 대해 알아봅니다. |
| 2023년 9월 | 데이터 수집 | [데이터 수집에서 빠른 시작 워크플로 사용](https://experienceleague.adobe.com/docs/platform-learn/data-collection/event-forwarding/quick-start-workflows.html?lang=ko) | 비디오 | [!UICONTROL 데이터 수집]에서 [!DNL Facebook] ([!DNL Meta]) 빠른 시작 워크플로를 최대한 활용하는 고급 사용 사례에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2023년 9월 | [AEP - Compose Audience는 읽기 전용입니다. 필요한 권한이 무엇입니까?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22841.html?lang=ko) | 신규 문서 | [!UICONTROL 대상자] 섹션에 액세스하여 새 대상자를 구성할 때 선택해야 하는 권한에 대해 알아봅니다. |
| 2023년 9월 | [[!UICONTROL 타깃 추적]은 Adobe Experience Platform Debugger에 표시되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22635.html?lang=ko) | 신규 문서 | [!UICONTROL 타깃 추적] 탭이 Adobe Experience Platform Debugger에 표시되지 않는 경우 문제에 대한 솔루션을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2023년 9월 | [Flutter AEP Core Libraries를 통해 Adobe Analytics 데이터를 전송할 수 없음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22809.html?lang=ko) | 신규 문서 | trackAction/trackState API를 사용하는 Flutter AEP Core Libraries(Mobile SDK)를 통해 Adobe Analytics에서 데이터 전송 시 발생하는 문제에 대한 솔루션을 알아봅니다. |
| 2023년 9월 | [서버 호출 사용량을 볼 수 없음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22784.html?lang=ko) | 신규 문서 | [!UICONTROL 서버 호출 사용량] 대시보드가 표시되지 않는 경우 문제에 대한 솔루션을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 9월 | [다음에서 오브젝트 배열 사용 [!DNL Customer Journey Analytics]](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/complex-data/object-arrays-in-cja.html?lang=ko) | 비디오 | CJA의 프로필 및 조회 데이터 세트에서 오브젝트 배열을 활용하여 연결부터 데이터 보기, 작업 영역까지 B2B 및 B2C 분석을 보완할 수 있는 방법에 대해 알아봅니다. |
...
* [Experience Manager 6.4 누적 수정 팩 릴리스 노트](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/cfp-release-notes.html?lang=ko)
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2023년 10월 | 애플리케이션 | [AEM Assets Sidekick 플러그인 및 Edge Delivery Services](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/edge-delivery-services/sidekick-plugin.html?lang=ko) | 비디오 | AEM Assets Sidekick 플러그인을 활용하여 관리 자산을 Edge Delivery Services를 통해 제공되는 영향력이 큰 경험에 통합할 수 있는 방법에 대해 알아봅니다. |
| 2023년 9월 | [!DNL AEM as a Cloud Service] | [[!DNL AEM as a Cloud Service] 캐싱](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/caching/overview.html?lang=ko) | 비디오 | AEM as a Cloud Service의 캐싱에 대해 알아봅니다. |
| 2023년 9월 | [!DNL AEM as a Cloud Service] | [[!UICONTROL 콘텐츠 조각] 편집기](https://experienceleague.adobe.com/docs/experience-manager-learn/content-fragments-console/basics/content-fragment-editor.html?lang=ko) | 비디오 | [!DNL Experience Manager] [!UICONTROL 콘텐츠 조각] 편집기에 대한 간략한 소개. |
| 2023년 9월 | [!DNL AEM as a Cloud Service] |  [!DNL AEM as a Cloud Service][&#128279;](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/architecture.html?lang=ko)의 아키텍처 | 비디오 | Edge Delivery Services를 사용하여 AEM as a Cloud Service의 기본 아키텍처와 중요한 부분을 살펴봅니다. |
| 2023년 9월 | [!DNL Forms] | [문서 목록에서 문서 추출](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/custom-workflow-steps/extract-document-from-list.html?lang=ko) | 문서 | 문서 목록에서 특정 문서를 추출하려면 사용자 정의 워크플로 구성 요소에 대해 알아봅니다. |
| 2023년 9월 | [!DNL Forms] | [감사 페이지 사용자 정의](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/handling-af-form-submissions/thank-you-page-on-fdm-submission.html?lang=ko) | 문서 | 감사 페이지에 양식 데이터 모델 제출에 대한 답변을 표시합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2023년 9월 | [수동 번역 작업이 “진행 중” 상태로 정지됨](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22846.html?lang=ko) | 신규 문서 | 번역된 콘텐츠를 가져온 후 번역 작업이 *진행 중* 상태로 정지되는 경우 문제에 대한 솔루션을 알아봅니다. |
| 2023년 9월 | [권한이 AEM as a Cloud Service에서 예기치 않게 사라짐](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22839.html?lang=ko) | 신규 문서 | 권한이 AEM as a Cloud Service에서 예기치 않게 사라지는 문제에 대한 솔루션을 알아봅니다. |
| 2023년 9월 | [게시/미리보기에서 나머지 노드를 삭제하는 방법](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22828.html?lang=ko) | 신규 문서 | [!DNL AEM as a Cloud Service]의 [게시/미리보기]에서 나머지 노드를 삭제하는 방법에 대해 알아봅니다. |
| 2023년 9월 | [작성자를 수동으로 전환한 후 SSL 인증서가 원래대로 복구됨](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22814.html?lang=ko) | 신규 문서 | 작성자를 수동으로 전환한 후 SSL 인증서가 원래대로 복구되는 문제를 해결하는 방법에 대해 알아봅니다. |
| 2023년 9월 | [작성자에서 DAM 자산 콘솔을 로드할 수 없음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22786.html?lang=ko) | 신규 문서 | `/assets.html/content/dam`을 사용하여 자산 AEM 콘솔에 액세스하는 동안 화면이 비어 있는 경우 문제에 대한 솔루션을 알아봅니다. |
| 2023년 9월 | 사용자 정의 태그에 대한 [*스마트 트레이닝* 실패](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22781.html?lang=ko) | 신규 문서 | 사용자 정의 태그에 대한 *스마트 트레이닝*&#x200B;이 실패하는 경우 문제에 대한 솔루션을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 9월 | [기업 크레딧 관리](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/company-credit.html?lang=ko) | 비디오 | B2B 기업 계정 사용자가 허용된 크레딧 제한까지 자신의 계정에서 구매할 수 있는 방법에 대해 알아봅니다. |
...
| 2023년 9월 | [기업 계정 관리](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/company-accounts.html?lang=ko) | 비디오 | 보류 상태인 승인 요청을 포함하여 B2B 기업 계정을 관리하는 방법에 대해 알아봅니다. |
...
| 2023년 9월 | [SOAP에서 RESTful로의 UPS 배송 방법 통합 마이그레이션 API](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/ups-shipping-method-integration-migration-from-soap-to-restful-api.html?lang=ko) | 신규 문서 | 이 문서에서는 Adobe Commerce 2.4.4 - 2.4.6-pX용 SOAP에서 RESTful API로의 United Parcel Service(UPS) 배송 방법 통합 마이그레이션으로 문제를 해결하는 패치를 제공합니다. |
...
| 2023년 9월 | [서드파티 보안 검사를 통해 파악된 취약점은 HackerOne에 전달되어야 함](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/third-party-test-reports-are-handled-by-hackerone.html?lang=ko) | 신규 문서 | 서드파티 보안 검사를 통해 파악된 취약점을 해결하는 솔루션에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2023년 9월 | [하루에 전송되는 최대 SMS 개수](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22848.html?lang=ko) | 신규 문서 | 하루에 전송될 수 있는 최대 SMS 한도를 확인하는 방법에 대해 알아봅니다. |
| 2023년 9월 | [OOTB 스키마 서비스 “이름” 필드 변경](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22857.html?lang=ko) | 신규 문서 | *[!UICONTROL 이름]* 필드가 즉시 사용할 수 있는(OOTB) 스키마에서 변경되는 이유에 대해 알아봅니다. |
| 2023년 9월 | [등록 토큰이 _nms :appSubscriptionRcp_테이블에 저장되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22844.html?lang=ko) | 신규 문서 | 등록 토큰이 `nms:appSubscriptionRcp` 테이블에 저장되지 않는 경우 문제에 대한 솔루션을 알아봅니다. |
| 2023년 9월 | [Campaign Classic에서 WebApps URL 브랜딩](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22750.html?lang=ko) | 신규 문서 | Adobe 서버에서 계속 호스팅하는 동시에 Adobe 서버 대신 특정 회사 이름을 보유하도록 URL을 수정/맞춤화할 수 있는지 여부에 대한 솔루션을 알아봅니다 |
| 2023년 9월 | [_데이터 업데이트_ 활동](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22755.html?lang=ko)으로 인한 알 수 없는 필드 오류 | 신규 문서 | 워크플로 실행 시 _데이터 업데이트_ 활동으로 인해 오류가 발생하는 경우 문제에 대한 솔루션을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 9월 | [Marketo Engage 내 주요 보고서](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/reporting/key-reports.html?lang=ko) | 비디오 | [!DNL Marketo Engage] 내 주요 보고서와 해당 보고서를 가져오는 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 9월 | [작업 또는 프로젝트 목록 로드 시 “Whoops” 오류 발생](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22882.html?lang=ko) | 신규 문서 | 오류 메시지 *Whoops를 해결하는 방법에 대해 알아봅니다. 작업 또는 프로젝트 목록 로드 시 문제가* 발생했습니다. |
| 2023년 9월 | [요청 대기열이 게시 취소됨](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22753.html?lang=ko) | 신규 문서 | Adobe Workfront의 요청 대기열이 게시 취소되는 경우 문제에 대한 솔루션을 알아봅니다. |
...
| 2023년 9월 | [매력적인 머천다이징 콘텐츠 만들기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/compelling-merchandise.html?lang=ko) | 비디오 | 커머스 팀에서 온라인 스토어의 새 재고 세트에 대한 매력적인 이미지를 쉽게 제작할 수 있는 방법에 대해 알아봅니다. |
| 2023년 9월 | [마케팅 팀이 다중 채널 콘텐츠를 제작할 수 있도록 지원](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/multi-channel-marketing-content.html?lang=ko) | 비디오 | 이벤트 마케팅 팀에서 온라인 이벤트에 대한 시청자의 관심을 끌기 위해 고유 콘텐츠를 제작할 수 있는 방법에 대해 알아봅니다. |
