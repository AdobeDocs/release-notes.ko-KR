...
| 2023년 3월 | [Asset Share Commons 자산 키트](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/assets-share/asset-share-commons-asset-kits.html) | 비디오 | Asset Share Commons 자산 키트를 사용하여 AEM Assets 폴더 또는 컬렉션에서 자산을 나열하는 공유 가능한 맞춤형 웹 페이지를 만드는 방법에 대해 알아봅니다. | AEM Assets |
