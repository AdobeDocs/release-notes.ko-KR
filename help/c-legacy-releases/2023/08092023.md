...
| 2023년 7월 | [공개 리소스에 이미지가 업로드되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22395.html) | 신규 문서 | 공개 리소스 폴더의 프로덕션에서 이미지를 업로드하려고 시도하는 동안 발생하는 오류를 해결하는 방법을 알아보십시오. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 7월 | [교정쇄를 업로드하는 동안 교정 문제, 파란색 막대가 무기한 스크롤됨](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22364.html) | 신규 문서 | 새 교정쇄를 업로드할 때 발생하는 오류를 해결하는 방법을 알아보십시오. |
