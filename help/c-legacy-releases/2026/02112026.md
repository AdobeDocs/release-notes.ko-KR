...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2026년 2월 | [데이터 스토리텔링: 슬라이드 프레젠테이션 생성](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/curate-and-share/data-storytelling-generate-slides.html) | 비디오 | Adobe Customer Journey Analytics의 강력한 데이터 Storytelling 기능을 살펴보십시오. 이 기능은 생성형 AI를 사용하여 Analysis Workspace 프로젝트를 전문 PowerPoint 프레젠테이션으로 변환하고 조정된 시각화, 주요 통찰력 및 매력적인 내러티브를 제공합니다. |
...
| 2026년 2월 | [Customer Journey Analytics의 Analysis Workspace 프로젝트에 막대 시각화 추가](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/add-bar-visualizations.html) | 비디오 | Customer Journey Analytics에서 Analysis Workspace 프로젝트에서 표준 바 및 스택 바 시각화를 추가하고 구성하는 방법에 대해 알아봅니다. |
...
| 2026년 2월 | [!DNL AEM Assets] | [Adobe Snapshot](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-snapshot.html) | 비디오 | Adobe Snapshot은 최적화된 동적 이미지 제공을 위한 Dynamic Media의 기능을 보여 주도록 설계된 시각적 데모 도구입니다. |
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026년 2월 | [!DNL Journey Optimizer] | [여정을 통해 다이렉트 메일 메시지 보내기](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/direct-mail-channel/direct-mail-in-journeys.html) | 비디오 | Adobe Journey Optimizer의 다이렉트 메일 채널을 활용하여 여정 내에서 다이렉트 메일 게재를 자동화하고 예약하는 방법을 살펴봅니다. |
