...
* [2025년 12월](https://experienceleague.adobe.com/en/docs/release-notes/experience-cloud/previous/2025/01222025#status)
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026년 2월 | [!DNL Journey Optimizer] | [여정과 DM 메시지 보내기](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/direct-mail-channel/direct-mail-in-journeys.html) | 비디오 | Adobe Journey Optimizer의 DM 채널을 활용하여 여정 내에서 DM 게재를 자동화하고 예약하는 방법을 살펴봅니다. |
