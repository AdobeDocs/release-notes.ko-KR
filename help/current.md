...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2026년 1월 | [만료되지 않는 자격 증명 관련 Customer Journey Analytics BI 확장 연결 문제](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29891) | 신규 문서 | BI 도구를 사용하여 작업하려면 Adobe Experience Platform에서 만료되지 않는 자격 증명에 올바른 Customer Journey Analytics 액세스 및 데이터 보기 권한이 있어야 하는 경우의 문제 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [잘못된 스키마 참조로 인해 스트리밍 수집이 실패합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29710) | 신규 문서 | 페이로드의 스키마 참조가 Adobe Experience Platform에서 잘못되었거나 잘못되어 스트리밍 수집이 실패할 경우 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | AEP에서 만료된 SAS 토큰으로 인해 [[!DNL Databricks] 커넥터가 실패합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29715) | 신규 문서 | 인프라 변경 후 [!DNL Databricks] 커넥터의 작동이 중지되거나 Spark 구성의 SAS([!DNL Shared Access Signature]) 토큰이 만료되거나 AEP에서 새로 고쳐질 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [S3 대상으로 증분 내보내기가 AEP에서 매핑된 대상을 내보내지 않습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29725) | 신규 문서 | Amazon S3 대상으로 증분 내보내기를 수행하면 매핑된 대상자에 AEP에서 유효한 증분 카운트가 표시되더라도 레코드가 0으로 내보내지는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [마케팅 작업 목록이 Adobe Experience Platform에 표시되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29744) | 신규 문서 | 영향을 받는 사용자에게 Adobe Experience Platform에서 올바른 데이터 거버넌스 권한이 없어 광고 대상을 구성할 때 마케팅 작업 목록이 표시되지 않고 페이지가 비어 있는 경우의 문제 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [AEP에서 소스 흐름 실행에 대한 잘못된 지연 알림](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29745) | 신규 문서 | 경고 시스템의 모니터링 신호가 Adobe Experience Platform의 실제 실행 지표와 항상 일치하지 않으므로 데이터 흐름이 성공적으로 완료되어도 소스 흐름 실행 지연에 대한 경고가 표시되는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [Adobe Experience Platform에서 스트리밍 데이터 흐름 수집 실패에 대한 경고가 트리거되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29762) | 신규 문서 | Adobe Experience Platform의 스트리밍 데이터 흐름에 대해 소스 흐름 실패에 대한 경고가 작동하지 않을 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [AEP에서 [!DNL LiveRamp] 로 세그먼트를 내보낼 때 인증 오류 발생](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29774) | 신규 문서 | 프로덕션 샌드박스에서 Adobe Experience Platform의 [!DNL LiveRamp] 온보딩 대상으로 세그먼트를 내보내는 동안 인증 오류가 발생할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [프로필이 AEP의 Google Customer Match와 동기화되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29806) | 신규 문서 | 프로필에 Google에서 지원하는 ID 속성이 없거나 잘못된 매핑이 있어 Google Customer Match에 대상을 활성화할 때 프로필의 작은 하위 집합만 성공적으로 동기화할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [[!DNL Meta Pixel] 확장은 AEP에서 동의 전에 JavaScript을 로드합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29840) | 신규 문서 | 동의를 제공하기 전에 Adobe Experience Platform의 [!DNL Meta Pixel] 확장이 `fbevents.js` 스크립트를 로드할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [Adobe Experience Platform과 통합 [!DNL The Trade Desk] 및 수집 [!DNL The Trade Desk ID]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29847) | 신규 문서 | [!DNL The Trade Desk]을(를) Adobe Experience Platform과 통합할 때 웹 SDK을 통해 [!DNL The Trade Desk ID]을(를) 수집하고 매핑하는 데 불확실성이 있을 때 문제에 대한 해결 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2026년 2월 | [Adobe Analytics 온보딩](https://experienceleague.adobe.com/en/docs/analytics/analyze/admin-overview/onboard) | 비디오 | 귀사와 조직이 성공할 수 있도록 Adobe Analytics을 지원하는 주요 Adobe 플랫폼으로 온보딩합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2026년 2월 | [데이터 Storytelling: 슬라이드 프레젠테이션 생성](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/curate-and-share/data-storytelling-generate-slides.html) | 비디오 | Adobe Customer Journey Analytics의 강력한 데이터 Storytelling 기능을 살펴보십시오. 이 기능은 생성형 AI를 사용하여 Analysis Workspace 프로젝트를 전문 PowerPoint 프레젠테이션으로 변환하고 조정된 시각화, 주요 통찰력 및 매력적인 이야기를 제공합니다. |
...
| 2026년 2월 | [왜 CJA입니까? CJA과 Adobe Analytics에 대한 전략적 검토](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/cja-basics/why-cja-modernize-customer-analytics) | 비디오 | Adobe Experience Platform을 기반으로 구축된 Adobe Customer Journey Analytics(CJA)이 기존 Adobe Analytics의 한계를 극복하는 방법을 알아봅니다. |
| 2026년 2월 | [자유 형식 테이블의 여러 차원 열](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/multiple-dimension-columns-in-freeform-tables) | 비디오 | CJA의 여러 Dimension 열 기능을 사용하면 자유 형식 테이블을 더욱 강력하게 만들 수 있습니다. |
| 2026년 2월 | [Customer Journey Analytics에서 Analysis Workspace 프로젝트에 막대 시각화 추가](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/add-bar-visualizations.html) | 비디오 | Customer Journey Analytics의 Analysis Workspace 프로젝트에서 표준 막대 및 스택 막대 시각화를 추가하고 구성하는 방법에 대해 알아봅니다. |
...
| 게시일 | 애플리케이션 | 이름 | 형식 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026년 2월 | [!DNL AEM CS] | [개발 에이전트 개요](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/development/overview) | 비디오 | AEM의 Development Agent가 Cloud Manager에서 실패한 파이프라인을 분석하고 로그를 빌드하여 코드 수정을 제안하고 디버깅 속도를 높이는 방법에 대해 알아봅니다. |
| 2026년 2월 | [!DNL AEM Assets] | [Adobe 스냅숏](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-snapshot.html) | 비디오 | Adobe 스냅샷은 최적화된 동적 이미지 제공을 위한 Dynamic Media의 기능을 보여 주도록 설계된 시각적 데모 도구입니다. |
| 2026년 2월 | [!DNL AEM CS] | [AEM as a Cloud Service에서 콘텐츠 복원](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/cloud-manager/content-restore) | 비디오 | 이 단계별 자습서를 사용하여 AEM as a Cloud Service에서 콘텐츠를 복원하는 방법에 대해 알아봅니다. 이전 컨텐츠를 효율적으로 복구하는 시기와 방법을 파악하여 컨텐츠 무결성을 보장합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|--------|---------|---------|
| 2026년 1월 | [DASH/HLS 적응형 스트리밍이 *고급 스트리밍을 사용할 수 없습니다* AEM Dynamic Media에 오류가 있습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29657) | 신규 문서 | AEM Dynamic Media의 MPD 파일에 대한 잘못된 URL 형식으로 인해 DASH 적응형 스트리밍에 액세스하여 *고급 스트리밍이 활성화되지 않음* 오류가 반환될 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [Adobe Experience Manager: XF(경험 조각) 복사 및 붙여넣기 작업이 실패하고 오류 팝업이 나타납니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29837) | 신규 문서 | XF(경험 조각)를 복사하여 붙여넣으면 오류 팝업이 표시되고 XF가 붙여넣어지지 않을 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [Adobe Experience Manager: 더 이상 AEM을 사용하지 않는 사용자에게 AEM 이메일을 중지하는 방법](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29839) | 신규 문서 | 사용자가 AEM 사용을 중단한 후에도 시스템 또는 워크플로우 이메일을 계속 수신할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | AEM에서 Java 버전이 일치하지 않아 [TCP 로케이터를 시작하지 못했습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28132) | 신규 문서 | 클러스터된 환경에서 SP22 핫픽스 후에 JDK 17 이상이 필요하기 때문에 TCP 로케이터를 시작하지 못하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [AEM as a Cloud Service 또는 AEM 6.5의 [!UICONTROL Publish]&#x200B;(Dispatcher 포함)에서 ZIP 자산이 404를 반환합니다.](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28174) | 신규 문서 | AEM DAM에 업로드된 ZIP 파일이 [!UICONTROL 작성자]에 게시된 것으로 표시되지만 [!UICONTROL 게시]에 액세스하면 Dispatcher에서 기본적으로 ZIP 요청을 차단하므로 404 오류가 반환되는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [AEM 로그를  [!DNL Nginx]을(를) 통해 HTTP 끝점으로 전달할 때 오류 로그가 누락됨](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28164) | 신규 문서 | [!DNL Nginx]을(를) 사용하여 AEM 로그를 사용자 지정 HTTP 끝점으로 전달하면 HTTP 끝점을 일시적으로 사용할 수 없거나 느리게 응답하기 때문에 오류 예외 로그가 누락되는 문제에 대한 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [AEM as a Cloud Service의 Adobe Launch(태그) 환경 매핑 이해](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28165) | 신규 문서 | AEM as a Cloud Service에서 Adobe Launch를 구성하면 각 환경에서 사용하는 Launch 라이브러리에 대해 혼동을 일으키며 스테이징 및 프로덕션 탭만 표시되는 경우에 발생하는 문제의 솔루션에 대해 알아봅니다. |
| 2026년 1월 | [AEM as a Cloud Service 게시 pod에서 Dispatcher `vhost` 구성 불일치](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29602) | 신규 문서 | 필요한 호스트가 명시적으로 정의되지 않아 일부 AEM as a Cloud Service 게시 Pod에서 업데이트된 Dispatcher `vhost` 구성을 일관되게 적용하지 않아 *HTTP 301* 리디렉션 및 무한 리디렉션 루프가 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [리디렉션 속성이 AEM Live Copy로 롤아웃되지 않습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29707) | 신규 문서 | 기본 MSM 작업이 리디렉션 관련 속성을 제외하므로 블루프린트 페이지에 구성된 리디렉션 설정이 롤아웃 중에 라이브 카피로 전파되지 않는 경우의 문제 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [AEMaaCS에서 올바른 Adobe 저장소를 사용하여 EDS 프로젝트 설정](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28055) | 신규 문서 | AEMaaCS에서 Edge Delivery Services 프로젝트를 설정할 때 올바른 Adobe 보일러플레이트 저장소를 사용해야 하는 문제에 대한 해결 방법에 대해 알아봅니다. |
...
| 2026년 1월 | [[!DNL Site-Wide Analysis Tool] 보고서를 열 수 없습니다. *400 잘못된 요청 - 요청 헤더 또는 쿠키가 너무 큼* 오류](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27906) | 신규 문서 | 요청 헤더 또는 쿠키가 Adobe Commerce Cloud의 서버 구성 제한을 초과하므로 [!DNL Site-Wide Analysis Tool] 보고서가 열리지 않고 *400 잘못된 요청 오류*&#x200B;를 표시하는 경우의 문제 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [Adobe Commerce용 고급 보고 문제 해결사](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29603) | 신규 문서 | Adobe Commerce의 고급 보고 문제를 진단하고 해결하는 방법에 대해 알아봅니다. |
| 2026년 1월 | [[!DNL Cloudflare] Adobe Commerce의 시간 제한 및 리디렉션 문제](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29759) | 신규 문서 | [!DNL Cloudflare] 구성으로 인해 Adobe Commerce 환경에서 시간 초과 및 리디렉션 문제가 발생할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [데이터베이스 업로드가  [!DNL MySQL]에 연결되지 않음](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29843) | 신규 문서 | 데이터베이스 업로드가 [!DNL MySQL]에 대한 연결을 끊을 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [Adobe Commerce에서 이미지 최적화를 활성화하는 동안 오류가 발생했습니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29890) | 신규 문서 | [!DNL Fastly] 이미지 최적화([!DNL Fastly] IO)가 기본적으로 비활성화되어 있고 [!DNL Fastly]에 연락하여 이미지 최적화를 활성화하라는 알림이 있는 경우의 문제 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [클라우드 인프라에서 Adobe Commerce의 `var/export` 폴더 권한 문제](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29895) | 신규 문서 | `var/export/email` 폴더의 서버에서 파일 권한 문제로 인해 제품 데이터를 내보낼 수 없는 문제의 해결 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2026년 1월 | [Adobe Campaign Managed Cloud에서 부풀려진 활성 프로필 개수 수정](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29761) | 신규 문서 | 여러 대상 매핑이 동일한 로그 스키마를 공유하여 Adobe Campaign Managed Cloud의 활성 프로필 수가 예기치 않게 증가하는 문제의 해결 방법에 대해 알아봅니다. |
| 2026년 1월 | [Campaign Standard: 우승자를 선택하는 동안 A/B 테스트 게재가 아직 보류 중입니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29793) | 신규 문서 | 모든 변형이 수신자에게 제공되기 전에 A/B 테스팅이 종료될 때 발생하는 문제의 솔루션에 대해 알아봅니다. |
| 2026년 1월 | [Campaign Classic: 워크플로우를 내보내면 인스턴스가 충돌합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29792) | 신규 문서 | 패키지에서 사용자 지정 캠페인 워크플로우를 내보내면 인스턴스가 충돌할 때 발생하는 문제의 해결 방법에 대해 알아봅니다. |
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026년 2월 | [!DNL Journey Optimizer] | [여정과 DM 메시지 보내기](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/direct-mail-channel/direct-mail-in-journeys.html) | 비디오 | Adobe Journey Optimizer의 다이렉트 메일 채널을 활용하여 여정 내에서 다이렉트 메일 게재를 자동화하고 예약하는 방법을 살펴봅니다. |
| 2026년 2월 | [!DNL Journey Optimizer] | [AJO Decisioning으로 푸시 알림 최적화](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/decision-capabilities/decisioning/decisioning-in-push-notifications) | 비디오 | AJO Decisioning을 사용하여 푸시 알림을 대상자에게 맞게 개인화하는 방법을 알아봅니다. 수신자 프로필을 기반으로 매력적인 오퍼를 만들어 판매를 유도합니다. |
| 2026년 2월 | [!DNL Journey Optimizer] | [조회 데이터 세트 만들기](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/trigger-journey-on-form-submission/lookup-dataset) | 비디오 | 여정에서 사용할 조회 데이터 세트를 만듭니다. |
| 2026년 2월 | [!DNL Journey Optimizer] | [웹 푸시 알림 만들기](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/push-channel/create-web-push-notifications.html) | 비디오 | Adobe Journey Optimizer에서 웹 푸시 알림을 만드는 방법을 알아봅니다. 도달 범위를 모바일 디바이스 너머로 확장하여 웹 브라우저에서 직접 사용자의 참여를 유도할 수 있습니다. |
...
| 2026년 2월 | [!DNL Journey Optimizer] | [SMS 메시지에서 의사 결정 사용](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/decision-capabilities/decisioning/use-decisioning-in-an-sms-message) | 비디오 | AJO Decisioning을 사용하여 SMS 콘텐츠를 개인화하고 최적화하는 방법을 알아봅니다. SMS 메시지를 개선하여 참여를 향상시키고 비즈니스 목표를 달성할 수 있습니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2026년 1월 | [AJO의 이벤트 타이밍 및 일괄 처리 수집으로 인해 대상 자격이 실패합니다](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29796) | 신규 문서 | 이벤트가 Adobe Journey Optimizer의 대상 기준에 정의된 평가 기간을 벗어나서 대상 자격이 실패하는 경우의 문제 해결 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2026년 2월 | [GenStudio for Performance Marketing용 Photoshop 플러그인](https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/integrations/photoshop-plugin) | 비디오 | GenStudio for Performance Marketing용 Photoshop 플러그인을 설치, 구성 및 사용하는 방법에 대해 알아봅니다. |
