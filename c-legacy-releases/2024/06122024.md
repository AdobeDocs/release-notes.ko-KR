...
* **WORKFRONT** | 고객 워크숍 | _관리자 101 - Workfront 시작_ | Workfront을 처음 사용하십니까? &quot;새로운 관리자&quot; 월별 모임에 참여하여 질문을 하고, 리소스 및 권장 사항을 얻고, 다른 새로운 관리자를 만나고, 이 세션을 위해 Workfront 환경 설정을 위한 모범 사례를 알아보십시오. | **7월 9일 @ 오전 9시(MT)** | [등록](https://events.teams.microsoft.com/event/49c249c9-81d9-4a54-a0cb-6d6313ed429c@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
