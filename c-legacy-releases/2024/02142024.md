...
| 2024년 2월 | [특수 페이지에 대한 Experience Platform 태그 규칙 만들기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-special-pages.html?lang=ko-KR) | 비디오 | 모든 페이지에서 수집된 데이터 외에도 특정 페이지에서 수집해야 하는 다른 데이터가 있습니다. 이 비디오는 이러한 데이터를 일반 데이터와 병합하여 Adobe Analytics으로 전송하는 방법을 보여 줍니다. |
...
* 기본 제공 색인 정의에 사용자 정의 속성을 추가하는 방법에 대한 공개 설명서가 없습니다. [사용자 지정 속성을 추가](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/integrations/workfront-connector-configure.html?lang=ko-KR#metadata-schema-mapping)하는 방법에 대해 자세히 알아보세요.
