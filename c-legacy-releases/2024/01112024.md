...
* [2023년 10월](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2023/10042023.html?lang=ko#status)
...
[!DNL Experience Platform] 및 [!UICONTROL Mobile SDK]에 대한 최신 릴리스 정보와 새로운 설명서를 확인합니다. Experience League에서 새로운 튜토리얼과 기술 자료 문서를 살펴보십시오.
...
| 게시일 | 애플리케이션 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2023년 12월 | Mobile SDK | [모바일 앱에서 Adobe Experience Cloud 구현 튜토리얼](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/overview.html?lang=ko-KR) | 업데이트된 튜토리얼(여러 문서) | Adobe [!DNL Experience Platform Mobile SDK]를 사용하여 모바일 앱에서 Adobe [!DNL Experience Cloud] 애플리케이션을 구현하는 방법에 대해 알아봅니다. |
| 2023년 12월 | Platform, Journey Optimizer | [푸시 알림 만들기 및 전송](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push.html?lang=ko) | 문서 | [!DNL Experience Platform Mobile SDK] 및 [!DNL Journey Optimizer]를 사용하여 모바일 앱용 푸시 알림을 만드는 방법에 대해 알아봅니다. |
| 2023년 12월 | Mobile SDK, Journey Optimizer | [인앱 메시지 만들기 및 전송](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp.html?lang=ko) | 문서 | [!DNL Experience Platform Mobile SDK] 및 [!DNL Journey Optimizer]를 사용하여 모바일 앱용 인앱 메시지를 작성하는 방법에 대해 알아봅니다. |
| 2023년 12월 | Platform, Journey Optimizer | [의사 결정 관리를 통해 오퍼 만들기 및 표시](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers.html?lang=ko) | 문서 | [!DNL Experience Platform Mobile SDK]가 있는 모바일 앱의[!DNL Journey Optimizer] [!UICONTROL 의사 결정 관리]에서 오퍼를 표시하는 방법에 대해 알아봅니다. |
| 2023년 12월 | 관리 | [제품 관리자 추가](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-product-administrators.html?lang=ko) | 비디오 | [!DNL Admin Console]에서 Adobe [!DNL Experience Platform]의 새 관리자를 추가하는 방법에 대해 알아봅니다. 관리자는 추가 관리자, 사용자, 개발자 및 API 자격 증명을 추가하고 관리할 수 있습니다. |
| 2023년 12월 | 관리 | [개발자를 추가하고 API 자격 증명에 권한 부여](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-developers.html?lang=ko) | 비디오 | [!DNL Real-Time Customer Data Platform] 및 [!DNL Journey Optimizer]와 같은 Adobe Experience Platform 기반의 애플리케이션에 개발자를 추가하는 방법에 대해 알아봅니다. |
| 2023년 12월 | 관리 | [사용자 추가 및 권한 관리](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-users.html?lang=ko) | 업데이트된 비디오 | [!DNL Real-Time Customer Data Platform] 및 [!DNL Journey Optimizer]와 같은 Adobe Experience Platform 기반의 애플리케이션에서 사용자를 추가하고 권한을 관리하는 방법에 대해 알아봅니다. |
| 2023년 12월 | 데이터 수집 | [datastream 만들기](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream.html?lang=ko) | 비디오 | Experience Platform에서 datastream을 만드는 방법에 대해 알아봅니다. |
| 2023년 12월 | 데이터 수집 | [태그 속성 구성](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags.html?lang=ko) | 비디오 | [!UICONTROL 데이터 수집] 인터페이스에서 태그 속성을 구성하는 방법에 대해 알아봅니다. |
| 2023년 12월 | 데이터 수집 | [Adobe Experience Platform Mobile SDK 설치](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/app-implementation/install-sdks.html?lang=ko) | 문서 | 모바일 앱에서 Adobe [!DNL Experience Platform Mobile SDK]를 구현하는 방법에 대해 알아봅니다. |
| 2023년 12월 | 프로필 | [구매 합계에 대한 계산된 속성 만들기](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases.html?lang=ko) | 비디오 | 계산된 속성을 사용하여 여러 판매 채널에서 사용자가 구매한 금액을 합산하는 방법에 대해 알아봅니다. |
| 2023년 12월 | 데이터 수집 | [태그 속성 만들기](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/create-a-property.html?lang=ko) | 업데이트된 비디오 | 웹 사이트의 마케팅 태그를 관리하기 위해 태그 속성을 만드는 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2023년 12월 | [[!DNL AEP] - [!DNL TARGET] 대상자 - [!DNL AEP]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23223.html?lang=ko)에서 단일 활성화 후 모든  [!DNL Target] 대상자를 위한 수정 일자 변경 | 신규 문서 | [!DNL Adobe Experience Platform]에서 사용자의 [!DNL Target] 대상에 대한 단일 세그먼트를 활성화한 후에 해당 대상([!DNL Target UI] 내)의 활성화된 모든 세그먼트에 대해 변경된 수정 일자가 표시되는 이유에 대해 알아봅니다. |
| 2023년 12월 | [[!DNL AEP] - 소스 스키마가 비[!DNL XDM]준수](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23026.html?lang=ko)인 경우 스트리밍 프로필 업데이트가 실패함 | 신규 문서 | 스트리밍 프로필이 “[!DNL upsert]”일 때 소스 스키마가 [!DNL XDM] 규정을 준수하지 않으면 데이터 흐름이 실패하는 경우에 대해 알아봅니다. |
| 2023년 12월 | [[!DNL AEP] - 라이선스 사용 섹션의 주소 지정 가능한 대상자가 홈 페이지의 프로필 수와 일치하지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23025.html?lang=ko) | 신규 문서 | 라이선스 사용 섹션의 주소 지정 가능한 대상자가 홈 페이지의 프로필 수와 일치하지 않는 경우에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| ---------- | ---------- |---------- |
| 2023년 12월 | [샘플 데이터를 Adobe [!DNL Experience Platform]](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html?lang=ko)으로 가져오기 | 업데이트된 문서 | 샘플 데이터를 사용하여 Experience Platform 샌드박스 환경을 설정하는 방법에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2024년 1월 | [[!UICONTROL Analysis Workspace]의 읽기 전용 프로젝트 공유](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/view-only-projects-in-analysis-workspace.html?lang=ko) | 비디오 | 사용자에게 읽기 전용 [!UICONTROL Workspace] 프로젝트를 공유하는 방법을 알아보고 이 권한 수준에서 사용할 수 있는 기능을 이해합니다. |
| 2023년 12월 | [데이터 사전 감사를 위한 유용한 체크리스트](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/admin-tips/audit-your-data-dictionary.html?lang=ko) | 문서 | Adobe [!DNL Analytics] 및 [!DNL Customer Journey Analytics] [!UICONTROL 데이터 사전] 감사 체크리스트를 통해 데이터 효율성과 안정성을 강화합니다. |
...
| 2023년 12월 | [Experience Platform 태그에서 Analytics 확장 기능의 기본 구성](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.html?lang=ko) | 비디오 | 기본 사이트에 대한 [!DNL Experience Platform] 태그의 [!DNL Analytics] 확장 기능을 구성하는 방법을 시청합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
|---------|----|----|-----------|
| 2023년 12월 | [중복 구매 ID로 인해  [!DNL Adobe Analytics]에 보고되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23145.html?lang=ko) | 신규 문서 | 주문 보고를 방지하는 중복 구매 ID가 [!DNL Adobe Analytics]에 미치는 영향을 살펴봅니다. 적절한 구현을 통해 이 추적 문제를 어떻게 해결할 수 있는지 알아봅니다. |
| 2023년 12월 | [ [!DNL Workspace] 보고서에서 [!UICONTROL 날짜 범위 차원] 주문을 수동 정렬하는 방법은 무엇입니까?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21923.html?lang=ko) | 신규 문서 | [!UICONTROL 날짜 범위] 정렬 아이콘을 통해 [!DNL Adobe Analytics]에서 [!UICONTROL 차원] 주문을 정렬할 수 없는 경우 문제를 해결하는 방법을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 12월 | [조회 및 프로필 데이터에 대한 CJA 조회](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections/cja-lookup-data.html?lang=ko-KR) | 비디오 | 조회 데이터를 추가하여 데이터 세트를 조회 및 프로파일링하고 주요 필드를 계획 및 매핑하는 방법에 대해 알아봅니다. |
...
| 2023년 12월 | [ [!DNL OOTB] 워크플로를 사용하여 모바일 앱 인증서 만료 알림 관리](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23280.html?lang=ko) | 신규 문서 | [!DNL OOTB] 워크플로를 통해 Adobe Campaign Standard로 모바일 앱 인증서 알림을 자동화하는 방법에 대해 알아봅니다. |
| 2023년 12월 | [퍼블릭 리소스 아래의 파일 업로드가 중단됨)](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23329.html?lang=ko) | 신규 문서 | Adobe Campaign Classic v7의 마케팅 및 중간 인스턴스 인프라 내에서 퍼블릭 리소스를 통한 파일 업로드가 90%에서 멈추는 경우에 대한 솔루션을 알아봅니다. |
| 2023년 12월 | [ACC: MKT(마케팅) 서버에서 푸시 알림 토큰이 수신되지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23273.html?lang=ko) | 신규 문서 | MKT(마케팅) 서버에서 푸시 알림 토큰이 수신되지 않는 Adobe Campaign Classic 문제가 있는 경우 솔루션에 대해 알아봅니다. |
| 2023년 12월 | [ACS: 파일 전송 활동을 사용하여 Adobe [!DNL SFTP] 에 연결할 수 없음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23272.html?lang=ko) | 신규 문서 | 파일 전송/다운로드 활동을 사용할 때 Adobe [!DNL SFTP]에 연결할 수 없는 문제가 나타나면 Adobe Campaign Standard에서 솔루션을 알아봅니다. |
...
| 2023년 12월 | [시스템별 로그인 오류: [!DNL XTK-170092] 쿼리 조건에 대한 표현식이 너무 복잡합니다.](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23188.html?lang=ko) | 신규 문서 | 시스템별 로그인 오류(XTK-170092)를 해결하기 위해 하드 캐시 지우기를 수행하는 방법에 대해 알아봅니다. 쿼리 조건에 대한 표현식이 너무 복잡합니다. |
...
| 2023년 12월 | [마케팅 캠페인의 여러 워크플로 구성에 대한 제한 사항](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23013.html?lang=ko) | 신규 문서 | 캠페인 내에서 오류가 발생하는 이유 및 “[!UICONTROL 특성 속성]”을 *[!UICONTROL 지정되지 않음]*&#x200B;으로 조정하여 문제를 효과적으로 해결할 수 있는 방법에 대해 알아봅니다. |
| 2023년 12월 | [[!DNL X-Env-sender] 는 도메인과 다름](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23053.html?lang=ko) | 신규 문서 | 올바른 외부 계정에 대한 경로를 검토하여 [!DNL X-Env-sender]가 도메인과 다른 경우 문제를 해결하는 방법에 대한 자세한 안내서를 살펴봅니다. |
| 2023년 12월 | [고객이 사용자 정의 스키마에서 레코드를 삭제할 수 없음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23001.html?lang=ko) | 신규 문서 | 사용자 정의 스키마의 데이터 삭제 문제를 해결하는 방법을 알아봅니다. |
| 2023년 12월 | [파이프라인 트리거가 처리되고 있지 않음](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23014.html?lang=ko) | 신규 문서 | 해당 인스턴스의 각 컨테이너에서 명령을 실행하여 처리되지 않는 파이프라인 트리거를 수정하는 빠른 솔루션에 대해 알아봅니다. |
...
| 2023년 12월 | [이메일 게재/교정쇄 전송 중 오류 발생](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22995.html?lang=ko) | 신규 문서 | 배포 마법사를 사용하여 이메일 게재/교정쇄 전송 중 오류가 발생할 경우 문제를 해결하기 위한 빠른 안내서에 대해 알아봅니다. |
...
* 최신 정보는 [2024년 1월 - 최신 릴리스 정보](https://experienceleague.adobe.com/docs/marketo/using/release-notes/current.html?lang=ko-KR)를 참조하십시오.
...
## ![Icon](/assets/experience-league.png) 고객 데이터 관리 - Voices {#voices}
