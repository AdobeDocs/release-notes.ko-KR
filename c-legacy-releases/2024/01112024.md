...
Experience League에서 [예정된 이벤트](https://experienceleague.adobe.com/events/)를 모두 보거나 [이벤트 녹음/녹화](https://experienceleague.adobe.com/docs/events/experience-league-recorded-events/overview.html)를 찾아보세요.
...
| 2023년 12월 | Platform, Journey Optimizer | [푸시 알림 만들기 및 전송](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push.html) | 문서 | [!DNL Experience Platform Mobile SDK] 및 [!DNL Journey Optimizer]를 사용하여 모바일 앱용 푸시 알림을 만드는 방법에 대해 알아봅니다. |
| 2023년 12월 | Mobile SDK, Journey Optimizer | [인앱 메시지 만들기 및 전송](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp.html) | 문서 | [!DNL Experience Platform Mobile SDK] 및 [!DNL Journey Optimizer]를 사용하여 모바일 앱용 인앱 메시지를 작성하는 방법에 대해 알아봅니다. |
| 2023년 12월 | Platform, Journey Optimizer | [의사 결정 관리를 통해 오퍼 만들기 및 표시](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers.html) | 문서 | [!DNL Experience Platform Mobile SDK]가 있는 모바일 앱의[!DNL Journey Optimizer] [!UICONTROL 의사 결정 관리]에서 오퍼를 표시하는 방법에 대해 알아봅니다. |
...
| 2023년 12월 | 데이터 수집 | [Adobe Experience Platform Mobile SDK 설치](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/app-implementation/install-sdks.html) | 문서 | 모바일 앱에서 Adobe [!DNL Experience Platform Mobile SDK]를 구현하는 방법에 대해 알아봅니다. |
...
| 2023년 12월 | [ [!DNL OOTB] 워크플로를 사용하여 모바일 앱 인증서 만료 알림 관리](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23280.html) | 신규 문서 | [!DNL OOTB] 워크플로를 통해 Adobe Campaign Standard로 모바일 앱 인증서 알림을 자동화하는 방법에 대해 알아봅니다. |
...
| 2023년 12월 | [이메일 게재/교정쇄 전송 중 오류 발생](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22995.html) | 신규 문서 | 배포 마법사를 사용하여 이메일 게재/교정쇄 전송 중 오류가 발생할 경우 문제를 해결하기 위한 빠른 안내서에 대해 알아봅니다. |
