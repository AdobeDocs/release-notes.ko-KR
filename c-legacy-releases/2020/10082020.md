...
| 2020년 9월 21일 | [계정 및 서비스 설정](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/accounts-and-services.html) | 문서 | asset compute AEM 작업자를 개발하려면 as a Cloud Service, Adobe Developer App Builder 및 Microsoft 또는 Amazon에서 제공하는 클라우드 스토리지를 비롯한 계정 및 서비스에 액세스해야 합니다. |
