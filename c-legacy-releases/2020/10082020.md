...
| 2020년 9월 21일 | [Adobe I/O Project Firefly 설정](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/firefly.html) | 비디오 | Asset Compute 애플리케이션은 특별히 정의된 Adobe Project Firefly 애플리케이션으로서, 설정 및 배포하려면 Adobe 개발자 콘솔에서 Adobe Project Firefly에 액세스해야 합니다. |
