...
| [Analysis Workspace의 여러 보고서 세트](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/using-panels/multiple-report-suites-in-analysis-workspace.html?lang=ko-KR) | 패널 수준에서 보고서 세트를 선택하여 단일 [!UICONTROL Workspace] 프로젝트의 여러 보고서 세트를 분석할 수 있습니다. 이렇게 하면 여러 데이터 세트에서 나란히 패널 분석을 수행할 수 있습니다. |

제품 설명서에 대해서는 [Adobe Analytics 도움말 홈](https://experienceleague.adobe.com/docs/analytics.html)을 참조하십시오.
