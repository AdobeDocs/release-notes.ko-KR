...
| 2020년 6월 5일 | [SPA 편집기 프로젝트](https://experienceleague.adobe.com/docs/experience-manager-learn/spa-react-tutorial/create-project.html?lang=ko) | 문서 | AEM(Adobe Experience Manager) 프로젝트 원형을 사용하여 AEM SPA 편집기와 통합된 반응형 애플리케이션의 시작점으로 다중 모듈 Maven 프로젝트를 생성하는 방법을 알아봅니다. |
