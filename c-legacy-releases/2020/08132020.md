...
| 기능 | [일반 가용성](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=ko) - 대상 날짜 | 설명 |
| ----------- | ---------- | ---------- |
| 작업 영역의 미디어 동시 뷰어 패널 | 2020년 9월 17일 | 미디어 동시 뷰어 패널을 사용하면 최대 동시 시청 횟수가 발생한 위치 또는 드롭오프가 발생한 위치를 파악할 수 있습니다.  콘텐츠 및 뷰어 참여의 품질에 대한 중요한 통찰력을 제공하고 볼륨/규모에 대한 문제 해결 또는 계획을 수립하는 데 도움이 됩니다. [자세히 알아보기...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/media-concurrent-viewers.html?lang=ko) |
...
| 2020년 7월 6일 | [Adobe Analytics를 사용하여 Advertising Cloud 대시보드 만들기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/integrations/ad-cloud/create-advertising-cloud-dashboards-with-adobe-analytics.html?lang=ko#tutorials) | 튜토리얼 | 라이브 캠페인 모니터링을 위한 Advertising Cloud 대시보드를 만드는 기술 |
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------- | ----------- | ---------- | ---------- |
| 2020년 8월 7일 | [광고를 변환기로 내보내 비용을 절감하고 고객 경험 최적화하기](https://experienceleague.adobe.com/?lang=ko&recommended=AudienceManager-A-1-2020.1) | 튜토리얼 | 이 강좌에서는 도달 범위의 캠페인에서 기존 고객을 제거하여 비용을 절감하고 고객 경험을 최적화하는 사용 사례를 통해 처음부터 끝까지 살펴보면서 모든 개념을 알아봅니다. 여기에는 트레이트 및 세그먼트 작성, 올바른 프로필 병합 규칙 추가, 대상에 세그먼트 추가, 이 사용 사례를 사용하는 중 ROI 계산 등이 포함됩니다. |
...
| 2020년 8월 4일 | [Adobe I/O에서 API 자격 증명 검색하기](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/api/retrieve-api-credentials-in-adobe-io.html?lang=ko) | 튜토리얼 | REST API 사용을 위한 자격 증명을 찾기 위해 Adobe 컨설팅이나 고객 지원에 연락하는 대신, 브라우저에서 `Adobe.io`로 이동하여 자격 증명을 검색하거나 등록할 수 있습니다. |
...
| 2020년 7월 22일 | [실용적인 세그먼트 정의 및 작성](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/practical-segment-definition-and-creation.html?lang=ko) | 튜토리얼 | 이 비디오에서는 세그먼트를 정의한 다음 작성 시 필요한 트레이트와 신호에 따라 분류하는 방법을 안내합니다. |
| 2020년 7월 17일 | [변환기에 대한 광고 억제](https://video.tv.adobe.com/v/36658) | 튜토리얼 | 변환기에 대한 광고를 억제하여 비용을 절감하고 고객 경험을 최적화할 수 있습니다. |
| 2020년 7월 15일 | [고객 억제 사용 사례에서 ROI 측정하기](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/intro-to-audience-manager/value-realization/measuring-roi-in-a-customer-suppression-use-case.html?lang=ko) | 튜토리얼 | 기존 고객에 대한 광고를 억제하여 캠페인 비용 절감을 결정하는 몇 가지 공식의 사용 방법을 살펴봅니다. |
...
* **AEM as a Cloud Service**
   ...
   * [정적 전용 송신 IP 주소](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/development-guidelines.html?lang=ko#dedicated-egress-ip-address)를 Java 코드로 프로그래밍된 아웃바운드 트래픽에 대해 할당할 수 있으며 이는 일부 통합에 유용할 수 있습니다.
