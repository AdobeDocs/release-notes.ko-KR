...
도움말 홈을 찾고 계십니까? [Adobe Experience Cloud 설명서](https://experienceleague.adobe.com/docs/home.html?lang=ko)를 참조하십시오.
...
**참고:** 다음 [!UICONTROL 피드] 페이지는 2020년 1월부터 사용되지 않습니다. 제품 내 사용 중단 알림을 찾으십시오.
...
* **Experience Cloud 대상 최적화**: 이 기능을 사용하여 세그먼트를 8시간 이내에(이전의 48시간 처리 시간이 아니라) Experience Cloud에 게시할 수 있습니다. [추가 정보...](https://experienceleague.adobe.com/docs/analytics/components/segmentation/segmentation-workflow/seg-publish.html?lang=ko-KR)
...
[JavaScript용 AppMeasurement 릴리스 정보](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ko)를 참조하십시오. 버전 2.20.0은 2020년 2월 5일에 릴리스되었습니다.
...
* **AEM 6.3.3.8**
   ...
   * [릴리스 노트](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html?lang=en)
   * [AEM Forms CFP 릴리스](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=en)
...
* **AEM Assets Brand Portal**
   ...
   * [릴리스 노트](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html?lang=ko)
...
[스마트 자르기 작업](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/adding-dynamic-media-assets-to-pages.html?lang=ko-KR)을 참조하십시오.
...
자세한 내용은 [!DNL Marketo]2020년 2월[ 릴리스 노트](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html?lang=ko)를 참조하십시오.
...
| [!DNL Adobe Campaign] | 자습서 - [Android에서 푸시 알림™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=ko) | iOS 및 Android™ 모바일 장치로 맞춤형 및 세그먼트화된 푸시 알림을 보냅니다. 이 튜토리얼은 Adobe Campaign에서 푸시 알림을 전송하고 Android™ 앱에서 이러한 알림을 받는 것과 관련된 단계를 설명합니다. |
...
| Adobe Analytics | 비디오 - [Adobe Analysis Workspace에서 비즈니스를 변경하는 방법](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/how-adobe-analysis-workspace-can-change-your-business.html?lang=en) | 를 사용하여 Ad Hoc Analysis, 유연한 분석, 집단 분석 및 폴아웃 분석을 수행하는 방법을 알아봅니다 [!UICONTROL Analysis Workspace]. 또한 분석 작업 환경을 회사의 모든 사람과 공유할 수 있고, 드래그 앤 드롭 기능을 통해 모든 사람이 데이터를 쉽게 분석하고 통찰력을 신속하게 얻을 수 있습니다. |
