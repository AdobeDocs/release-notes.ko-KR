...
* **Experience Cloud 대상 최적화**: 이 기능을 사용하여 세그먼트를 8시간 이내에(이전의 48시간 처리 시간이 아니라) Experience Cloud에 게시할 수 있습니다. [자세히 알아보기...](https://experienceleague.adobe.com/docs/analytics/components/segmentation/segmentation-workflow/seg-publish.html?lang=ko)
...
* Adobe Campaign Classic: [설명서](https://experienceleague.adobe.com/docs/campaign-classic.html?lang=ko) - [방법 비디오](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=ko-KR)
...
| [!DNL Adobe Campaign] - Audience 대상 | 비디오 - [마케팅 워크플로에서 Adobe Experience Platform 대상 활성화](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/profiles-and-audiences/audience-destinations/activating-aep-audiences.html?lang=ko) | [!UICONTROL 대상 읽기] 활동을 사용하여 워크플로 내에서 [!UICONTROL Data Services 쿼리 대상]을 활성화하는 방법을 알아봅니다. |
