...
Experience Cloud 인터페이스에 대한 최신 릴리스 정보(고객 특성, 대상, 사용자 및 제품 관리)는 [누적 릴리스 정보](https://experienceleague.adobe.com/docs/core-services/interface/release-notes/release-notes.html)를 참조하십시오.
...
* 의 필터링을 방해하는 문제를 해결했습니다. [!UICONTROL 작업 영역] 열을 &quot;지정되지 않음&quot; 차원으로 지정합니다. (AN-222393)
...
| 2020년 8월 21일 | [대상 세그먼트 생성 및 전략](https://experienceleague.adobe.com/?recommended=AudienceManager-U-1-2020.2) | 교육 과정 | 이 교육 과정에서는 세그먼트를 만들고, 관리하고, 대상 파트너에게 활성화하는 방법을 처음부터 끝까지 알아봅니다. 유용한 사용 사례를 살펴보고 고객의 팁과 요령을 확인할 수 있습니다. |
