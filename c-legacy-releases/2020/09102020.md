...
Experience Cloud 인터페이스에 대한 최신 릴리스 정보(고객 속성, 대상자, 사용자 및 제품 관리)는 [누적 릴리스 정보](https://experienceleague.adobe.com/docs/core-services/interface/release-notes/release-notes.html?lang=ko)를 참조하십시오.
...
| 2020년 8월 17일 | [데이터 엔지니어의 Adobe Experience Platform 시작을 위한 교육 과정 소개](https://video.tv.adobe.com/v/39478) | 비디오 | [데이터 엔지니어를 위한 Adobe Experience Platform 시작하기](https://experienceleague.adobe.com/?lang=ko&recommended=ExperiencePlatform-D-1-2020.2) 교육 과정의 소개 비디오입니다 . |
...
| 2020년 8월 17일 | [데이터 설계자를 위한 Adobe Experience Platform 시작하기 교육 과정 소개](https://video.tv.adobe.com/v/39477) | 비디오 | 이 비디오에서는 [데이터 설계자를 위한 Adobe Experience Platform 시작하기](https://experienceleague.adobe.com/?lang=ko&recommended=ExperiencePlatform-D-1-2020.1) 교육 과정에 대한 개요를 제공합니다. |
...
| 기능 | [일반 가용성](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=ko) - 대상 날짜 | 설명 |
| ----------- | ---------- | ----- |
| Customer Journey Analytics 권한 변경 | 2020년 9월 9일 | CJA는 더 이상 모든 사용자를 관리자로 취급하지 않습니다. [Adobe Admin Console](https://experienceleague.adobe.com/docs/core-services/interface/manage-users-and-products/admin-getting-started.html?lang=ko)에서 제품 관리자로 지정된 사용자만 다음 동작을 수행할 수 있습니다.<ul><li>[!UICONTROL 연결] 또는 [!UICONTROL 데이터 보기] 만들기/업데이트/ 삭제하기</li><li>다른 사용자가 만든 프로젝트, 필터 또는 계산 지표 업데이트/삭제하기</li><li>모든 사용자에게 작업 영역 프로젝트 공유</li></ul>[자세히 알아보기...](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-overview.html?lang=ko#admin-access-permissions) |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2020년 8월 30일 | [Analysis Workspace에서 프로젝트 저장, 공유 및 공동 작업하기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/saving-sharing-and-collaborating-on-projects-in-analysis-workspace.html?lang=ko) | 비디오 | [!UICONTROL Analysis Workspace]에서 테이블에 텍스트 설명을 추가하고 프로젝트에 대한 직접 링크를 만들어 공유하는 방법을 살펴봅니다. |
| 2020년 8월 28일 | [교육 과정 소개 - 고객 여정의 디지털 터치 포인트에 대한 가치 부여](https://video.tv.adobe.com/v/39380) | 비디오 | 이 소개 비디오에서는 [고객 여정의 디지털 터치 포인트에 대한 가치 부여](https://experienceleague.adobe.com/?lang=ko&recommended=Analytics-U-1-2020.2) 교육 과정의 전제 조건과 교육 과정 내용을 살펴봅니다. |
| 2020년 8월 28일 | [고객 여정의 디지털 터치 포인트에 대한 가치 부여](https://experienceleague.adobe.com/?lang=ko&recommended=Analytics-U-1-2020.2) | 교육 과정 | 사이트 방문자의 사이트 방문자 식별, 사이트 내 전환 크레딧을 다른 채널로 할당하는 방법, 사이트의 다른 항목이 사이트 전환을 유도하는 방법을 이해하여 사이트 방문자를 파악할 수 있습니다. 이 교육 과정에서는 이 분석을 보여주는 기본 시각화와 [!UICONTROL 속성 IQ]를 사용하여 분석에 속성 모델을 할당하는 방법을 설명합니다. |
| 2020년 8월 21일 | [교차 탭 분석을 사용하여 Analysis Workspace의 기본 마케팅 기여도 분석하기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/attribution-iq/using-cross-tab-analysis-to-explore-basic-marketing-attribution-in-analysis-workspace.html?lang=ko) | 비디오 | Adobe Analytics를 통해 기여도 분석 방법을 한 차원 끌어올릴 수 있는 방법은 여러 가지가 있습니다. 이 비디오에서는 [!UICONTROL 작업 영역]에서 교차 탭 분석을 사용하여 [!UICONTROL 마케팅 채널] 보고서에서 보다 세부적인 통찰력을 도출하는 방법을 강조표시합니다. |
| 2020년 8월 21일 | [마우스 오른쪽 버튼을 클릭하여 작업 영역 효율성 향상하기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/right-click-for-workspace-efficiency.html?lang=ko) | 비디오 | 자주 사용하는 모든 Analysis Workspace를 마우스 오른쪽 버튼으로 클릭하고 이를 사용하는 방법을 살펴볼 수 있습니다. 자유 형식 테이블에서 폴아웃 시각화에 이르기까지 마우스 오른쪽 버튼을 클릭하면 작업 영역에서 보다 효율적이고 능숙하게 작업할 수 있습니다. |
...
| 2020년 8월 17일 | [양식 데이터 모델을 사용하여 적응형 양식 미리 채우기](https://experienceleague.adobe.com/?lang=ko&recommended=ExperienceManager-D-1-2020.1.forms) | 교육 과정 | 기존 데이터를 사용하여 적응형 양식의 필드를 미리 채울 수 있습니다. 이 교육 과정에서는 양식 데이터 모델의 요청 속성을 사용하여 필드를 미리 채우는 방법을 학습합니다. |
...
| 2020년 8월 25일 | [DM 전송 만들기](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/direct-mail/creating-direct-mail-deliveries.html?lang=ko) | Campaign Classic | Adobe Campaign에서 DM(Direct Mail) 작동 방식을 이해하고 DM(Direct Mail Delivery)을 제작, 포맷 및 실행하는 방법을 알아봅니다. |
