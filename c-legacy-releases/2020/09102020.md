...
| 2020년 8월 17일 | [Google 고객 일치 타겟팅](https://experienceleague.adobe.com/docs/platform-learn/tutorials/rtcdp/integrate-with-google-customer-match.html) | 비디오 | 이 비디오에서는 Adobe의 Real-Time CDP 및 Google의 Customer Match 기능을 통해 기업이 Google의 소유 및 운영 자산을 활용하여 고객과의 관계를 강화하면서 비즈니스 목표를 달성하는 데 어떻게 도움이 되는지 보여줍니다. |
