...
| 2020년 9월 14일 | [Adobe Developer App Builder 설정](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/firefly.html) | 튜토리얼 | asset compute 응용 프로그램은 특별히 정의된 Adobe Developer App Builder 응용 프로그램으로서, 설정 및 배포하려면 Adobe Developer 콘솔에서 Adobe Developer App Builder에 액세스해야 합니다. |
...
| 2020년 9월 25일 | [계정 및 서비스 설정](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/accounts-and-services.html) | 문서 | 개발 Asset compute 작업자는 AEM as a Cloud Service, Adobe Developer App Builder, Microsoft 또는 Amazon에서 제공하는 클라우드 스토리지 등 계정 및 서비스에 액세스해야 합니다. |
