...
>[!IMPORTANT]
>
>Workfront for Experience Manager 강화 커넥터의 [최신 1.9.9 버전으로 업그레이드](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=ko)하는 것이 좋습니다.
...
| 2023년 5월 | [[!UICONTROL 라이브 검색]](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/capabilities/live-search-full-demonstration.html?lang=en)에 대한 전체 데모 | 비디오 | [!UICONTROL 라이브 검색]의 기능 및 유연성에 대한 전체 데모 시청. |
