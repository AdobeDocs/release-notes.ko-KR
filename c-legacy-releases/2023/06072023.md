...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2023년 6월 | [다중 샌드박스 이벤트 전달 데이터 수집](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-ingestion/multi-sandbox-event-forwarding.html) | Blueprint 튜토리얼 | Experience Platform Web 및 Mobile SDK로 수집된 데이터가 단일 이벤트를 수집하고 여러 AEP 샌드박스로 전달되도록 구성하는 방법에 대해 알아봅니다. |
