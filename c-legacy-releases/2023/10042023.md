...
* **[개선된 Adobe Sign 워크플로 단계](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=ko-KR#sign-document-step-sign-document-step)** – Adobe Sign 워크플로 단계는 다음을 포함하도록 개선되었습니다.
...
>[!IMPORTANT]
>
>Workfront for Experience Manager 강화 커넥터의 [최신 1.9.13 버전으로 업그레이드](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=ko-KR)하는 것이 좋습니다.
...
| 2023년 9월 | [기업 계정 관리](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/company-accounts.html) | 비디오 | 보류 상태인 요청을 포함하여 B2B 기업 계정을 관리하는 방법에 대해 알아봅니다. |
