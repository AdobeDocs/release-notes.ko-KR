...
| 2023년 9월 | [등록 토큰이 _nms:appSubscriptionRcp_ 테이블](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22844.html?lang=ko)에 저장되지 않음 | 신규 문서 | 등록 토큰이 `nms:appSubscriptionRcp` 테이블에 저장되지 않는 경우 문제에 대한 솔루션을 알아봅니다. |
