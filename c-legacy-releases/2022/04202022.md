...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 4월 | [업그레이드 호환성 도구 개요](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/upgrade/upgrade-compatibility-tool-overview.html?lang=ko) | 비디오 | 업그레이드 호환성 도구에 대해 알아보고 최신 버전의 Adobe Commerce로 업그레이드하는 데 필요한 오류 및 해결 방법을 신속하게 식별하는 데 이 도구가 어떻게 도움이 되는지 알아보십시오. |
