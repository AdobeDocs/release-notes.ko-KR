...
| 2022년 5월 | [세그먼트 매치 구성 플로우](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/segment-match-configuration-flow.html) | 비디오 | 데이터 공유에 대한 [!UICONTROL 세그먼트 일치] 인스턴스를 구성하는 프로세스에 대해 알아봅니다. | [!DNL Real-time Customer Data Platform] |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 5월 | [Report Builder 시작하기](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/get-started-with-report-builder.html) | 비디오 | 설치, 로그인 및 데이터 요청을 포함한 Report Builder 사용의 기본 사항에 대해 알아보십시오. |
...
| 2022년 5월 | [대체 제안 만들기](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/create-fallback-offers.html?lang=ko) | 비디오 | 의사 결정 관리에 사용할 대체 제안을 만드는 방법을 알아봅니다. 대체 오퍼는 맞춤형 오퍼에 대한 자격이 없는 고객에게 표시되는 기본 오퍼입니다. |
