...
| 기능 | 설명 |
| ------- | ----------- |
| [!UICONTROL 맞춤형 보고서] | (31) 5월 베타 기능) 이제 Advertising Cloud DSP에서 고객 데이터 플랫폼(CDP) 내에서 구축된 인증된 신호로 구성된 자사 세그먼트를 수집할 수 있습니다. |
| 최적화 목표 | 5월 25일) 이제 사용자 지정 목표가 있는 패키지에 비디오 및 기본 배치를 포함할 수 있습니다 [!UICONTROL 최고 ROAS] 및 [!UICONTROL 최저 CPA]. |
...
| Adobe Analytics와의 통합 | (5월 7일) Advertising Cloud이 보내는 데이터 피드에서 [!DNL Analytics], 데이터 [!DNL Google Ads] 동적 검색 광고는 2022년 5월 7일부터 광고 그룹 수준으로만 사용할 수 있습니다. |
