...
| 2022년 1월 | [미디어 재생 소요 시간 패널](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html?lang=ko-KR) | 비디오 | 미디어 재생 소요 시간 패널을 통해 미디어 사용자가 선택한 세부 기간을 하루 동안 시청한 시간을 기준으로 시청률을 파악하는 방법에 대해 알아봅니다. |
...
| 2022년 1월 | [Analysis Workspace에서 치수로 세그먼트 사용](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.html?lang=ko-KR) | 업데이트된 비디오 | Analysis Workspace에서 세그먼트를 치수로 사용하여 비교하고 시각화하는 방법에 대해 알아봅니다. |
...
| 2022년 1월 | [Analysis Workspace에서 세그먼트를 사용하여 데이터 제한](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-to-limit-data-in-analysis-workspace.html?lang=ko-KR) | 업데이트된 비디오 | Analysis Workspace에서 프로젝트 사용자를 도구를 사용하여 작업할 때 특정 세그먼트로 제한하는 방법에 대해 알아봅니다. |
