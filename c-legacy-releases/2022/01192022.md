...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [XML 설명서 릴리스](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/tutorials/release-info/latest-release-info.html?lang=ko-KR) | 비디오 | 강력한 엔터프라이즈급 구성 요소 콘텐츠 관리 솔루션(CCMS)인 Experience Manager Guides에 대해 알아봅니다. 이는 Adobe Experience Manager의 기본 DITA 지원을 활성화하며, AEM에서 DITA 기반 콘텐츠 생성 및 전달을 처리할 수 있도록 촉진합니다. |
