...
| 2022년 1월 | [데이터베이스에 표 추가](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/add-new-db-table.html?lang=ko) | 비디오 | 데이터베이스 표를 생성하고, 기존 데이터베이스 표를 수정하고, 거기에 설정 데이터와 같이 모듈 설치 시 추가하는 데이터를 추가할 수 있는 Commerce의 특별한 메커니즘에 대해 알아봅니다. |
