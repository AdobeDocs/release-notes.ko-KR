...
지난 에피소드는 [Experience League 라이브](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html)에서 확인할 수 있습니다.

### 커뮤니티 Q&amp;A Coffee Break{#coffee}

1시간 동안 특별한 게스트와 함께하고 Experience League 커뮤니티에 질문을 제출해 보십시오. Adobe에서 제품 전문가로부터 답변을 받을 수 있습니다!

| 이벤트 이름 | 일자 | 애플리케이션 | 형식 | 설명 |
| -----------| ---------- | ---------- | ---------- |---------- |
| Customer Journey Analytics과 Analytics의 미래 | 2022년 1월 18일 @ 오전 8시(PST) | Adobe Analytics, Customer Journey Analytics, Experience Platform | 포럼 Q&amp;A | Analytics 커뮤니티에서 Adobe Analytics의 그룹 제품 관리자인 Trevor Paulsen에게 질문을 게시해 보십시오.<br>[세부 정보 및 등록](https://analyticscommunityqacoffeebrea.splashthat.com/?utm_source=community-thread&utm_campaign=coffee_talk_AA&utm_content=220118) |
...
| 이벤트 | 날짜 및 시간 | 유형 | 설명 |
| -----------| ---------- | ---------- |---------- |
| [Adobe [!DNL Developers Live]](https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/2021/oct2021/overview.html) | 온디맨드 | 비디오 | [!DNL Developers Live] 업계 전반에 걸쳐 디자인, 콘텐츠 제작 워크플로, 문서 서비스 및 고객 경험 관리를 지원하는 최신 기술 발전 및 개발자 도구를 소개합니다. 기조 연설을 보고 Analytics API, 클라이언트 데이터 레이어, Adobe I/O 오픈 소스 프로젝트 등에 대해 알아보십시오. |
...
[!DNL Adobe System Status]의 [최신 릴리스 정보](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html#status)를 참조하십시오.
...
최신 정보는 [Experience Platform 릴리스 정보](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=ko)를 참조하십시오.
...
| 기능 | 설명 | 목표 날짜 |
| ----------- | ---------- | ------- |
| 해당 없음 | | [일반 가용성](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html) 확인 |
...
* 작업 영역에서 날짜 필드를 사용하여 날짜를 변경할 때 발생한 문제가 해결되었습니다. 이로 인해 [!UICONTROL 종료 시간]이(가) 오후 11:59에서 오전 12:00로 변경되었습니다. (AN-277269; AN-277481)
...
* 그래프의 날짜 범위가 테이블의 데이터 필터를 무시하는 문제가 해결되었습니다. (AN-263999)
...
| [!DNL Reports & Analytics]에 대한 EOL | 2022년 1월 4일 | **2023년 12월 31일**&#x200B;부로 Adobe는 [!DNL Reports & Analytics] 및 관련 보고서와 기능에 대한 서비스를 중단할 예정입니다. [!DNL Reports & Analytics]을(를) 지원하는 보고서, 시각화 및 기본 기술은 더 이상 Adobe의 기술 표준을 충족하지 않습니다. 대부분의 [!DNL Reports & Analytics] 기능은 [Analysis Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html)에서 사용할 수 있습니다. 2015년 Analysis Workspace가 출시된 이후 [!DNL Reports & Analytics] 기능이 Analysis Workspace로 이전되면서 워크플로 패리티의 한계점에 도달했습니다. [이 공지 사항](https://spark.adobe.com/page/6WnF8JK6IRDhf/)은 서비스 종료 프로세스에 대해 설명합니다. |
| Secure File Transfer Protocol(SFTP) 서비스 업그레이드 | 2022년 1월 13일 | **2022년 5월 2일**, [!DNL Adobe Analytics]는 파일 전송 보안을 개선하기 위해 Secure File Transfer Protocol(SFTP) 서비스를 업그레이드할 예정입니다. 이 변경 사항으로 일부 SFTP 클라이언트 구성은 더 이상 지원되지 않습니다. 또한 **2022년 3월 1일**&#x200B;까지 사용할 수 있는 몇 가지 연결 옵션을 추가할 예정입니다. 이는 SFTP를 사용하여 Adobe Analytics로 전송되거나 Adobe Analytics에서 검색된 데이터에만 영향을 줍니다. FTP 프로토콜은 영향을 받지 않습니다. 서비스 중단을 방지하려면 SFTP 클라이언트(코드, 도구, 서비스)가 [여기](https://experienceleague.adobe.com/docs/analytics/export/ftp-and-sftp/secure-file-transfer-protocol/sftp-upgrade.html)에 설명된 변경 사항을 준수하는지 확인하십시오. |
| _글로벌 + 중국_ RDC 유형 | 2021년 11월 22일 화요일 | _글로벌 + 중국_&#x200B;은 [!UICONTROL 중국 성능 최적화 추가 기능 패키지]를 사용하여 글로벌 고객의 트래픽 라우팅을 간소화하는 새로운 지역 데이터 수집(RDC) 유형입니다. 이전까지는 데이터를 중국 수집 엔드포인트로 라우팅할지 또는 글로벌 수집 엔드포인트 중 하나로 라우팅할지를 결정해야 했습니다. 이제 이 RDC *유형*&#x200B;을 선택하여 Adobe가 사용자의 지리적 위치를 기반으로 최적의 수집 엔드포인트를 결정하도록 할 수 있습니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [비즈니스 사용자를 위한 Analytics 기본 사항이 삭제되었습니다.](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/retire-fundamentals-for-business-users-course.html) | 비디오 | 원래 교육 과정이 삭제된 이유 및 Adobe에서 권장하는 새로운 대체 교육 과정에 대해 알아봅니다. |
| 2022년 1월 | [미디어 재생 소요 시간 패널](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html) | 비디오 | 미디어 재생 소요 시간 패널을 통해 미디어 사용자가 선택한 세부 기간을 하루 동안 시청한 시간을 기준으로 시청률을 파악하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [Adobe Analytics의 고객 세분화 전략 및 모범 사례](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/customer-segmentation-strategies.html) | 비디오 | 고객 세분화 기본 사항, 전략 및 모범 사례를 중점적으로 다루는 Analytics Thursday의 분석 인사이더에 가입하십시오. |
| 2022년 1월 | [유료 검색 탐지 구성](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configure-paid-search-detection.html#) | 비디오 | Adobe Analytics Admin Console에서 몇 가지 권장 사항을 포함하여 [유료 검색 탐지] 섹션의 구성을 살펴봅니다. |
| 2022년 1월 | [목록 변수 구성](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-list-variables.html) | 비디오 | Adobe Analytics에서 목록 변수를 구성하고 사용하는 방법 및 이유를 알아봅니다. 목록 변수를 사용하여 하나의 eVar에 두 개 이상의 값을 입력할 수 있습니다. |
| 2022년 1월 | [트래픽 변수 구성(Prop)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-traffic-variables-props.html) | 비디오 | Analytics Admin Console에서 _Prop_&#x200B;이라고도 하는 트래픽 변수의 구성에 대해 알아봅니다. |
| 2022년 1월 | [처리 규칙을 사용하여 수신 데이터 조작](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/manipulating-incoming-data-with-processing-rules.html) | 비디오 | Adobe Analytics의 처리 규칙 및 이를 사용하여 수행할 수 있는 작업에 대해 알아봅니다. 처리 규칙 사용에 대한 몇 가지 팁, 예 및 경고를 얻으십시오. |
| 2022년 1월 | [Analysis Workspace에서 치수로 세그먼트 사용](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.html) | 업데이트된 비디오 | Analysis Workspace에서 세그먼트를 치수로 사용하여 비교하고 시각화하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [Adobe Analytics의 세분화 관리 및 공유](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-management-and-sharing.html) | 업데이트된 비디오 | 이 업데이트된 비디오에서 세그먼트 공유 및 관리에 대한 몇 가지 팁을 알아볼 수 있습니다. |
| 2022년 1월 | [Analysis Workspace에서 세그먼트를 사용하여 데이터 제한](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-to-limit-data-in-analysis-workspace.html) | 업데이트된 비디오 | Analysis Workspace에서 프로젝트 사용자를 도구를 사용하여 작업할 때 특정 세그먼트로 제한하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [Analysis Workspace의 세그먼트 비교](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-comparison-in-analysis-workspace.html) | 업데이트된 비디오 | Adobe Analytics의 Analysis Workspace의 일부인 세그먼트 IQ가 모든 차원 및 지표에 걸쳐 두 개의 Analytics 세그먼트를 검사하여 통계적으로 가장 유의미한 차이점을 자동으로 검색함으로써 분석을 간소화하는 방법에 대해 알아봅니다. |
...
* [Customer Journey Analytics 제품 설명서](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Dynamic Media [!UICONTROL 이미지 스마트 자르기] 및 [!UICONTROL 견본]은(는) 이제 개선된 자르기 및 견본을 생성하는 최신 AI 서비스에서 제공합니다. 동일한 종횡비에 대해 서로 다른 해상도가 적용된 다양한 자르기 콘텐츠 생성을 위해 향상된 기능도 출시되었습니다. 또한 이미지 프로필에서 너비와 높이를 변경하지 않는 경우 재처리 시 수동 편집 기능은 그대로 유지됩니다.
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **안전한 처리를 위한 Experience Manager 워크플로 데이터 외부화**: 민감한 개인 데이터(SPD) 요소가 포함된, 처리 중인 Experience Manager 워크플로 데이터(Experience Manager [!UICONTROL 워크플로 변수] 데이터)를 안전하게 처리될 수 있도록 고객 관리 저장소에 저장할 수 있습니다. 데이터 요소와 워크플로 변수는 Experience Manager 저장소에 저장되지 않으며 워크플로 처리 중에 고객 관리 저장소에서 필요에 따라 가져옵니다.
      ...
      * **AEM Forms as a Cloud Service - 커뮤니케이션**: [커뮤니케이션 API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications.html)를 통해 템플릿과 XML 데이터를 결합하여 다양한 형식의 인쇄 문서를 생성할 수 있습니다. 이 서비스를 통해 동기화 모드와 배치 모드에서 문서를 생성할 수 있습니다. API를 사용하면 다음 작업을 수행하는 애플리케이션을 만들 수 있습니다.
         * 템플릿 파일(PDF 및 XDP)을 XML 데이터로 채워 문서를 생성합니다.
         * 비대화형 PDF 인쇄 스트림을 포함하여 다양한 형식의 출력 양식을 생성합니다.
      * **커뮤니케이션 API로 생성된 기록 문서 및 PDF 문서에 대한 사용자 지정 글꼴**: 이제 커뮤니케이션 API를 사용하여 생성된 PDF 문서의 브랜드 승인 글꼴을 사용하여 조직 요구 사항을 맞출 수 있습니다.
      * **Forms 포털**: [Forms 포털](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-an-adaptive-form/configure-forms-portal.html)을 사용하여 Experience Manager Sites 페이지에 게시된 적응형 양식을 나열할 수 있습니다. 이렇게 하면 사이트 방문자가 사용 가능한 모든 양식을 탐색할 수 있습니다. 또한 방문자는 [!UICONTROL Forms 포털]을 사용하여 적응형 양식의 초안을 저장 및 액세스하고 제출된 적응형 양식의 PDF 버전을 살펴볼 수 있습니다.

   * **Cloud Manager**

     _새로운 기능_

      * 이제 새로운 프론트엔드 파이프라인을 사용하여 가속화된 방식으로 프론트엔드 코드를 독점적으로 배포할 수 있습니다. 자세히 알아보려면 [Cloud Manager 프론트엔드 파이프라인](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html#front-end)을 참조하십시오.
      ...
      * 이제 `x-request-id` 응답 헤더를 [www.adobe.io](https://www.adobe.io/)의 API 플레이그라운드에 볼 수 있습니다. 이 헤더는 문제 해결을 위해 고객 지원 센터 문제를 제출할 때 유용합니다.
...
* **Experience Manager GEM Webinar - Experience Manager as a Cloud Service** | 2021년 검토 및 2022년 전망
  ...
  **날짜**: 2022년 1월 25일 화요일
  **시간**: 오전 8:00(PST) 또는 오후 5:00(CET) 또는 오후 9:30(IST)
  **시간**: 60분
  **비용**: 무료

   * [여기에서 등록](https://adobe.ly/3tAh3OC)
...
| 2022년 1월 | [이메일 서비스](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/networking/examples/email-service.html) | 비디오 | 고급 네트워킹 이그레스 포트를 사용하도록 AEM의 `DefaultMailService`를 구성하여 AEM as a Cloud Service에서 이메일을 전송합니다. | AEM as a Cloud Service |
| 2022년 1월 | [Workfront 강화 커넥터 기본 사항](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/basics.html) | 비디오 | Adobe Workfront 및 Experience Manager Assets 강화 커넥터의 기본 사항에 대해 알아봅니다. 또한 [프로젝트 폴더](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/project-folders.html)에 대해서도 살펴봅니다. | AEM Assets 서비스 및 Workfront |
| 2022년 1월 | [AEM Sites 시작하기 - 빠른 사이트 제작](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/site-template/overview.html) | 비디오(다중) | 사전 정의된 사이트 템플릿을 사용하여 Adobe Experience Manager의 빠른 사이트 제작을 통해 귀하의 첫 번째 사이트를 제작하는 로우 코드 접근법에 대해 알아봅니다. | AEM Sites |
| 2022년 1월 | [유연한 포트 이그레스용 비표준 포트에서의 HTTP/HTTPS 연결](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/networking/examples/http-on-non-standard-ports-flexible-port-egress.html) | 비디오(다중) | 비표준 포트(80/443이 아닌 포트)에서의 HTTP/HTTPS 연결이 AEM as a Cloud Service 외부로 프록시화되는 방법에 대해 알아봅니다. | AEM as a Cloud Service |
| 2022년 1월 | [활성화된/완료된 탭을 표시하는 아이콘 추가](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/ui-tips-and-tricks/active-complete.html) | 비디오 | 적응형 양식에 왼쪽 탭 내비게이션이 있을 때 아이콘이 탭 상태를 나타내도록 표시하는 방법에 대해 알아봅니다. | AEM Forms |
| 2022년 1월 | [Adobe Asset Link 설정](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/adobe-asset-link/setup.html) | 비디오 | 크리에이티브 팀 및 마케팅 팀이 콘텐츠 생성 프로세스에서 에셋에 대해 공동 작업을 수월하게 수행하도록 지원함으로써 조직에 신속하게 영향을 미칠 수 있습니다. | AEM Assets |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [XML 설명서 릴리스](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/tutorials/release-info/latest-release-info.html) | 비디오 | 강력한 엔터프라이즈급 구성 요소 콘텐츠 관리 솔루션(CCMS)인 Experience Manager Guides에 대해 알아봅니다. 이는 Adobe Experience Manager의 기본 DITA 지원을 활성화하며, AEM에서 DITA 기반 콘텐츠 생성 및 전달을 처리할 수 있도록 촉진합니다. |
| 2022년 1월 | [AEM을 위한 XML 설명서를 통한 출력 생성](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/output-generation/overview.html) | 비디오 및 문서 | 맵 대시보드, 보고서, 기준선 및 조건을 통한 게시 등에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [Business Intelligence](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/business-intelligence/1-overview.html) | 비디오(다중) | 개요부터 살펴보고 모든 Adobe Commerce 및 Magento Open Source 판매자에게 최적화된 완벽한 솔루션인 Business Intelligence에 대해 알아봅니다. |
| 2022년 1월 | [사용자, 역할 및 권한](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/users-roles-permissions.html) | 비디오 | 각 사용자에 대해 개별 사용자 계정을 생성하고 비즈니스 요구 사항에 따라 제한된 액세스 권한을 할당하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [이중 인증](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/two-factor-authentication.html) | 비디오 | 이중 인증(2FA)이 승인되지 않은 데이터로의 액세스를 차단하는 방법에 대해 알아봅니다. Adobe Commerce 및 Magento Open Source에서 여러 공급자의 이중 인증 방식을 지원합니다. |
| 2022년 1월 | [웹 사이트, 스토어 및 스토어 조회수 추가](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/add-websites-stores-views.html) | 비디오 | 모든 Adobe Commerce 및 Magento Open Source 설치가 웹 사이트, 스토어 및 스토어 조회수의 계층을 지원하는 방법에 대해 알아봅니다. 비즈니스 요구 사항에 따라 이 계층을 구축하고 확장할 수 있습니다. |
| 2022년 1월 | [스토어 URL 변경](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/change-store-url.html) | 비디오 | 스토어에 대한 기본 URL을 변경하는 방법에 대해 알아봅니다. (이 비디오의 콘텐츠는 2.1.0 릴리스에 반영됩니다.) |
| 2022년 1월 | [스토어 사이트 맵 설정](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/site-map-setup.html) | 비디오 | Commerce 스토어에 사이트 맵을 손쉽게 추가하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [프로모션 요금제 규칙](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/promotions-price-rules.html) | 비디오 | 제품 관계를 설정하고 다양한 조건에 따라 할인이 적용되는 요금제 규칙을 사용하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [페이지 제작](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/frontend-development/create-new-page.html) | 비디오 | 하나의 매개변수와 함께 JSON을 반환하는 페이지를 제작하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [JavaScript 모듈 추가](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/frontend-development/add-javascript-module.html) | 비디오 | 인사말 &quot;Hello World&quot;를 제공하는 간단한 JS 모듈 개발에 대해 알아봅니다. |
| 2022년 1월 | [페이지 빌더 개요](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/page-builder-overview.html) | 비디오 | 페이지 빌더를 사용하여 시각적 스토리텔링을 강화하고 고객 참여 및 충성도를 높이는 맞춤형 레이아웃을 통해 손쉽게 콘텐츠가 풍부한 페이지를 제작하는 방법에 대해 알아봅니다. |
| 2022년 1월 | [데이터베이스에 테이블 추가](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/add-new-db-table.html) | 비디오 | 데이터베이스 테이블을 생성하고, 기존 데이터베이스 테이블을 수정하고, 거기에 설정 데이터와 같이 모듈 설치 시 추가하는 데이터를 추가할 수 있는 Commerce의 특별한 메커니즘에 대해 알아봅니다. |
| 2022년 1월 | [모듈 생성](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/create-module.html) | 비디오 | 모듈은 Commerce의 구조적 요소이며, 전체 시스템은 모듈을 기반으로 구축됩니다. 일반적으로 맞춤화 생성의 첫 번째 단계는 모듈 구축입니다. |
| 2022년 1월 | [제품 속성 만들기](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/add-product-attribute.html) | 비디오 | Commerce에서 가장 인기 있는 작업 중 하나인 제품 속성을 추가하는 방법에 대해 알아봅니다. 속성은 제품과 관련된 다양한 실질적인 과제를 해결할 수 있는 강력한 방법입니다. |
| 2022년 1월 | [종속성 삽입 예](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/dependency-injection.html) | 비디오 | 오브젝트 A가 외부의 해당 종속성을 제공하는 오브젝트 B에 종속성을 선언할 수 있는 디자인 패턴인 종속성 삽입에 대해 알아봅니다. A가 선언하는 종속성은 일반적으로 클래스 인터페이스이며 B가 제공하는 종속성은 해당 인터페이스에 대한 구체적인 구현입니다. |
...
* Adobe Target 프리릴리스에 대한 자세한 내용은 [Adobe Target 프리릴리스](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html?lang=ko) 릴리스 정보를 참조하십시오.
* 현재 릴리스 정보는 [Target 릴리스 정보](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html)를 참조하십시오.
...
* [Campaign v7.2 릴리스](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html)
...
| 게시일 | 이름 | 유형 | 설명 | 버전 |
| ------| ----- | -----| ------ | --- |
| 2022년 1월 | [애드혹 이메일 전송 템플릿 배포](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/using-delivery-templates/deploy-ad-hoc-email-delivery-template.html) | 비디오 | 애드혹 이메일 전송 템플릿을 배포하는 방법을 알아보고 이를 통해 이메일 전송 및 전달 워크플로의 차이점에 대해 알아봅니다. | Campaign v8 |
| 2022년 1월 | [전송 템플릿 속성 설정](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/using-delivery-templates/set-delivery-template-properties.html) | 비디오 | 전송 템플릿 속성을 설정하는 방법을 알아보고 각 속성에 대해 자세히 살펴봅니다. | Campaign v8 |
| 2022년 1월 | [캠페인 승인 구성](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/create-approvals-and-validation-workflows/configure-approvals-for-campaigns.html) | 비디오 | 캠페인 수준에서 승인 및 검토자를 구성하는 방법에 대해 알아봅니다. | Campaign v8 |
| 2022년 1월 | [워크플로 내에 승인 프로세스 만들기](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/create-approvals-and-validation-workflows/create-approval-process-in-a-workflow.html) | 비디오 | 워크플로 내에 승인 프로세스를 만들어 전송을 시작하기 전에 타겟팅 선택 논리를 검토 및 승인하는 방법을 알아봅니다. | Campaign v8 |
| 2022년 1월 | [전송에 대한 승인 구성](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/create-approvals-and-validation-workflows/configure-approvals-for-deliveries.html) | 비디오 | 전송 수준에서 승인 및 검토자를 구성하는 방법에 대해 알아봅니다. | Campaign v8 |
| 2022년 1월 | [FFDA를 통한 API 스테이징 메커니즘](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/data-management/api-staging-mechanism.html) | 비디오 | 전체 FDA를 통한 API 스테이징 메커니즘의 작동 방식에 대해 알아봅니다. 스테이징이 사용되는 이유, Adobe Campaign의 주요 스테이징 원리 및 사용자 지정 테이블에 대해 스테이징 메커니즘을 활성화하는 방법에 대해 알아봅니다. | Campaign v8 |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [Advertising Cloud 튜토리얼](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/dsp/intro.html) | 비디오 | Advertising Cloud DSP에 대한 새로운 다섯 가지 비디오 튜토리얼을 시청할 수 있습니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2022년 1월 | [PDF 향상](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/enhance.html) | 비디오 | 이 실습형 튜토리얼에서는 그래픽 개선 사항 및 자동 번호 매기기를 추가하여 PDF를 변형하는 방법에 대해 알아봅니다. |
