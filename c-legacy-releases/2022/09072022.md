...
| 2022년 9월 | [웹에 최적화된 이미지 게재](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/components/web-optimized-image-delivery.html?lang=ko) | 비디오 | AEM 핵심 구성 요소를 사용하여 AEM as a Cloud Service 사이트의 웹에 최적화된 이미지 제공 기능을 활성화하는 방법에 대해 알아봅니다. | AEM Sites |
