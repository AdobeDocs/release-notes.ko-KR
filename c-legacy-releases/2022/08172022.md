...
* `mod_macro`를 이제 Experience Manager as a Cloud Service에서 사용할 수 있습니다. 지원되는 Apache 모듈의 목록은 [이 표](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html)를 참조하십시오.
...
* [컨트롤 패널 7월 릴리스](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html)
