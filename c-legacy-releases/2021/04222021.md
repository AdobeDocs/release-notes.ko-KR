...
| 비공개 인벤토리 | (10월 15일 릴리스) 이제 모든 사용자는 기존 스마트 광고 서비스 제공 양식의 간소화된 버전인 새로운 거래 ID 양식을 사용하여 거래 ID 세부 사항을 설정하고 편집할 수 있습니다. 새 거래 ID 세부 사항을 설정하려면 다음 위치로 이동하십시오. **[!UICONTROL 인벤토리]** > **[!UICONTROL 딜]** > **[!UICONTROL 만들기]**&#x200B;를 선택하고 을 선택합니다. **[!UICONTROL 거래 ID 베타]**. |
