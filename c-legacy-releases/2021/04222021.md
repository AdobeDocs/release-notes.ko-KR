...
| 2021년 4월 | [PDF 온라인 경험 제어 및 분석 수집](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=ko-KR) | 문서 | 조직은 웹 사이트에 PDF를 게시합니까? Adobe PDF Embed API를 사용하여 모양을 제어하고, 공동 작업을 활성화하고, 페이지 및 검색 체류 시간 등 사용자의 Embed API가 PDF과 상호 작용하는 방법에 대한 분석을 수집하는 방법을 알아봅니다. |
