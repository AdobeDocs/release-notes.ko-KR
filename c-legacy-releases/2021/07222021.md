...
| 2021년 7월 | [Adobe Document Services API를 통해 보고서 생성 및 편집](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reportcreation.html) | 문서 | PDF를 통해 테이블, 그래픽 및 인터랙티브 콘텐츠와 함께 풍부한 문서를 모든 사용자가 볼 수 있는 형식으로 손쉽게 공유할 수 있습니다. 이러한 통계를 경영진, 주주, 기부자 또는 다른 관련자와 공유하는 방법에 대해 알아봅니다. |
