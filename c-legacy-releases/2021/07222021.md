...
[Offer Decisioning 릴리스 정보](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=ko-kr)를 참조하여 최신 정보를 유지하십시오.

**Offer Decisioning을 위한 추가 리소스**

[설명서](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started/starting-offer-decisioning.html?lang=en) - [릴리스 정보](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=ko-kr) - [방법 비디오](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/introduction-to-decision-management.html?lang=en)
...
| 공지 | 추가 또는 업데이트 날짜 | 설명 |
| ----------- | ---------- | ---------- |
| Adobe Data Connectors의 EOL | 2021년 8월 3일 | Adobe [!UICONTROL Data Connectors]는 더 이상 실행 불가능하거나 지원되지 않는 레거시 기술을 기반으로 합니다. 이 표준을 사용하여 모든 통합이 지속적으로 제공되고 지원될 수 있습니다. 공식적인 서비스 종료 날짜는 **2021년 8월 19일**&#x200B;입니다. [자세히 알아보기...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=ko-KR) |
...
* **Experience Manager as a Cloud Service**
   ...
   * **AEM의 Cloud Manager 클라우드 서비스**
      ...
      * `damAssetLucene`색인 구조를 확인하기 위해 새 코드 품질 규칙이 추가되었습니다. [맞춤형 DAM 에셋 Lucene Oak 색인](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/custom-code-quality-rules.html?lang=en)을 참조하십시오.
...
* [Campaign v8 릴리스 정보](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html?lang=en)
...
| 2021년 7월 | [Adobe Document Services API를 통한 채용 공고](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/jobposting.html?lang=en) | 문서 | 여러 사용자와 함께 웹 사이트를 운영하는 경우, 모든 사용자가 원활한 경험을 할 수 있는 환경을 설계하는 것이 중요합니다. 자동으로 모든 업로드된 문서를 PDF로 변환하고 게시물에 인라인으로 임베드하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 보고서 생성 및 편집](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reportcreation.html?lang=en) | 문서 | PDF를 통해 표, 그래픽 및 인터랙티브 콘텐츠와 함께 풍부한 문서를 모든 사용자가 볼 수 있는 형식으로 손쉽게 공유할 수 있습니다. 이러한 통계를 경영진, 주주, 기부자 또는 다른 관련자와 공유하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 검토 및 승인](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reviews.html?lang=en) | 문서 | 몇 가지 Adobe Document Services API를 사용하여 실습형 검토 및 승인 사용 사례를 해결하는 방법에 대해 알아봅니다. |
| 2021년 7월 | [Adobe Document Services API를 통해 검색 및 색인화](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html?lang=en) | 문서 | 이 튜토리얼에서는 Adobe Document Services API의 환상적인 기능과 이 기능을 사용하여 문서를 손쉽게 보관하고 디지털화하는 방법에 대해 알아봅니다. Express NodeJS 애플리케이션을 만든 다음 보관, 디지털화 및 문서 변형을 위한 문서 서비스 API를 통합하여 이러한 기능을 살펴봅니다. |
