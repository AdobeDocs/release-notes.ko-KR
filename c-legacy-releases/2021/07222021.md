...
| 2021년 7월 | [Adobe Document Services API를 통해 NDA 작성](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/nda.html?lang=ko) | 문서 | 회사 NDA를 위한 Microsoft® Word 템플릿을 제작하는 방법에 대해 알아봅니다. Microsoft® Word, Adobe 문서 생성 Tagger용 Adobe의 무료 추가 기능은 &quot;태그&quot;를 삽입하여 동적 값을 입력하는 데 도움이 됩니다. 템플릿에 JSON 데이터를 전달하고 동적 PDF를 제작하는 방법에 대해 배울 수도 있습니다. 그런 다음 비즈니스 요구 사항 및 목표에 따라 해당 PDF를 이메일로 보내거나 브라우저에 표시하여 공동 작업자에게 보여 줄 수 있습니다. |
