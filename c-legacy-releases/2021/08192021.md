...
| 기능 | 날짜 | 설명 |
| ------- | ------- | -------|
| [!UICONTROL Unified Recents] - 최근에 액세스한 비즈니스 오브젝트에 대한 확장 지원 | 2021년 8월 10일 | [!UICONTROL Unified Recents]는 Journey Optimizer 및 Experience Platform의 추가 비즈니스 오브젝트로 확장됩니다. Journey Optimizer 고객은 Adobe Journey Optimizer 홈 페이지에서 최근에 액세스한 개체(메시지, 여정, 세그먼트, 스키마, 데이터 세트, 데이터 소스, 이벤트, 작업, 소스 및 대상)를 찾을 수 있습니다. |
...
| 2021년 8월 | [파일 기반 클라우드 스토리지 또는 이메일 마케팅 대상 구성](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html?lang=en) | 비디오 | Adobe Real-time Customer Data Platform(CDP)에서 파일 기반 대상을 구성하는 연습을 통해 팁을 얻을 수 있습니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 8월 | [[!UICONTROL 산점도] 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/scatterplot-visualization.html?lang=en) | 비디오 | 이 시각화를 사용하면 차원에 대한 여러 메트릭 간의 관계를 볼 수 있으며 X/Y 플롯의 항목을 그래프로 표시할 수 있습니다. 비즈니스 의사 결정을 내리는 데 도움이 되는 이상치 및 인사이트를 살펴보십시오. |
| 2021년 8월 | [트리맵 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/treemap-visualization.html?lang=en) | 비디오 | Analysis Workspace 프로젝트에서 [!UICONTROL 트리맵] 시각화를 추가하고 구성하는 방법에 대해 알아봅니다. 이 시각화는 한 번에 많은 데이터 포인트를 시각적으로 분석하는 데 도움이 됩니다. |
| 2021년 8월 | [데이터를 Analysis Workspace 프로젝트에 포함시키는 방법 이해](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/understanding-how-data-gets-into-your-analysis-workspace-project.html?lang=en) | 비디오 | Chrome의 Adobe Experience Platform [!UICONTROL Debugger] 확장 기능을 사용하여 Analysis Workspace의 페이지에서 테이블 및 시각화로의 데이터 흐름을 확인하는 방법에 대해 알아보십시오. |
| 2021년 8월 | [요약 번호 및 요약 변경 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/summary-number-and-summary-change-visualizations-2021.html?lang=en#) | 비디오 | Analysis Workspace에서 [!UICONTROL 요약 번호] 및 [!UICONTROL 요약 변경] 시각화를 추가하고 구성하는 방법에 대해 알아보십시오. |
| 2021년 8월 | [Analysis Workspace에서 벤 다이어그램](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/venn-diagram-visualization.html?lang=en) | 비디오 | 벤 다이어그램 시각화를 사용하여 Analysis Workspace에서 세그먼트의 겹침 및 교차를 시각적으로 표시할 수 있습니다. 몇 초 만에 놀랍고 통찰력 있는 벤 다이어그램을 쉽게 만들 수 있습니다. |
| 2021년 8월 | [Analysis Workspace의 글머리 기호 그래프 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/bullet-graph-visualization.html?lang=en) | 비디오 | [!UICONTROL 글머리 기호] 그래프는 분석의 목표에 대한(또는 초과) 진행 상황을 표시하는 유용한 방법입니다. 조직의 성공을 시각화할 수 있는 다른 방법을 제공합니다. |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager as a Cloud Service 기반**
      ...
      * 복제 에이전트의 트리 복제 UI [!UICONTROL 배포] 탭은 더 이상 사용되지 않는 것으로 간주되어야 합니다. 이 디자이너는 2021년 9월 30일 이후에 제거될 예정입니다. [대체 복제 전략에 대해 알아보십시오](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=en#tree-activation).
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **[!UICONTROL Acroform 기반 기록 문서]** - XFA 기반 양식 템플릿 외에 [Adobe Acrobat Form PDF(Acroform PDF)를 기록 문서의 템플릿으로 사용](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/create-an-adaptive-form/generate-document-of-record-for-non-xfa-based-adaptive-forms.html?lang=ko-KR)할 수도 있습니다.
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 8월 | [사용 사례 레시피](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/recipes.html) | 비디오 | 이러한 정부 및 상용 전자 서명 예를 사용하여 조직의 디지털 워크플로우를 가속화합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| --------- | --------- | --------- |
| 2021년 8월 | [Adobe Stock 라이선싱 내역 검색](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/searchstock.html) | 비디오 | Creative Cloud for enterprise에서 조직의 Adobe Stock 라이선스 내역을 빠르게 검색하는 방법을 알아봅니다. |
