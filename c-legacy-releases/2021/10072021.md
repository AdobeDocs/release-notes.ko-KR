...
| Experience Cloud [!UICONTROL 트리거] 탐색 | [Experience Cloud 트리거](https://experienceleague.adobe.com/docs/core-services/interface/services/triggers.html)는 프로비저닝된 사용자의 헤더에 있는 애플리케이션 전환기에서 직접 탐색할 수 있습니다. |
...
| 2021년 10월 | [워크플로에서 SOAP API 사용 - 소개](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html) | 튜토리얼 | API를 통해 받은 데이터를 기반으로 Adobe Campaign Soap API를 사용하고 고급 게재 워크플로우를 만드는 방법을 알아봅니다. |
