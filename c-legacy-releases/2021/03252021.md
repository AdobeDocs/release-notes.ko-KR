...
| [Customer Activity Hub 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/customer-activity.html?lang=ko-KR) | 외부 애플리케이션이 Adobe Experience Platform에 액세스하는 방법을 알아봅니다 [!UICONTROL 실시간 고객 프로필]. |
...
| [엔터프라이즈 데이터 탐색 및 보고 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-exploration/overview.html?lang=ko-KR) | Experience Platform [!UICONTROL 쿼리 서비스] 데이터에 대해 SQL 쿼리를 수행할 수 있습니다. [!UICONTROL Data Science Workspace] 를 사용하여 데이터 탐색, 데이터 과학 및 머신 러닝 워크로드를 데이터에서 수행하는 방법에 대해 알아봅니다. |
...
| 2021년 3월 5일 | [API를 사용한 데이터 수집 모니터링](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html?lang=ko-KR#data-ingestion) | 비디오 | 플랫폼의 UI 및 API를 사용하여 Adobe Experience Platform에 수집되는 데이터를 모니터링하고 추적하는 방법을 알아봅니다. |
| 2021년 3월 5일 | [데이터베이스로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-databases.html?lang=ko-KR#sources) | 비디오 | 이 비디오에서는 데이터베이스 소스에서 Adobe Experience Platform의 실시간 고객 프로필 및 경험 데이터 레이크로 데이터를 일괄 수집하여 매끄럽고 확장 가능한 방식으로 수행하는 방법을 안내합니다. |
| 2021년 3월 5일 | [Amazon S3로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage.html?lang=ko-KR) | 비디오 | 이 비디오에서는 클라우드 스토리지 서비스의 데이터를 Adobe Experience Platform의 실시간 고객 프로필 및 데이터 레이크에 매끄럽고 확장 가능한 방식으로 간편하게 일괄 수집하는 방법을 보여줍니다. |
| 2021년 3월 5일 | [Salesforce CRM으로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html?lang=ko-KR) | 비디오 | 이 비디오에서는 CRM 소스의 데이터를 Adobe Experience Platform의 실시간 고객 프로필 및 데이터 레이크에 매끄럽고 확장 가능한 방식으로 쉽게 일괄 처리하는 방법을 보여줍니다. |
| 2021년 3월 5일 | [Adobe Analytics로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=ko-KR) | 비디오 | Adobe Analytics 소스 커넥터를 사용하면 Adobe Analytics에서 Adobe Experience Platform의 실시간 고객 프로필 및 경험 데이터 레이크로 데이터를 매끄럽고 확장 가능한 방식으로 쉽게 스트리밍할 수 있습니다. |
...
| 2021년 3월 5일 | [Adobe Developer 콘솔 내보내기 Postman 세부 사항](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html?lang=ko-KR) | 비디오 | Experience Platform API를 인증하고 액세스하는 방법에 대해 알아봅니다. |
| 2021년 3월 5일 | [데이터 수집 이해](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/understanding-data-ingestion.html#data-ingestion) | 비디오 | 실시간 고객 프로필을 관리할 수 있는 개방적이고 확장 가능한 하나의 플랫폼으로 데이터를 통합할 수 있는 Experience Platform의 데이터 수집 기능에 대해 알아봅니다. |
...
* 세그먼트의 새 소유자를 편집하고 저장한 후 이 새 소유자가 세그먼트 UI에 반영되지 않던 문제를 수정했습니다. (AN-234502; AN-250970; AN-250286)
...
* 관리자가 아닌 사용자의 사용자 권한 및 문제를 해결했습니다. 사용자는에 있는 프로필 중 하나 이상에 추가되는 한 권한이 있어야 합니다 [!UICONTROL Admin Console]. 프로필에 사용자를 추가하는 경우 가지고 있는 권한에만 추가해야 하며 다른 제품 프로필을 통해 이미 권한이 부여된 것을 제거해서는 안 됩니다. (AN-242723)
...
| 2021년 3월 | [GraphQL API를 사용한 헤드리스 콘텐츠 관리](https://experienceleague.adobe.com/?lang=ko-KR?recommended=ExperienceManager-D-1-2020.1.headless) | 교육 과정 | AEM GraphQL API 및 헤드리스 기능을 사용하여 외부 앱에서 나타난 경험을 전달하는 방법을 알아봅니다. |
...
| 2021년 3월 5일 | [Adobe Stock 벡터 일러스트레이션의 색상 맟춤화](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/customizecolors.html?lang=ko-KR) | 비디오 | 멋진 일러스트레이션으로 모든 프로젝트에 세련미를 더합니다. Adobe Stock에서 완벽한 벡터를 찾은 다음 Adobe Illustrator을 사용하여 색상을 프로젝트의 팔레트에 일치시킵니다. |
