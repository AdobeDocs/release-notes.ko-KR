...
| 2021년 2월 3일 | [교육 과정 소개 - Audience Manager에서 데이터 활성화 생성 및 관리](https://video.tv.adobe.com/v/331001) | 비디오 | 대상자 세그먼트는 실제로 작업을 수행하지 않는 한 아무런 가치도 없습니다. 이 교육 과정에서는 대상자를 사용하여 사용자 경험을 사용자 정의하는 방법에 대해 설명합니다. 이 소개 비디오는 경로에서 시작할 수 있게 해 줍니다. |
