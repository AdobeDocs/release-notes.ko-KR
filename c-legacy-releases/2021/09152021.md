...
| 게시일 | 이름 | 애플리케이션 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 9월 | [[!UICONTROL Campaign 컨트롤 패널] 문제 해결](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/troubleshooting.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널] 문제를 해결하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [데이터베이스 모니터링](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/performance-monitoring/monitor-databases.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널]을 사용하여 인스턴스의 데이터베이스 사용을 모니터링하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [허용 목록 IP 주소](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/instance-settings/allowlist-ip-address.html?lang=ko-KR) | Campaign V8 | [!UICONTROL 컨트롤 패널]을 사용하여 Campaign Classic 인스턴스의 허용 목록에 IP 범위를 추가하는 방법과 허용 목록에서 제거하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [허용 목록 IP 범위](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/allowlist-ip-range.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널]의 허용 목록에 IP 주소 범위를 추가하는 방법에 대해 알아봅니다. |
...
| 2021년 9월 | [SFTP 서버에 연결](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/connect-to-sftp-server.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널]에 저장한 키를 사용하여 클라이언트 SFTP 애플리케이션을 통해 SFTP 서버에 연결하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [SSH 키 생성](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/generate-ssh-key.html?lang=ko-KR) | Campaign V8 | 터미널을 사용하여 SSH 키를 생성하는 방법과 [!UICONTROL Campaign 컨트롤 패널]에 키의 공개 버전을 저장하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [Campaign 컨트롤 패널 - 서버 용량 모니터링](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/monitor-server-capacity.html?lang=ko-KR) | Campaign V8 | SFTP 서버의 스토리지 용량을 모니터링하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [Campaign 컨트롤 패널 -Campaign 컨트롤 패널 시작하기](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/get-started.html?lang=ko-KR) | Campaign V8 | 이 문서에서는 [!UICONTROL Campaign 컨트롤 패널]에 액세스하는 방법과 [!UICONTROL Campaign 컨트롤 패널]에서 작업을 수행할 수 있는 사전 요구 사항에 대해 설명합니다. |
