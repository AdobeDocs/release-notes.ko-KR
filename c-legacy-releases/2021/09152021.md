...
| 기능 | 설명 | [일반 가용성](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html?lang=ko-KR) - 대상 날짜 |
| ----------- | ---------- | ----- |
| 지표 중복 제거 | 이제 CJA(Customer Journey Analytics)에서 지표 인스턴스의 중복을 제거할 수 있습니다. 동일한 값이 열(자체 열 또는 다른 열)에 표시되면 지표가 증가하는 것을 방지할 수 있습니다. 중복 제거는 주요 지표의 초과 계산을 방지하고 데이터에 대한 신뢰를 높입니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/metric-deduplication.html?lang=ko-KR) | 2021년 9월 16일 |
| 보고를 위한 일광 절약 시간 지원 | CJA의 모든 데이터는 특정 시간대가 아닌 UTC로 저장됩니다. 이제 CJA의 [!UICONTROL 데이터 보기]에서 일광 절약 시간제를 기준으로 1시간 증가 또는 감소를 간주하도록 데이터를 이동할 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=ko-KR#calendar) | 2021년 9월 16일 |
| [!UICONTROL 사용자 정의 달력] | 데이터 보기를 위해 다른 달력 유형(예: [!UICONTROL 소매 4-4-5])을 선택할 수 있습니다. 동일한 연결을 기반으로 여러 데이터 보기를 만들어 동일한 데이터를 다른 달력 형식으로 볼 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=ko-KR#calendar) | 2021년 9월 16일 |
| 부울 필드 지원 | CJA는 이제 부울 필드를 지원합니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/behavior.html?lang=ko-KR) | 2021년 9월 16일 |
| 새로운 [!UICONTROL 연결] 정보 경험 | 이 [!UICONTROL 연결] UI의 향상된 기능을 통해 보고에 데이터를 사용할 준비가 되었는지 여부와 시기를 알 수 있습니다. 데이터 처리와 관련된 문제를 추적할 수도 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=ko-KR) | 2021년 9월 20일 |
...
| 2021년 9월 | [Analytics 관리 로그 개요](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/logs/overview-of-analytics-admin-logs.html?lang=ko-KR) | 비디오 | 로그 파일은 사용자가 로그인한 시간, 사용량, 액세스, 보고서 세트 및 관리자 변경 사항을 확인하는 데 도움이 됩니다. 관리 로그는 [!UICONTROL 관리 도구]에서 관리자가 수행한 모든 변경 사항을 보고합니다. 이 로그는 세 가지 로그 중 하나의 사용자 정의 보고서에 대한 게이트웨이를 제공합니다. |
...
| 2021년 9월 | [시각화 범례 맞춤화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/customize-visualization-legends.html?lang=ko-KR) | 비디오 | 시리즈 라벨 편집이라고도 하는 시각화의 범례를 사용자 정의하면 보고서를 보는 모든 사람이 시각화를 더 쉽게 이해할 수 있습니다. |
...
* **동적 헤더:** 이제 HTTP 헤더 매개변수에서 동적 데이터를 전달할 수 있습니다. 이러한 매개변수는 여정 작업 HTTP 호출(예: 타임스탬프 또는 추적 ID)을 수신하는 통합 시스템에서 사용할 수 있습니다. [자세히 보기...](https://experienceleague.adobe.com/docs/journeys/using/action-journeys/action-third-party/url-configuration.html?lang=ko-KR)
* **동적 URL 경로:** 이제 사용자 정의 작업에 대한 동적 URL 경로를 설정할 수 있습니다. [자세히 보기...](https://experienceleague.adobe.com/docs/journeys/using/action-journeys/action-third-party/url-configuration.html?lang=ko-KR)
...
* [Experience Manager 6.5 Service Pack 릴리스 정보](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=ko-KR)
...
| 2021년 9월 | [Adobe Campaign 문제 해결 - 개요](https://experienceleague.adobe.com/docs/campaign-standard-learn/troubleshooting/overview.html?lang=ko-KR) | Campaign Standard | 이 섹션은 Adobe Campaign Standard에서 발생할 수 있는 문제를 해결하는 데 도움이 되도록 Adobe 고객 지원 센터에서 제공합니다. |
| 2021년 9월 | [누락된 제로 ID 레코드](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/login-and-client-console/fixing-zero-id.html?lang=ko-KR) | Campaign Classic | 제로(0) ID 문제를 해결하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [로드 밸런서 문제](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/administration/load-balancer-issues.html?lang=ko-KR) | Campaign Classic | 인스턴스 다시 시작 시 로드 밸런서 문제를 해결하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [Analytics에 캠페인 라벨 보내기](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/integrations/missing-campaign-label.html?lang=ko-KR) | Campaign Classic | Analytics에서 누락된 캠페인 라벨을 해결하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [이메일을 트리거하는 비활성화된 메시지](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/deliveries-and-channels/disabled-messages-sending-emails.html?lang=ko-KR) | Campaign Classic | 비활성화된 메시지에서 이메일이 보내지지 않도록 중지하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [게시 오류 수정](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/deliveries-and-channels/publishing-permissions-issues.html?lang=ko-KR) | Campaign Classic | 관리자가 아닌 사용자의 게시 오류를 수정하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [공개 리소스 URL을 http에서 https로 변경하는 단계별 방법](https://experienceleague.adobe.com/docs/campaign-standard-learn/troubleshooting/change-public-resource-url.html?lang=ko-KR) | Campaign Standard | 공개 리소스 URL을 http에서 https로 변경하는 방법에 대해 알아봅니다 |
| 2021년 9월 | [게재 XML 데이터 가져오기](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/workflows/query-delivery-output-names.html?lang=ko-KR) | Campaign Classic | 게재 XML 데이터를 가져오는 방법에 대해 알아봅니다. |
| 2021년 9월 | [Experience Manager에 연결하는 중에 발생하는 오류](https://experienceleague.adobe.com/docs/campaign-standard-learn/troubleshooting/error-aem-connection.html?lang=ko-KR) | Campaign Standard/Experience Manager | Campaign Standard에서 Experience Manager로 연결 중 발생하는 서비스 `nms:delivery`의 `GetAEMContentList` 오류를 해결하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [콘솔 로그인 오류 수정](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/login-and-client-console/console-login-errors.html?lang=ko-KR) | Campaign Classic | 콘솔 로그인 중 발생한 오류를 수정하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [프로필을 보는 도중 발생하는 기술 오류 문제를 해결하는 방법](https://experienceleague.adobe.com/docs/campaign-standard-learn/troubleshooting/technical-error-while-viewing-profile.html?lang=ko-KR) | Campaign Standard | 콘솔 로그인 중 발생한 오류를 수정하는 방법에 대해 알아봅니다. |
| 2021년 9월 | [캠페인 워크플로의 무조건부 중지](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/workflows/unconditional-stop-workflow.html?lang=ko-KR) | Campaign Classic | 워크플로에서 무조건부 중지를 올바르게 수행하는 방법에 대해 알아봅니다. |
