...
| 2021년 9월 | [시각화 범례 맞춤화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/customize-visualization-legends.html?lang=ko) | 비디오 | 시리즈 라벨 편집이라고도 하는 시각화의 범례를 사용자 정의하면 보고서를 보는 모든 사람이 시각화를 더 쉽게 이해할 수 있습니다. |
...
| 2021년 9월 | [Analytics에 캠페인 라벨 보내기](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/integrations/missing-campaign-label.html?lang=ko) | Campaign Classic | Analytics에서 누락된 캠페인 라벨을 해결하는 방법에 대해 알아봅니다. |
