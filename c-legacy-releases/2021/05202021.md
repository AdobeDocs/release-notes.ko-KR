...
* 일부 마케팅 채널 인스턴스가 &quot;없음&quot;으로 보고되던 문제를 수정했습니다. (AN-257850)
* Windows 및 Chrome 운영 체제가 운영 체제 유형 차원의 &quot;기타&quot; 아래에 그룹화되는 문제를 해결했습니다. (AN-244234)
...
| 2021년 5월 | [데이터 보기에서 구성 요소 설정 구성](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/configuring-component-settings-in-data-views.html?lang=ko-KR) | 비디오 | 구성 요소를 설정할 때 각 구성 요소(지표 및 차원)에 대해 구성할 기본 구성 요소 설정을 알아봅니다 [!UICONTROL 데이터 보기] Customer Journey Analytics에서 확인하십시오. |
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **Adobe Sign이 활성화된 적응형 양식에서 정부 ID 신원 확인 방법 사용**
         ...
         고급 기계 학습 알고리즘을 기반으로 하는 Adobe Sign의 정부 ID 프로세스는 전 세계 기업을 대상으로 수신자의 신원을 높은 품질로 확인할 수 있는 기능을 제공합니다. 이제 Adobe Sign이 활성화된 적응형 양식에서 정부 ID 신원 확인 방법을 사용할 수 있습니다.

         정부 ID는 프리미엄 신원 확인 방법입니다. 수신자에게 [정부가 발행한 신분증명서(운전면허증, 국민 신분증, 여권) 이미지를 업로드합니다](https://helpx.adobe.com/kr/sign/using/adobesign-authentication-government-id.html). 그런 다음 해당 문서가 진짜인지 평가합니다.
...
| 기능 | 설명 |
| -----------| ---------- |
| 패키지 설정 | 새로운 [!UICONTROL 게재 간격 채우기 전략] 옵션 “[!UICONTROL 약간 앞으로]”를 사용할 수 있으며 새 패키지의 기본값입니다. 이 전략은 55-65%가 비행 기간의 절반을 완수하도록 전송을 가속화합니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 5월 | [PDF 온라인 경험 제어 및 분석 수집](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=ko-KR#part1) | 문서 | Adobe PDF 포함 API를 사용하여 모양새를 제어하고, 공동 작업을 가능하게 하며, 페이지 및 검색에서 보낸 시간을 포함하여 사용자가 PDF과 상호 작용하는 방법에 대한 분석을 수집하는 방법을 알아봅니다. (네 가지 부분) |
