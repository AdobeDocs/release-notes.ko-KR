...
| 2025년 5월 | Journey Optimizer | [일괄 세분화 완료 후 일일 여정 실행 트리거](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/create-journeys/trigger-daily-journey-runs-after-batch-segmentation-completion) | 새 비디오 | 세분화 작업이 완료된 후에만 읽기 대상자 여정을 시작하도록 구성하여 데이터 정확성과 규정 준수를 보장하는 방법을 알아보십시오. |
...
| 2025년 4월 | [여정에 진입하는 프로필 수와 AJO의 관련 대상자 수의 불일치](https://experienceleague.adobe.com/ko/docs/experience-cloud-kcs/kbarticles/ka-26253) | 신규 문서 | 특히 일괄 대상자를 이용하는 여정에서 해당 여정에 진입하는 프로필 수와 관련 대상의 프로필 수가 일치하지 않는 문제에 대한 해결 방법을 알아보십시오. |
